package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      private var var_201:DropMenuController;
      ...
      {
         if(param1 > this.var_288.lenght - 1)
         {
      ...
      {
         if(this.var_201 != null && !this.var_201.disposed)
         {
            this.var_201.destroy();
            this.var_201 = null;
         }
         super.dispose();
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_201 == null || this.var_201.disposed)
         {
            this.var_201 = context.create(name + "::submenu","",WindowType.const_564,var_92,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_201.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_288.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_1059 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_201.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_1059)
         {
            if(this.open())
            {
               if(this.var_288.length)
               {
                  this.populateMenuItemContainer(this.var_288,this.getSubMenu(),this.subMenuEventProc);
                  this.var_1059 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_1059 = false;
            this.getTitleLabel().text = this.var_689 < this.var_288.length && this.var_689 > -1 ? this.var_288[this.var_689] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_516,var_92,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_442,var_92,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_689 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_689).setStateFlag(WindowState.const_57,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_801)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1173:
            ...
            case WindowMouseEvent.const_44:
               ...
               break;
            case WindowEvent.const_648:
               if(param2 == this.var_201)
               {
                  this.closeMenuView();
               }
         }
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1969,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_2003,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_2041,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_288[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_288.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_875,this.var_288,PropertyStruct.const_153,true));
         }
         else
         {
