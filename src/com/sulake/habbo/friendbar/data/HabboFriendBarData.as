package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1146:Boolean = false;
      
      private static const const_716:String = "Navigation";
      
      private static const const_717:String = "Friend Bar";
      
      private static const const_1662:String = "go.friendbar";
      
      private static const const_1660:String = "chat_btn_click";
      
      private static const const_1661:String = "find_friends_btn_click";
      
      private static const const_1144:String = "Toolbar";
      
      private static const const_1145:String = "open";
      
      private static const const_1143:String = "close";
      
      private static const const_1658:String = "FRIENDLIST";
      ...
      private var var_231:IHabboMessenger;
         ...
         if(!disposed)
         {
            ...
            if(this.var_91)
            {
               if(!this.var_91.disposed)
               {
                  ...
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_209,this.onFriendRequestEvent);
               }
            ...
            if(this.var_231)
            {
               this.var_231.release(new IIDHabboMessenger());
               this.var_231 = null;
            }
            if(this.var_722)
            {
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_716,const_717,const_1662));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_231)
         {
            this.var_231.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false,param1));
            if(this.var_94)
            {
               this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_716,const_717,const_1660));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_94)
         {
            ...
            this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_716,const_717,const_1661));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_91)
         {
            if(!this.var_91.disposed)
            {
               ...
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1144,const_1658,!!this.var_91.isOpen() ? const_1145 : const_1143));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_231)
         {
            ...
            {
               this.var_231.toggleMessenger();
               if(this.var_94)
               {
                  this.var_94.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1144,const_1659,!!this.var_231.isOpen() ? const_1145 : const_1143));
               }
            }
         }
      }
      ...
      private function onConfigurationAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_2900 = this.var_1104.getBoolean("friendbar.notifications.enabled",false);
         this.var_2117 = this.var_1104.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      {
         this.var_231 = param2 as IHabboMessenger;
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_91.events.addEventListener(FriendRequestEvent.const_209,this.onFriendRequestEvent);
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         this.var_892 = _loc2_.senderId;
         var _loc3_:Boolean = true;
         if(this.var_231)
         {
            if(this.var_231.isOpen())
            {
               _loc4_ = this.var_231.getActiveConversation();
               if(_loc4_)
               {
                  if(_loc4_.id == this.var_892)
                  {
                     _loc3_ = false;
                  }
               }
         ...
         if(_loc3_)
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_892));
            this.makeNotification(String(this.var_892),FriendNotification.const_398,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         this.var_892 = _loc2_.senderId;
         if(this.var_231 && !this.var_231.isOpen())
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_892));
            this.makeNotification(String(this.var_892),FriendNotification.const_398,null,true,false);
         }
      }
