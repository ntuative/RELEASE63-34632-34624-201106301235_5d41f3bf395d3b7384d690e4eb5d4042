package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_2040:String = "cone";
      
      public static const const_1944:String = "plane";
      
      public static const const_1998:String = "sphere";
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_300 = param6;
         this.var_2868 = param7;
         this.var_2863 = param9;
         this._energy = param8;
         this.var_2865 = param10;
         this.reset();
      }
      ...
      public function reset() : void
      {
         ...
         this.var_1096 = 0;
         this.var_1021 = false;
         this.init(0,0,0,this._direction,this.var_2864,this.var_1097,this.var_2863,true);
      }
      ...
      {
         this.var_1021 = true;
         if(this.var_1096 < this.var_1640)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2866)
         {
            switch(this.var_2868)
            {
               case const_2040:
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1096 < this.var_1640)
         {
            if(this.age % this.var_2865 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1096 < this.var_1640)
         {
            ...
            _loc4_ = this.y;
            _loc5_ = this.z;
            this.x = (2 - this.var_300) * this.x - (1 - this.var_300) * this.lastX;
            this.y = (2 - this.var_300) * this.y - (1 - this.var_300) * this.lastY + this.var_2107 * this.var_1097 * this.var_1097;
            this.z = (2 - this.var_300) * this.z - (1 - this.var_300) * this.lastZ;
            this.lastX = _loc3_;
            this.lastY = _loc4_;
            this.lastZ = _loc5_;
         }
         ...
         for each(_loc2_ in this.var_414)
         {
            ...
            _loc4_ = _loc2_.y;
            _loc5_ = _loc2_.z;
            _loc2_.x = (2 - this.var_300) * _loc2_.x - (1 - this.var_300) * _loc2_.lastX;
            _loc2_.y = (2 - this.var_300) * _loc2_.y - (1 - this.var_300) * _loc2_.lastY + this.var_2107 * this.var_1097 * this.var_1097;
            _loc2_.z = (2 - this.var_300) * _loc2_.z - (1 - this.var_300) * _loc2_.lastZ;
            _loc2_.lastX = _loc3_;
            _loc2_.lastY = _loc4_;
            _loc2_.lastZ = _loc5_;
         ...
         for each(_loc2_ in _loc1_)
         {
            ...
            this.var_414.splice(this.var_414.indexOf(_loc2_),1);
            _loc2_.dispose();
         }
      }
