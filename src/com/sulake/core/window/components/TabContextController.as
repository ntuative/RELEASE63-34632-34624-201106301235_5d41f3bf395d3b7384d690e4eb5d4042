package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1607:String = "_SELECTOR";
      
      private static const const_1606:String = "_CONTENT";
       
      
      protected var var_1148:ITabSelectorWindow;
      
      protected var var_2258:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1148 = findChildByTag(const_1607) as ITabSelectorWindow;
            if(this.var_1148 != null)
            {
               this.var_1148.procedure = this.selectorEventProc;
            }
         }
      ...
      {
         if(this.var_2258 == null)
         {
            this.var_2258 = findChildByTag(const_1606) as IWindowContainer;
         }
      ...
      {
         return !!this.var_906 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1148.numSelectables;
      }
