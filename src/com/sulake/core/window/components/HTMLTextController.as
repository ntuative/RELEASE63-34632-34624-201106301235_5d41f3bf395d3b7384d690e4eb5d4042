package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private var var_1907:StyleSheet = null;
      ...
      {
         this.var_823 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      {
         if(PropertyDefaults.const_942.indexOf(param1) > -1)
         {
            this.var_823 = param1;
         }
      }
      ...
      {
         return this.var_823 == LinkTarget.const_30 ? defaultLinkTarget : this.var_823;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_17);
            _field.styleSheet = this.var_1907;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1371)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_823 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_790,this.var_823,PropertyStruct.const_51,true,PropertyDefaults.const_942));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_790)
            {
               this.var_823 = _loc2_.value as String;
               break;
            }
