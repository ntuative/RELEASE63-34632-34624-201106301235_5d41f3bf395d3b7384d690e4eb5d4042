package com.sulake.habbo.ui.handler
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.sessionDataManager.events.removeEventListener(UserNameUpdateEvent.const_870,this.onUserNameUpdate);
         }
         ...
         if(this._container && this._container.sessionDataManager && this._container.sessionDataManager.events)
         {
            this._container.sessionDataManager.events.addEventListener(UserNameUpdateEvent.const_870,this.onUserNameUpdate);
         }
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_983);
      ...
      public function getProcessedEvents() : Array
      {
         ...
         _loc1_.push(RoomSessionDanceEvent.const_165);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_983:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_136:
               ...
               break;
            case RoomSessionDanceEvent.const_165:
