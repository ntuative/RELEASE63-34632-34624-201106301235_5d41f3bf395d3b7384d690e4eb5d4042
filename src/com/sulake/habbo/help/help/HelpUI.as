package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201106301229));
         this.var_139 = new Map();
         this.var_139.add(HabboHelpViewEnum.const_1762,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_218,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_594,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_380,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_307,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_453,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_1010,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_246,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_139.add(HabboHelpViewEnum.const_1303,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_139.add(HabboHelpViewEnum.const_1246,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_139.add(HabboHelpViewEnum.const_876,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_139.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_139.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_571.length == 0 || param1 != this.var_406)
            {
               this.var_571.push(this.var_406);
            }
         }
         this.var_406 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_406);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_246:
               ...
               break;
            case CallForHelpResultEnum.const_1328:
               this.showUI(HabboHelpViewEnum.const_1246);
               break;
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_139.getValue(HabboHelpViewEnum.const_218) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_660));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_139.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_139.getValue(this.var_406);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2646 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.width = _loc1_.width + this.var_2646;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_571.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_406 == HabboHelpViewEnum.const_218)
         {
            return;
         }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_406 == HabboHelpViewEnum.const_218 || this.var_571.length == 0)
         {
            return;
         }
         if(this.var_405 == null)
