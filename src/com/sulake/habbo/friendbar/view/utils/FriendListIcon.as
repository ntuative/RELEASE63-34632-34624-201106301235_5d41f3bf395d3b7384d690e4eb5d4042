package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || _hover,!!_hover ? int(const_1158) : int(const_1157));
         if(!var_936 && !_hover)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_936,!!_hover ? int(const_1158) : int(const_1157));
         if(!var_936 && !_hover)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
