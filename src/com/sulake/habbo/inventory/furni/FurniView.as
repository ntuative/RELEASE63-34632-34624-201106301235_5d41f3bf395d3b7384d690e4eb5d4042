package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1070:int = 42;
      
      private static const const_1073:int = 120;
      ...
      private function addUnseenItemSymbols() : void
      {
         ...
         for each(_loc5_ in ["floor","wall","pets"])
         {
            ...
            _loc3_.x = _loc4_.rectangle.right - _loc3_.width - const_1041;
            _loc3_.y = _loc4_.y + const_1041;
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_212.getValue(this.var_456);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_78.getCategoryContent(this.var_456);
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.getUnseenItemCount(UnseenItemCategoryEnum.const_454) > 0;
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_78.getGroupItemInIndex(_loc3_,this.var_456);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            _loc5_ = _loc4_.peek();
            _loc1_ = true;
            _loc16_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_759 && this.var_759.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > const_1073)
         {
            _loc3_ = const_1073;
         }
         else if(_loc3_ < const_1070)
         {
            _loc3_ = const_1070;
         }
         else
         ...
         else if(param1.type == WindowEvent.const_47)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModelCategory.const_300);
            }
         }
      }
