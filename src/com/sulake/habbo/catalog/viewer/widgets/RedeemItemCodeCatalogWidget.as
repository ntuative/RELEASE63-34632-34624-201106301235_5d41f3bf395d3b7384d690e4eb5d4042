package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1131.removeEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
            this.var_1131 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         if(this.var_1131 != null)
         {
            this.var_1131.addEventListener(WindowKeyboardEvent.const_192,this.windowKeyEventProcessor);
         }
         return true;
      }
