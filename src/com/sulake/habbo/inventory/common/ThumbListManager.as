package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_1496:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         this.var_105 = this.var_641.height;
         this.var_1192 = param5;
         this.var_991 = param6;
         this.var_244 = Math.floor(this.var_1192 / this._thumbWidth);
         this.var_28 = new BitmapData(this.var_1192,this.var_991);
      }
      ...
      public function updateImageFromList() : void
      {
         ...
         this.var_28 = new BitmapData(Math.max(this.var_244 * this._thumbWidth,this.var_1192),Math.max(this.var_642 * this.var_105,this.var_991),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == this.var_244 && this.var_28.height < _loc3_.y * this.var_105)
         {
         ...
         _loc4_ = new Rectangle(0,this.var_105,this._thumbWidth * (this.var_244 - 1),this.var_28.height - this.var_105);
      ...
      private function getList() : Array
      {
         ...
         {
            _loc1_ = this.var_1496.getDrawableList();
         }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(this.var_28.height < this.var_991)
         {
            _loc12_ = new BitmapData(this.var_28.width,this.var_991);
