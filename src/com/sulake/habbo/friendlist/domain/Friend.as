package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2333:int = "F".charCodeAt(0);
      
      public static const const_2291:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1085 = param1.gender;
         this.var_859 = param1.online;
         this.var_1726 = param1.followingAllowed && param1.online;
         this._figure = param1.figure;
         this.var_1725 = param1.motto;
         this.var_1727 = param1.lastAccess;
         this.var_1515 = param1.categoryId;
