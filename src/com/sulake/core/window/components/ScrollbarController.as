package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1625:String = "increment";
      
      private static const const_1626:String = "decrement";
      
      private static const const_1125:String = "slider_track";
      
      private static const const_705:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         ...
         {
            this.var_18.removeEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_18.removeEventListener(WindowEvent.const_555,this.onScrollableScrolled);
         }
         this.var_18 = param1;
         if(this.var_18 != null && !this.var_18.disposed)
         {
            this.var_18.addEventListener(WindowEvent.const_39,this.onScrollableResized);
            this.var_18.addEventListener(WindowEvent.const_555,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      {
         return findChildByName(const_1125) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_705) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_705:
               if(param2.type == WindowEvent.const_203)
               {
                  if(!this.var_1311)
                  {
                     if(this._horizontal)
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_355)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_44 || param1.type == WindowTouchEvent.const_801)
         {
            ...
            else if(param2.name == const_1626)
            {
               if(this.var_18)
               {
                  this.var_1311 = true;
            ...
            else if(param2.name == const_1125)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_705).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_355)
         {
