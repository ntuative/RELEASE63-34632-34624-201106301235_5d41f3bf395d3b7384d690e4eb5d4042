package com.sulake.habbo.ui.handler
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1594:IMessageEvent;
      ...
      {
         this.var_1594 = new FurniListUpdateEvent(this.onFurniListUpdated);
         ...
         this._connection.addMessageEvent(this.var_1594);
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._connection)
            {
               this._connection.removeMessageEvent(this.var_1594);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_860,RoomWidgetPlayListModificationMessage.const_834,RoomWidgetPlayListModificationMessage.const_903,RoomWidgetPlayListPlayStateMessage.const_882,RoomWidgetPlayListUserActionMessage.const_746];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_860:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_834:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_903:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_882:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_746:
      ...
      private function onFurniListUpdated(param1:IMessageEvent) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_859,-1));
            }
         }
      }
      ...
      private function processSoundManagerEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case SongDiskInventoryReceivedEvent.SONG_DISK_INVENTORY_RECEIVED:
               this._container.events.dispatchEvent(new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_821));
               break;
