package com.sulake.habbo.communication.protocol
{
   ...
   public class WedgieProtocol implements IProtocol
   {
      ...
      public static const const_1865:uint = 2;
       
      
      private var var_1552:IProtocolEncoder;
      
      private var var_1259:IProtocolDecoder;
      
      public function WedgieProtocol()
      {
         super();
         this.var_1552 = new WedgieEncoder();
         this.var_1259 = new WedgieDecoder();
      }
      ...
      public function getMessages(param1:ByteArray, param2:Array) : uint
      {
         ...
         while(param1.bytesAvailable)
         {
            ...
            {
               _loc4_.position = 0;
               _loc6_ = this.var_1259.getID(_loc4_);
