package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private static const const_718:String = "room_view";
      
      private static const const_1663:String = "room_widget";
      ...
      private function getWidgetContainer(param1:String, param2:IWindow) : IWindowContainer
      {
         ...
         if(param1 == RoomWidgetEnum.const_370)
         {
         ...
         {
            if(String(_loc3_[_loc5_]).indexOf(const_1663) == 0)
            {
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = this.var_101.getChildByTag(const_718) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = this.var_101.findChildByTag(const_718) as IWindowContainer;
         if(!_loc1_)
         {
            return null;
         }
