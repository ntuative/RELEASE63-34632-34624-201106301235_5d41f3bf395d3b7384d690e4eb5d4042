package com.sulake.habbo.ui.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_598:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_598.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_598 = null;
         }
         if(this.var_47 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_598 == null)
         {
            this.var_598 = new Sprite();
            this.var_598.addChild(new Bitmap(this.var_47));
            this.var_598.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_598.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_47;
            }
         }
         _loc2_.setDisplayObject(this.var_598);
