package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1158:IDropMenuWindow;
      
      private var var_580:ITextFieldWindow;
      
      private var var_737:Boolean = true;
      
      private var var_943:ICheckBoxWindow;
      
      private var var_1439:ICheckBoxWindow;
      
      private var var_1438:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_35.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_419));
      ...
      public function populate() : void
      {
         ...
         this.var_580 = ITextFieldWindow(this._frame.findChildByName("message_input"));
         this.var_580.procedure = this.onInputClick;
         this.var_1158 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1158);
         this.var_1158.procedure = this.onSelectTemplate;
         this.var_943 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1439 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1438 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_35,WindowTracker.const_847,this._data.flatId),this._frame,false,false,true);
      }
      ...
      {
         if(this.var_737 || this.var_580.text == "")
         {
            this.var_35.windowManager.alert("Alert","You must input a message to the user",0,this.onAlertClose);
            return;
         }
         var _loc2_:int = this.determineAction(param1,this.var_943.isSelected);
         this.var_35.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1983,_loc2_,this.var_580.text,"",""));
         if(this.var_1439.isSelected || this.var_1438.isSelected || this.var_943.isSelected)
         {
            this.var_35.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1439.isSelected,this.var_1438.isSelected,this.var_943.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1789);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1761);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_35.initMsg.roomMessageTemplates[this.var_1158.selection];
         if(_loc3_ != null)
         {
            this.var_737 = false;
            this.var_580.text = _loc3_;
         }
      }
   }
}
