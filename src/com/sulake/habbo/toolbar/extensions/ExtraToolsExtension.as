package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1489:String = "HELP";
      ...
      public function ExtraToolsExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager)
      {
         ...
         this.var_388 = this._window.findChildByName("roominfo_region");
      ...
      {
         this.var_67.removeListItem(this.var_388);
      }
      
      public function showRoomInfo() : void
      {
         this.var_67.addListItemAt(this.var_388,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_327)
         {
            this.var_327 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_327.x = _loc1_.x + this._window.width - this.var_327.width;
            this.var_327.y = _loc1_.y + this._window.height - this.var_327.height;
         }
      }
