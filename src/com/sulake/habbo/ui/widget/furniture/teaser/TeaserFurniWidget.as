package com.sulake.habbo.ui.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_2379:int = 4;
      
      private const const_2376:int = 5;
      
      private const const_2106:String = "deco_img";
      
      private const const_2104:String = "dialog_bg";
      
      private const const_2378:String = "%campaign%_dialog_bg.png";
      
      private const const_392:String = "%campaign%_gift_package.png";
      
      private const const_2382:String = "%campaign%_gift_content.png";
      
      private const const_2381:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboInventory)
      {
         ...
         this.var_1688 = this.var_151.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1688 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1690.length)
         {
            _loc2_ = this.var_1690.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_151 = null;
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetTeaserDataUpdateEvent.const_967:
               ...
               this._shareId = null;
               this.var_1689 = param1.itemCategory;
               break;
         ...
         if(this._window && (this.var_1691 != _loc2_ || _loc3_ != this.var_209))
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_209 = _loc3_;
         this.var_1691 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1691)
            {
               ...
               case this.const_2102:
                  if(this.var_427 == this.const_2377)
                  {
                  ...
                  else if(this.var_427 == this.const_2380)
                  {
                     ...
                     _loc2_ = this.const_2382;
                  }
                  else if(this.var_427 == this.const_2384)
                  {
                  ...
                  else if(this.var_427 == this.const_2383)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_427 == this.const_2379)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_209,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_427 == this.const_2376)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2378.replace("%campaign%",this.var_209);
            this.setDecoImage(_loc5_,this.const_2104);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this.var_12)
         {
            if(this.var_1689 != 0)
            {
               this.var_12.toggleInventoryPage(this.var_1689 == 1 ? "null" : InventoryCategory.const_125);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_958,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1690.push(new ImageDownloader(this,_assets,this.var_209,this.var_1688,param1,param2));
            return;
         }
