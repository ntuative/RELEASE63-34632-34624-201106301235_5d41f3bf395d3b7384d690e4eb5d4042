package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2088:String = "_POINTER_UP";
      
      private static const const_2087:String = "_POINTER_DOWN";
      
      private static const const_2089:String = "_POINTER_LEFT";
      
      private static const const_2090:String = "_POINTER_RIGHT";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_835;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_955,this._direction,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         if(this.var_835 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_812,this.var_835,PropertyStruct.const_35,true));
         }
         else
         {
