package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1409:Dictionary = createPropertySetterTable();
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_452,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_452 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_452,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_772 ? true : null;
         }
      ...
      {
         return new Rectangle(this.var_933 * this.maxScrollH,this.var_603 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_887,this._field.antiAliasType,PropertyStruct.const_51,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1317));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1226 ? new PropertyStruct(PropertyDefaults.const_751,this._autoSize,PropertyStruct.const_51,true,PropertyDefaults.const_1331) : PropertyDefaults.const_1739);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_299,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1249 ? new PropertyStruct(PropertyDefaults.const_1359,this._field.gridFitType,PropertyStruct.const_51,true,PropertyDefaults.const_1274) : PropertyDefaults.const_1882);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_763) ? new PropertyStruct(PropertyDefaults.const_455,this._field.textColor,PropertyStruct.const_156,true) : PropertyDefaults.const_1299);
         ...
         _loc1_.push(this.var_41.left != PropertyDefaults.const_936 ? new PropertyStruct(PropertyDefaults.const_251,this.var_41.left,PropertyStruct.const_35,true) : PropertyDefaults.const_840);
         _loc1_.push(this.var_41.top != PropertyDefaults.const_1013 ? new PropertyStruct(PropertyDefaults.const_265,this.var_41.top,PropertyStruct.const_35,true) : PropertyDefaults.const_758);
         _loc1_.push(this.var_41.right != PropertyDefaults.const_762 ? new PropertyStruct(PropertyDefaults.const_271,this.var_41.right,PropertyStruct.const_35,true) : PropertyDefaults.const_892);
         _loc1_.push(this.var_41.bottom != PropertyDefaults.const_1005 ? new PropertyStruct(PropertyDefaults.const_253,this.var_41.bottom,PropertyStruct.const_35,true) : PropertyDefaults.const_744);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1231 ? new PropertyStruct(PropertyDefaults.const_891,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1828);
