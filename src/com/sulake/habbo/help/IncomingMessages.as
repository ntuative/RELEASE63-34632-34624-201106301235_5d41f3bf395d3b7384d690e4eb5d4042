   ...
   public class IncomingMessages
   {
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            {
               this.var_2297 = _loc5_.id;
            }
            _loc4_++;
         }
         this.var_22.tellUI(HabboHelpViewEnum.const_876);
      }
      ...
      {
         this.var_22.showUI(HabboHelpViewEnum.const_453);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_594);
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         this.var_22.tellUI(HabboHelpViewEnum.const_380,_loc6_);
      }
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            this.var_22.tellUI(HabboHelpViewEnum.const_307,_loc4_);
         }
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         this.var_22.showUI(HabboHelpViewEnum.const_1263);
         this.var_22.tellUI(HabboHelpViewEnum.const_1263,_loc5_);
      }
