package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_537)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_537)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_771,param1.toolTipCaption,PropertyStruct.const_51,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1978);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1267)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_868,param1.toolTipDelay,PropertyStruct.const_299,true));
         }
         else
         {
