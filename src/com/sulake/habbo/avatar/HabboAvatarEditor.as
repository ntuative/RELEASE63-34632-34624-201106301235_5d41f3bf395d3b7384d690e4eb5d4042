package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1721:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1720:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_599:HabboAvatarEditorManager;
      
      private var var_1135:IFigureData;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_599 = param2;
         this.var_1135 = this.var_599.avatarRenderManager.getFigureData(AvatarType.const_134);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_743 = new Dictionary();
         this.var_743["null"] = new FigureData(this);
         this.var_743["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_743["null"];
         var _loc3_:FigureData = this.var_743["null"];
         _loc2_.loadAvatarData(const_1721,FigureData.const_93);
         _loc3_.loadAvatarData(const_1720,FigureData.FEMALE);
         this.var_118 = new Map();
         this.var_600 = new Map();
         this.var_118.add(AvatarEditorFigureCategory.const_902,new BodyModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_56,new HeadModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_279,new TorsoModel(this));
         this.var_118.add(AvatarEditorFigureCategory.const_1001,new LegsModel(this));
         ...
         this.var_600.add(AvatarEditorSideCategory.const_111,new WardrobeModel(this));
         this.var_600.add(AvatarEditorSideCategory.const_522,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_916 != param3)
         {
            this.var_916 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_743[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1135.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1135.getPalette(param1);
      }
      ...
      {
         var _loc2_:ISideContentModel = this.var_600.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      {
         return this.var_743[this.var_1085];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         else
         {
            ...
            this.var_599.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2194;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_916 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_599.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_599.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_599.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1805)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_916 >= _loc6_.clubLevel))
               {
      ...
      {
         return this.var_599.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_916 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_600.getValue(AvatarEditorSideCategory.const_111);
      }
