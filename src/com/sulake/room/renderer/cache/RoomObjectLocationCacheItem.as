package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1890 || param1.getUpdateID() != this.var_2624)
         {
            this.var_2624 = param1.getUpdateID();
            if(param2.updateId != this.var_1890 || _loc4_.x != this.var_1257.x || _loc4_.y != this.var_1257.y || _loc4_.z != this.var_1257.z)
            {
               this.var_1890 = param2.updateId;
               this.var_1257.assign(_loc4_);
               _loc3_ = true;
            }
         }
