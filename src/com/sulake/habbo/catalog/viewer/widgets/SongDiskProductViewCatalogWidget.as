package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SongDiskProductViewCatalogWidget extends ProductViewCatalogWidget
   {
      ...
      public function SongDiskProductViewCatalogWidget(param1:IWindowContainer, param2:IHabboSoundManager)
      {
         ...
         this.var_1255 = _window.findChildByName("ctlg_song_length") as ITextWindow;
      ...
      private function onClickPlay(param1:WindowMouseEvent) : void
      {
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            ...
            this._soundManager.musicController.playSong(this.var_1039,HabboMusicPrioritiesEnum.const_211,15,40,0.5,2);
         }
      }
      ...
      private function onSelectProduct(param1:SelectProductEvent) : void
      {
         ...
         {
            this.var_1039 = parseInt(_loc2_.extraParam);
            if(this.var_1256 != null)
            {
      ...
      private function updateView() : void
      {
         ...
         if(_loc2_ >= 0)
         {
            ...
            {
               this.var_1255.text = _loc8_;
            }
         }
         else if(this.var_1255 != null)
         {
            this.var_1255.text = "";
         }
         if(this.var_465 != null)
      ...
      private function getSongLength() : int
      {
         ...
         if(this._soundManager != null && this._soundManager.musicController != null)
         {
            _loc1_ = this._soundManager.musicController.getSongInfo(this.var_1039);
            if(_loc1_ != null)
            {
               return _loc1_.length / 1000;
            }
            this._soundManager.musicController.requestSongInfoWithoutSamples(this.var_1039);
         }
         return -1;
      }
