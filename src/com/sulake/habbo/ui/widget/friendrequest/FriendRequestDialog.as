package com.sulake.habbo.ui.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      private function createWindow() : void
      {
         ...
         this._window.addEventListener(WindowEvent.const_648,this.onDeactivated);
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1403);
            return;
         }
         if(this.var_2200 || this.var_2198)
         {
            return;
         }
      ...
      private function onAccept(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.acceptRequest(this.var_1403);
         }
      }
      ...
      private function onDecline(param1:WindowMouseEvent) : void
      {
         if(this._widget != null)
         {
            this._widget.declineRequest(this.var_1403);
         }
      }
   }
}
