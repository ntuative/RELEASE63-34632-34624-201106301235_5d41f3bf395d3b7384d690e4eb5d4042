package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      {
         super();
         this.var_1150 = param2 == null ? "" : param2.url;
         this._type = param1;
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_359 < var_3053)
            {
               ...
               this.var_44.load(new URLRequest(this.var_1150 + (this.var_1150.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_359),this.var_1149);
               return true;
            }
         }
         return false;
