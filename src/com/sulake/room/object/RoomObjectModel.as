package com.sulake.room.object
{
   ...
   public class RoomObjectModel implements IRoomObjectModelController
   {
      ...
      public function dispose() : void
      {
         ...
         {
            for(_loc1_ in this.var_709)
            {
               delete this.var_709[_loc1_];
            }
            this.var_709 = null;
         }
         ...
         {
            for(_loc1_ in this.var_707)
            {
               delete this.var_707[_loc1_];
            }
            this.var_707 = null;
         }
         if(this.var_708 != null)
         {
            for(_loc1_ in this.var_708)
            {
               delete this.var_708[_loc1_];
            }
            this.var_708 = null;
         }
         this.var_1618 = [];
      ...
      {
         var _loc2_:Array = this.var_707[param1];
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.slice();
         }
      ...
      {
         if(this.var_1617.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      {
         if(this.var_1618.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function setNumberArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_707[param1];
      ...
      public function setStringArray(param1:String, param2:Array, param3:Boolean = false) : void
      {
         ...
         var _loc6_:Array = this.var_708[param1];
         var _loc7_:Boolean = true;
         if(_loc6_ != null && _loc6_.length == _loc4_.length)
         {
            _loc5_ = _loc4_.length - 1;
