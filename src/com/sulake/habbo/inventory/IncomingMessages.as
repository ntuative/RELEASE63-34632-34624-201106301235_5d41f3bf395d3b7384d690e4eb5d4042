package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_12.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.isVIP,_loc2_.responseType == ScrSendUserInfoMessageParser.const_1334);
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this.var_12.toggleInventorySubPage(InventorySubCategory.const_358);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this.var_12.setInventoryCategoryInit(InventoryCategory.const_426);
      ...
      {
         var _loc2_:* = null;
         if(this.var_12.isInventoryCategoryInit(InventoryCategory.const_426))
         {
      ...
      private function onUnseenItems(param1:UnseenItemsEvent) : void
      {
         ...
         this.var_12.furniModel.addUnseenFloorItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_430));
         this.var_12.furniModel.addUnseenWallItems(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_454));
         this.var_12.petsModel.addUnseenPets(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_54));
         this.var_12.badgesModel.addUnseenBadges(_loc2_.getItemsByCategory(UnseenItemCategoryEnum.const_1197));
