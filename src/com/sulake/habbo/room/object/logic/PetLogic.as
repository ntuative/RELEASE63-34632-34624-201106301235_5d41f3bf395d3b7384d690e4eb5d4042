package com.sulake.habbo.room.object.logic
{
   ...
   public class PetLogic extends MovingObjectLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_167,RoomObjectMoveEvent.const_427];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(!this.var_2343)
         {
            ...
            if(param1 is RoomObjectAvatarSleepUpdateMessage)
            {
               ...
               _loc2_.setNumber(RoomObjectVariableEnum.const_249,Number(_loc7_.isSleeping));
               return;
            }
         }
         ...
         if(param1 is RoomObjectAvatarFigureUpdateMessage)
         {
            ...
            _loc2_.setString(RoomObjectVariableEnum.const_1986,_loc10_.race);
            _loc2_.setNumber(RoomObjectVariableEnum.const_765,this.getPaletteIndex(_loc10_.figure));
            return;
         }
      }
      ...
      private function debugMouseEvent(param1:RoomSpriteMouseEvent) : void
      {
         ...
         if(!param1.altKey && !param1.ctrlKey)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_208,_loc3_ + this.var_958);
         }
         else if(param1.altKey && !param1.ctrlKey)
         {
            ++this.var_1755;
            _loc2_.setNumber(RoomObjectVariableEnum.const_245,this.var_1755);
            _loc2_.setNumber(RoomObjectVariableEnum.const_175,NaN);
         }
         else if(param1.ctrlKey && !param1.altKey)
         {
            ++this.var_1754;
            _loc2_.setNumber(RoomObjectVariableEnum.const_175,this.var_1754);
         }
         else
         {
            this.var_958 += 45;
