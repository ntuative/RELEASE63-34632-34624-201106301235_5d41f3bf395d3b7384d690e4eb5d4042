package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_243 = param2;
         this.var_834 = [];
         this.var_834.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_834.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_834)
         {
         ...
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_1014,this.onSoundMachinePlayEvent);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_1023,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_1014,this.onSoundMachinePlayEvent);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_1023,this.onSoundMachineStopEvent);
               this.var_95 = null;
            }
            this._disposed = true;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_495 == param1)
         {
            this.playCurrentSongAndNotify(this.var_495);
      ...
      public function stopPlaying() : void
      {
         this.var_495 = -1;
         this.var_727 = false;
         this.var_243.stop(HabboMusicPrioritiesEnum.const_120);
      }
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_243.playSong(param1,HabboMusicPrioritiesEnum.const_120,_loc3_,0,0,0))
         {
