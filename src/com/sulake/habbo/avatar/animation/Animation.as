package com.sulake.habbo.avatar.animation
{
   ...
   public class Animation implements IAnimation
   {
      ...
      private var var_2031:AvatarDataContainer;
      
      private var var_1597:Array;
      
      private var var_2032:DirectionDataContainer;
      
      private var var_2030:ShadowDataContainer;
      ...
      public function Animation(param1:AvatarStructure, param2:XML)
      {
         ...
         {
            this.var_1746 = String(param2.@desc);
         }
         else
         {
            this.var_1746 = this._id;
         }
         if(param2.hasOwnProperty("sprite"))
         {
            for each(_loc3_ in param2.sprite)
            {
               this.var_1599.push(new SpriteDataContainer(this as IAnimation,_loc3_));
            }
         }
         if(param2.hasOwnProperty("avatar"))
         {
            this.var_2031 = new AvatarDataContainer(param2.avatar[0]);
         }
         if(param2.hasOwnProperty("canvas"))
         {
            for each(_loc4_ in param2.canvas)
            {
               this.var_1597.push(new CanvasDataContainer(_loc4_));
            }
         }
         if(param2.hasOwnProperty("direction"))
         {
            this.var_2032 = new DirectionDataContainer(param2.direction[0]);
         }
         if(param2.hasOwnProperty("shadow"))
         {
            this.var_2030 = new ShadowDataContainer(param2.shadow[0]);
         }
         if(param2.hasOwnProperty("remove"))
         {
            for each(_loc5_ in param2.remove)
            {
               this.var_1598.push(String(_loc5_.@id));
            }
         }
         if(param2.hasOwnProperty("add"))
         {
            ...
            {
               this.var_860.push(new AddDataContainer(_loc6_));
            }
         }
         if(param2.hasOwnProperty("override"))
         {
            ...
            for each(_loc7_ in param2.method_12)
            {
               ...
               this.var_700.add(_loc9_,_loc8_);
               _loc10_ = new Array();
      ...
      private function parseFrames(param1:Array, param2:XMLList, param3:AvatarStructure) : void
      {
         ...
         for each(_loc7_ in param2)
         {
            ...
            for each(_loc9_ in _loc7_.fx)
            {
               ...
               _loc11_ = new AnimationLayerData(param3,_loc9_,AnimationLayerData.const_514,_loc6_,_loc5_);
               _loc4_.push(_loc11_);
               if(_loc5_ != null)
               {
               }
      ...
      public function getAnimatedBodyPartIds(param1:int, param2:String = null) : Array
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param2))
         {
            ...
            else if(_loc4_.type == AnimationLayerData.const_514)
            {
               for each(_loc5_ in this.var_860)
               {
      ...
      public function getLayerData(param1:int, param2:String, param3:String = null) : AnimationLayerData
      {
         ...
         for each(_loc4_ in this.getFrame(param1,param3))
         {
            ...
            if(_loc4_.type == AnimationLayerData.const_514)
            {
               for each(_loc5_ in this.var_860)
               {
      ...
      {
         return this.var_2032 != null;
      }
      
      public function hasShadowData() : Boolean
      {
         return this.var_2030 != null;
      }
