package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      private var var_1737:AssetTypeDeclaration;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_586 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_124 is BitmapDataAsset)
         {
            ...
            this.var_1685 = BitmapDataAsset(this.var_124).var_1685;
            this.var_1684 = BitmapDataAsset(this.var_124).var_1684;
            if(this._bitmap != null)
            {
               this.var_124 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1685 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1684 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
