package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      public function HabboNotificationViewManager(param1:IAssetLibrary, param2:IHabboWindowManager, param3:IHabboConfigurationManager, param4:IHabboToolbar, param5:Map, param6:Map)
      {
         ...
         this._toolbar.events.addEventListener(ExtensionViewEvent.const_1327,this.refreshTopMargin);
      }
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_1303,this.var_992,param1);
      ...
      {
         return this.getNextAvailableVerticalPosition() + HabboNotificationItemView.const_651 < this._windowManager.getDesktop(0).height;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc1_:int = this._toolbar.extensionView.screenHeight + const_474;
         ...
         while(_loc3_ < this.var_202.length)
         {
            ...
            if(_loc2_ + HabboNotificationItemView.const_651 < _loc4_.verticalPosition)
            {
               return _loc2_;
            }
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_651 + const_474;
            _loc3_++;
         }
         return _loc2_;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this._toolbar.extensionView.screenHeight + const_474;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_202.length)
         {
            _loc4_ = this.var_202[_loc3_] as HabboNotificationItemView;
