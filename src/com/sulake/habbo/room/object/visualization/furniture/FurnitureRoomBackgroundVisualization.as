   ...
   public class FurnitureRoomBackgroundVisualization extends FurnitureRoomBrandingVisualization
   {
      ...
      override protected function getSpriteXOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_858 != null)
         {
            ...
            _loc5_ = this.var_858[_loc4_];
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetX(param2,0) + var_1708;
            }
         }
         return super.getSpriteXOffset(param1,param2,param3) + var_1708;
      }
      ...
      override protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         if(this.var_858 != null)
         {
            ...
            if(_loc5_ != null)
            {
               return _loc5_.getOffsetY(param2,0) + var_1709;
            }
         }
         return super.getSpriteYOffset(param1,param2,param3) + var_1709;
      }
