package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private static const const_485:int = 3;
      ...
      private var var_2603:IWindowContainer;
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_828);
      }
      ...
      public function toggleCategoryView(param1:String, param2:Boolean = true, param3:Boolean = false) : void
      {
         ...
         {
            if(param3 && this.var_382 != null && this.var_382 != param1)
            {
               this.setViewToCategory(param1);
               return;
            }
            _loc4_.visible = true;
            _loc4_.activate();
            if(param1 != this.var_382 || !this.var_26.isInventoryCategoryInit(param1))
            {
               this.setViewToCategory(param1);
            }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_828);
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         {
            this.resetUnseenCounters(this.var_382);
         }
         ...
         _loc2_.container.removeChild(this.var_1928);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_382 == InventoryCategory.const_125)
            {
               this.toggleCategoryView(InventoryCategory.const_125);
            }
            else if(this.var_382 == InventoryCategory.const_74)
            {
      ...
      private function updateUnseenBadgeCount() : void
      {
         if(!this.var_1929)
         {
            this.var_1929 = this.createCounter("badges");
         }
         var _loc1_:int = this.var_26.badgesModel.getUnseenItemCount();
         this.updateCounter(this.var_1929,_loc1_);
      ...
      private function createCounter(param1:String) : IWindowContainer
      {
         ...
         if(_loc4_)
         {
            ...
            _loc3_.x = _loc4_.width - _loc3_.width - const_485;
            _loc3_.y = const_485;
         }
         return _loc3_;
      }
