package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_1641:String = "tile_cursor";
      
      private static const const_1137:int = -3;
      
      private static const const_1640:String = "selection_arrow";
      ...
      private var var_881:IRoomObjectFactory = null;
      
      private var var_579:IRoomObjectVisualizationFactory = null;
      
      private var var_318:IAdManager = null;
      
      private var var_415:ISessionDataManager = null;
      ...
      private var var_883:NumberBank;
      ...
      public function RoomEngine(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_883 = new NumberBank(1000);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_881.release(new IIDRoomObjectFactory());
            this.var_881 = null;
         }
         if(this.var_579 != null)
         {
            this.var_579.release(new IIDRoomObjectVisualizationFactory());
            this.var_579 = null;
         }
         ...
         if(this.var_298 != null)
         {
            ...
            {
               _loc2_ = this.var_298.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         if(this.var_298 != null)
         {
            _loc4_ = this.var_298.getValue(_loc3_) as RoomInstanceData;
            if(_loc4_ == null)
            {
               _loc4_ = new RoomInstanceData(param1,param2);
               this.var_298.add(_loc3_,_loc4_);
            }
         }
         return _loc4_;
      }
      ...
      {
         return this.getRoomCamera(this.var_89,this.var_90);
      }
      ...
      public function requestMouseCursor(param1:String, param2:int, param3:String) : void
      {
         ...
         switch(param1)
         {
            case RoomObjectFurnitureActionEvent.const_311:
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:IRoomSession = this.var_15.getSession(this.var_89,this.var_90);
      ...
      public function addFloorHole(param1:int, param2:int, param3:int) : void
      {
         ...
         if(param3 >= 0)
         {
            ...
            if(_loc5_ != null && _loc5_.getModel() != null && _loc4_ != null && _loc4_.getEventHandler() != null)
            {
               ...
               _loc10_ = _loc5_.getModel().getNumber(RoomObjectVariableEnum.const_352);
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1087 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         {
            _loc5_ = this.var_298.getWithIndex(_loc3_) as RoomInstanceData;
            _loc6_ = null;
            _loc7_ = 0;
            _loc8_ = 0;
            if(_loc5_ != null)
            ...
            if(_loc6_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  if(_loc7_ != this.var_89 || _loc8_ != this.var_90 || !this.var_1086)
                  {
         ...
         var _loc4_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_90,1);
         if(_loc4_ != null)
         {
            if(this.var_1086)
            {
               _loc4_.screenOffsetX += this.var_1631;
               _loc4_.screenOffsetY += this.var_1629;
               this.var_1631 = 0;
               this.var_1629 = 0;
            }
         }
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_976) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_959) - 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_787) + 0.5;
                  _loc20_ = _loc10_.getNumber(RoomVariableEnum.const_1000) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_881 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_579 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_14 != null)
         {
            this.var_14.visualizationFactory = this.var_579;
         }
         this.initializeRoomManager();
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_14 != null)
         {
            events.addEventListener(RoomContentLoader.const_820,this.onContentLoaderReady);
            this.var_14.initialize(events,this.var_151);
         }
         this.var_2815 = this.var_151.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_820)
         {
            this.var_2812 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_318.events.addEventListener(AdEvent.const_637,this.showRoomAd);
         this.var_318.events.addEventListener(AdEvent.const_930,this.onRoomAdImageLoaded);
         this.var_318.events.addEventListener(AdEvent.const_1213,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_14.sessionDataManager = this.var_415;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_881 != null)
         {
            this.var_881.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_881 == null || this.var_579 == null || this._roomManager == null || this._roomRendererFactory == null || this._communication == null || this.var_151 == null || !this.var_2812)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         if(param1)
         {
            ...
            {
               _loc3_ = this.var_412.getWithIndex(_loc2_) as RoomData;
               if(_loc3_ != null)
               {
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1281,_loc5_);
            if(_loc5_ == 0)
            {
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1281);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         if(!this.var_577)
         {
            _loc5_ = this.var_412.remove(_loc4_);
            if(_loc5_ != null)
            {
            ...
            this.var_412.add(_loc4_,_loc5_);
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1167,_loc12_,true);
            if(this.var_14 != null)
            {
         ...
         if(param2 != null)
         {
            ...
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_976,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_787,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_959,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_1000,_loc18_);
         ...
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_753,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_213,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_886,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_228,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1019,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_224,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_577,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_298);
                        ...
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              ...
                              _loc7_.setNumber(RoomObjectVariableEnum.const_970,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_852,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_970,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1340,_loc27_,true);
         ...
         _loc7_.createRoomObject(const_1136,const_1641,RoomObjectCategoryEnum.const_324);
         if(this.var_151.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1137,const_1640,RoomObjectCategoryEnum.const_324);
         }
         return _loc7_;
      }
      ...
      public function updateObjectRoom(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null, param6:Boolean = false) : Boolean
      {
         ...
         if(_loc7_ == null)
         {
            ...
            _loc11_ = this.var_412.getValue(_loc10_);
            if(_loc11_ == null)
            {
               _loc11_ = new RoomData(param1,param2,null);
               this.var_412.add(_loc10_,_loc11_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_753,param3);
         ...
         if(param4 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_228,param4);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_886,param4);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         if(param5 != null)
         {
            if(_loc8_ != null && !param6)
            {
               _loc8_.setString(RoomObjectVariableEnum.const_224,param5);
            }
            _loc9_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_1019,param5);
            _loc7_.getEventHandler().processUpdateMessage(_loc9_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1787,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1175,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1381,param4);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
         return true;
      }
      ...
      public function updateObjectRoomPlaneThicknesses(param1:int, param2:int, param3:Number, param4:Number) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlanePropertyUpdateMessage(RoomObjectRoomPlanePropertyUpdateMessage.const_1204,param3);
         _loc5_.getEventHandler().processUpdateMessage(_loc6_);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_298.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_375,param1,param2));
      }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1243;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_970);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1340);
      ...
      public function method_4(param1:int, param2:int, param3:int) : Point
      {
         var _loc4_:IRoomRenderingCanvas = this.getRoomCanvas(param1,param2,param3);
         if(_loc4_ == null)
         {
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1628;
         var _loc9_:int = param3 - this.var_1627;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1086 = true;
               this.var_882 = false;
               this.var_2813 = this.var_1628;
               this.var_2814 = this.var_1627;
            }
         }
         else if(param4 == MouseEvent.MOUSE_UP)
         {
            if(this.var_1086)
            {
               ...
               if(this.var_882)
               {
                  _loc10_ = this.getRoomInstanceData(this.var_89,this.var_90);
                  if(_loc10_ != null)
                  {
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1086)
            {
               ...
               {
                  this.var_1631 += _loc8_;
                  this.var_1629 += _loc9_;
                  this.var_882 = true;
               }
            }
         }
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc9_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_90,param1);
         if(_loc9_ != null)
         {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_569,this.var_89,this.var_90,-1,RoomObjectCategoryEnum.const_140));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_76 != null)
                  {
                     ...
                     this.var_76.handleRoomObjectEvent(_loc14_,this.var_89,this.var_90);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         if(param3)
         {
            _loc5_ = this.getRoomObjectImage(this.var_89,this.var_90,param1,param2,new Vector3d(),1,null);
         }
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_90,this.var_1630);
         if(_loc6_ != null)
         {
            ...
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1628 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1627 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_90,this.var_1630);
         if(_loc2_ != null)
         {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_89,this.var_90,this.var_1630);
         if(_loc1_ != null)
         {
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            return this.var_76.modifyRoomObject(this.var_89,this.var_90,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_76 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_76.modifyRoomObjectData(this.var_89,this.var_90,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_76 != null)
         {
            ...
            {
               return this.var_76.modifyWallItemData(this.var_89,this.var_90,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_76 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_25)
            {
               return this.var_76.deleteWallItem(this.var_89,this.var_90,param1);
            }
         }
         return false;
      }
      ...
      {
         var _loc5_:IRoomInstance = this.getRoom(this.var_89,this.var_90);
         ...
         if(this.var_76 != null)
         {
            return this.var_76.initializeRoomObjectInsert(this.var_89,this.var_90,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_76 != null)
         {
            this.var_76.cancelRoomObjectInsert(this.var_89,this.var_90);
         }
      }
      ...
      {
         var _loc4_:* = null;
         var _loc3_:IRoomObject = this.getRoomObject(this.var_89,this.var_90,param1,param2);
         if(_loc3_ != null)
         {
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1137,RoomObjectCategoryEnum.const_324);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1136,RoomObjectCategoryEnum.const_324);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc9_ != null && _loc9_.getModelController() != null && _loc5_)
         {
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_304,param4.typeId,true);
            ...
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1191,getTimer());
            if(param4.knownAsUsable)
            {
               _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_734,1);
            }
         }
      ...
      public function changeObjectState(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         {
            _loc6_ = Number(_loc5_.getModelController().getNumber(RoomObjectVariableEnum.const_985));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
            ...
            _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_985,_loc6_);
         }
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         if(_loc8_ != null && _loc8_.getModelController() != null)
         {
            ...
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_304,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_408,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1243,1,true);
            if(param4.knownAsUsable)
            {
               _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_734,1);
            }
         }
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_191,param1,param2,param3,RoomObjectCategoryEnum.const_25));
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            if(_loc7_.getModel() != null)
            {
               ...
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1214);
                  ...
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_991,_loc5_);
                  }
               }
            }
         }
      ...
      public function addObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:Number, param7:int, param8:String = null) : Boolean
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_191,param1,param2,param3,RoomObjectCategoryEnum.const_28));
         }
         return true;
      }
      ...
      public function updateObjectUserAction(param1:int, param2:int, param3:int, param4:String, param5:int, param6:String = null) : Boolean
      {
         ...
         switch(param4)
         {
            case RoomObjectVariableEnum.const_195:
               ...
               break;
            case RoomObjectVariableEnum.const_297:
            ...
            case RoomObjectVariableEnum.const_249:
               ...
               break;
            case RoomObjectVariableEnum.const_663:
            ...
            case RoomObjectVariableEnum.const_342:
               ...
               break;
            case RoomObjectVariableEnum.const_282:
               _loc8_ = new RoomObjectAvatarUseObjectUpdateMessage(param5);
               break;
            case RoomObjectVariableEnum.const_576:
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            if(_loc4_.disposeObject(param2,param3))
            {
               if(events != null)
               {
                  events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_410,this.var_89,this.var_90,param2,param3));
               }
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_76 != null)
         {
            this.var_76.handleRoomObjectEvent(param1,this.var_89,this.var_90);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_25:
                     ...
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_325);
                     break;
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_228,_loc5_);
               param1.getModelController().setString(RoomObjectVariableEnum.const_224,_loc6_);
               if(_loc7_ != null)
               {
                  _loc13_ = null;
                  _loc14_ = "undefined_1";
                  _loc13_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_577,_loc14_,_loc7_,new Vector3d(2.5,0.5,2));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         var _loc12_:int = this.var_883.reserveNumber();
         ...
         switch(_loc13_)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_325,param7);
               break;
            case RoomObjectCategoryEnum.const_28:
               ...
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_765,int(param2));
               }
               break;
         ...
         {
            this.var_1328.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1346,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_883.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_89,this.var_90,const_391,RoomObjectCategoryEnum.const_84,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1346);
               ...
               this.var_883.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1328.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc6_ != null && _loc6_.getModel() != null && _loc6_.getEventHandler() != null)
         {
            ...
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_822,_loc4_,_loc5_,param2,param3));
            }
         }
      }
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_14 != null)
         {
            ...
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1284,param1.adWarningL,true);
            this.var_14.addGraphicAsset(this.var_14.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1282,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1309,RoomObjectVariableEnum.const_425,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         {
            this.var_318.loadRoomAdImage(param1,param2,param3,param4,param5,param6);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_930:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1320,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_1213:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1250,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
