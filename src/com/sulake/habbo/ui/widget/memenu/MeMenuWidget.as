package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_497:String = "me_menu_my_clothes_view";
      
      public static const const_1388:String = "me_menu_dance_moves_view";
      
      public static const const_1017:String = "me_menu_settings_view";
      
      public static const const_737:String = "me_menu_sound_settings";
      
      private static const const_1103:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2616 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_1945 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_913,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_782,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_997,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_804,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1367,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1351,this.onHideAvatarEditor);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_171,this.onAvatarDeselected);
         ...
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_394,this.onSettingsUpdate);
         param1.addEventListener(RoomWidgetTutorialEvent.const_129,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetTutorialEvent.const_656,this.onTutorialEvent);
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_124,this.onCreditBalance);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.onNormalMode);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_459,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_913,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_782,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_997,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_804,this.onToolbarClicked);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_171,this.onAvatarDeselected);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1351,this.onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_114,this.onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_394,this.onSettingsUpdate);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_656,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetTutorialEvent.const_129,this.onTutorialEvent);
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_124,this.onCreditBalance);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_557 && this.var_53.window.name == const_497))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_932);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_737)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_656:
               Logger.log("* MeMenuWidget: onHighlightClothesIcon " + this.var_557 + " view: " + this.var_53.window.name);
               if(this.var_557 != true || this.var_53.window.name != const_189)
               {
                  return;
               }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_497)
         {
            this.hide();
         }
      }
      ...
      {
         var _loc2_:* = param1.daysLeft != this.var_1545;
         this.var_1545 = param1.daysLeft;
         this.var_2619 = param1.periodsLeft;
         this.var_3076 = param1.pastPeriods;
         this.var_2620 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1934);
         this.var_1934 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
