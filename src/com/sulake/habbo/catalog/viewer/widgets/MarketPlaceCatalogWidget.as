package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2348:int = 40;
      
      private const const_2349:int = 10;
      
      private var var_793:Array;
      
      private var var_1497:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_533)
         {
            this.var_533.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_533 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_793 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_793 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_793));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_643)
         {
            ...
            this.var_643 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_643)
         {
            return;
         ...
         if(!this.var_533)
         {
            this.var_533 = new Timer(25);
            this.var_533.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1193 = 0;
         this.populateList();
         this.var_533.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1193 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1193));
            ++this.var_1193;
            _loc1_++;
         }
         return false;
      ...
      {
         var _loc5_:* = null;
         this.updateStatusDisplay(this.const_2080);
         var _loc1_:int = -1;
         var _loc2_:int = -1;
         var _loc3_:String = "";
         var _loc4_:int = 1;
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_793.length)
         {
            _loc4_ = this.var_793[_loc6_.selection];
         }
         ...
         else if(param1.type == WindowEvent.const_117)
         {
            ...
            switch(_loc7_.name)
            {
               ...
               case "max_price_input":
                  _loc8_ = this.const_2349;
                  break;
               case "search_input":
                  _loc8_ = this.const_2348;
                  break;
               default:
                  return;
            }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1497.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_47)
