package com.sulake.habbo.avatar.common
{
   ...
   public class CategoryData
   {
      ...
      private const const_2386:int = 2;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_306)
         {
            for each(_loc2_ in this.var_306 as Array)
            {
               if(_loc2_)
               {
      ...
      public function selectPartIndex(param1:int) : AvatarEditorGridPartItem
      {
         ...
         if(this.var_1112 >= 0 && this._parts.length > this.var_1112)
         {
            _loc2_ = this._parts[this.var_1112];
            if(_loc2_)
            {
               _loc2_.isSelected = false;
            }
      ...
      public function getSelectedColorIds() : Array
      {
         ...
         if(!this.var_306 || this.var_306.length == 0)
         {
            return null;
         }
         var _loc1_:Array = this.var_306[0] as Array;
      ...
      public function getPalette(param1:int) : Array
      {
         ...
         if(this.var_306.length <= param1)
         {
            return null;
         }
         return this.var_306[param1] as Array;
      }
      
      public function getCurrentPart() : AvatarEditorGridPartItem
      {
         return this._parts[this.var_1112] as AvatarEditorGridPartItem;
      }
