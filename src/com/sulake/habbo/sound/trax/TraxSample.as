package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSample implements IDisposable
   {
      ...
      public static const const_1766:String = "sample_44khz";
      
      public static const const_1764:String = "sample_22khz";
      
      public static const const_1756:String = "sample_11khz";
      ...
      public function TraxSample(param1:ByteArray, param2:int, param3:String = "sample_44khz", param4:String = "sample_16bit")
      {
         ...
         var _loc6_:int = this.var_178 * this.var_87;
         ...
         while(_loc11_ < _loc10_)
         {
            ...
            {
               this.var_134[int(_loc11_ / this.var_178)] = _loc9_;
               _loc9_ = 0;
            }
            _loc11_++;
         }
      ...
      {
         return this.var_134.length * this.var_178 * this.var_87;
      }
      ...
      public function setSample(param1:Vector.<int>, param2:int, param3:int, param4:int) : int
      {
         ...
         var _loc5_:int = this.var_178 * this.var_87;
         param4 /= _loc5_;
         if(param2 < 0)
         {
            param3 += param2;
