package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationItemView implements IUpdateReceiver
   {
      ...
      public static const const_651:int = 70;
      ...
      public function HabboNotificationItemView(param1:IAsset, param2:IHabboWindowManager, param3:Map, param4:Map, param5:HabboNotificationItem)
      {
         ...
         if(_loc7_ != null)
         {
            this.var_1827 = this._window.height - _loc7_.rectangle.bottom;
         }
         else
         {
            this.var_1827 = 15;
         }
         this.var_1825 = this._window.height;
         this.var_1499 = 4;
         this._blend = 0;
         this._state = name_4;
      ...
      public function update(param1:uint) : void
      {
         ...
         switch(this._state)
         {
            ...
            case const_605:
               ...
               _loc2_ = Number(this.var_1197) / Number(this.var_992["time_fade_in"]);
               if(this.var_1197 > int(this.var_992["time_fade_in"]))
               {
                  this.startDisplay();
               }
            ...
            case const_1058:
               ...
               if(this.var_1498 > int(this.var_992["time_display"]) && !this.var_1826)
               {
                  this.startFadeOut();
               }
               break;
            case const_1057:
               ...
               _loc3_ = 1 - Number(this.var_1196) / Number(this.var_992["time_fade_out"]);
               this.adjustBlend(_loc3_);
               if(this.var_1196 > int(this.var_992["time_fade_in"]))
               {
                  this.startIdling();
               }
         }
      ...
      private function setNotificationText(param1:String) : void
      {
         ...
         _loc2_.text = param1;
         _loc2_.height = _loc2_.textHeight + this.var_1827;
         if(this._window.height < this.var_1825)
         {
            this._window.height = this.var_1825;
         }
      }
      ...
      public function reposition(param1:int = -1) : void
      {
         ...
         this._window.x = _loc2_.width - this._window.width - const_1834;
         this._window.y = this.var_1499;
      }
