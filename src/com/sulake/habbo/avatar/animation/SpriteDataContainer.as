package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2654 = String(param2.@member);
         this.var_2655 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1566 = [];
         this.var_1567 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1566[_loc4_] = parseInt(_loc3_.@dy);
            this.var_1567[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1566.length)
         {
            return this.var_1566[param1];
         }
         return 0;
      }
      ...
      {
         if(param1 < this.var_1567.length)
         {
