package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_421:AdImageRequest;
      
      private var var_1391:BitmapData = null;
      
      private var var_1392:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3005 = this._config.getKey("interstitial.enabled","HabboFriendBarCom_im_notification_icon_png") == "true";
         this.var_3007 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_3008 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2175 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_1390 == 0)
         {
            this.var_1390 = getTimer();
            return false;
         }
         if(this.var_2175 > 0 && this.var_2174 >= this.var_2175)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1390;
         if(_loc1_ > this.var_3007)
         {
            ++this.var_2174;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1678 = _loc2_.imageUrl;
         this.var_3006 = _loc2_.clickUrl;
         this.var_1390 = getTimer();
         if(this.var_1678 != "")
         {
            _loc3_ = this.var_1678;
            ...
            {
               this.var_265 = new Timer(this.var_3008,1);
            ...
            this.var_265.start();
            _loc4_ = new URLRequest(this.var_1678);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_579,param1.bitmapData,this.var_3006));
            this.var_1390 = getTimer();
         }
         else
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_523));
         }
      }
      
      public function showRoomAd(param1:int, param2:int) : void
      {
         this.var_421 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_421 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_421 = new AdImageRequest(this.var_421.roomId,this.var_421.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_421 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_637,this.var_421.roomId,this.var_421.roomCategory,_loc4_,_loc2_.assetName,this.var_421.clickURL,this.var_1391,this.var_1392));
            this.var_421 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1391 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1392 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function loadRoomAdImage(param1:int, param2:int, param3:int, param4:int, param5:String, param6:String) : void
      {
         ...
         var _loc8_:Array = this.var_736.getValue(_loc7_);
         if(_loc8_ == null)
         {
            _loc8_ = new Array();
            this.var_736.add(_loc7_,_loc8_);
         }
         if(_loc8_.length > 0)
         {
      ...
      private function onBillboardImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Bitmap = _loc2_.assetLoader.content as Bitmap;
         var _loc4_:Array = this.var_736.remove(_loc2_.assetName);
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_930,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
      ...
      private function onBillboardImageLoadError(param1:AssetLoaderEvent) : void
      {
         var _loc4_:* = null;
         var _loc2_:AssetLoaderStruct = param1.target as AssetLoaderStruct;
         var _loc3_:Array = this.var_736.remove(_loc2_.assetName);
