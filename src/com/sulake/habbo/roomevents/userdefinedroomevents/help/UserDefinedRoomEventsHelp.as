package com.sulake.habbo.roomevents.userdefinedroomevents.help
{
   ...
   public class UserDefinedRoomEventsHelp
   {
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_2051 = IWindowContainer(this.find(this._window,"help_container"));
         this.var_1313 = this.var_2051.findChildByName("button_previous") as IContainerButtonWindow;
         if(this.var_1313)
         {
            this.var_1313.procedure = this.onButtonClick;
         }
         this.var_1312 = this.var_2051.findChildByName("button_next") as IContainerButtonWindow;
         if(this.var_1312)
         {
            this.var_1312.procedure = this.onButtonClick;
         }
      ...
      {
         if(this.var_294 >= this.var_73.length - 1)
         {
            this.var_1312.disable();
         }
         else
         {
            this.var_1312.enable();
         }
         if(this.var_294 <= 0)
         {
            this.var_1313.disable();
         }
         else
         {
            this.var_1313.enable();
         }
      }
      ...
      {
         ++this.var_294;
         this.var_294 = Math.min(this.var_294,this.var_73.length - 1);
         this.openPage();
      }
      ...
      {
         --this.var_294;
         this.var_294 = Math.max(this.var_294,0);
         this.openPage();
      }
      ...
      private function localize() : void
      {
         ...
         if(_loc1_)
         {
            _loc1_.text = ILocalization(this.var_73[this.var_294][0]).value;
         }
         if(_loc2_)
         {
            _loc2_.text = ILocalization(this.var_73[this.var_294][2]).value;
         }
         if(_loc3_)
         {
            _loc4_ = ILocalization(this.var_73[this.var_294][1]).value;
