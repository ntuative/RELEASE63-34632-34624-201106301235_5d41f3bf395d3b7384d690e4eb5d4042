package com.sulake.habbo.ui.handler
{
   ...
   public class FriendRequestWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserLocationMessage.const_754);
         _loc1_.push(RoomWidgetFriendRequestMessage.const_977);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetUserLocationMessage.const_754:
               ...
               break;
            case RoomWidgetFriendRequestMessage.const_977:
