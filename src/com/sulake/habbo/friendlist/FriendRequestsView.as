package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      {
         this.var_2179 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_2180 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_2180.procedure = this.onDismissAllButtonClick;
         this.var_2179.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         else if(param1.state == FriendRequest.const_1166)
         {
      ...
      public function acceptAllRequests() : void
      {
         ...
         for each(_loc2_ in this._friendList.friendRequests.requests)
         {
            if(_loc2_.state != FriendRequest.const_404 && _loc2_.state != FriendRequest.const_403)
            {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_2179,_loc1_);
         this.setEnabled(this.var_2180,_loc1_);
      }
