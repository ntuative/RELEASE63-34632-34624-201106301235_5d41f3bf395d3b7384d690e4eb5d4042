package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListEditorWidget extends RoomWidgetBase
   {
      ...
      private static const const_1483:int = 100;
      
      private static const const_1486:int = 130;
      
      private static const const_1484:int = 100;
      
      private static const const_1487:int = 130;
      
      private static const const_1485:int = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_859,this.onInventoryUpdatedEvent);
         param1.addEventListener(RoomWidgetPlayListEditorEvent.const_821,this.onSongDiskInventoryUpdatedEvent);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_859,this.onInventoryUpdatedEvent);
         param1.removeEventListener(RoomWidgetPlayListEditorEvent.const_821,this.onSongDiskInventoryUpdatedEvent);
      ...
      public function getDiskColorTransformFromSongData(param1:String) : ColorTransform
      {
         ...
         _loc2_ = uint(_loc2_ % const_1483 + const_1488);
         _loc3_ = uint(_loc3_ % const_1484 + const_1486);
         _loc4_ = uint(_loc4_ % const_1485 + const_1487);
      ...
      public function sendAddToPlayListMessage(param1:int) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc4_ = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_834,_loc3_,param1);
      ...
      {
         var _loc2_:RoomWidgetPlayListModificationMessage = new RoomWidgetPlayListModificationMessage(RoomWidgetPlayListModificationMessage.const_903,param1);
         if(messageListener != null)
         {
      ...
      public function sendTogglePlayPauseStateMessage() : void
      {
         ...
         var _loc2_:RoomWidgetPlayListPlayStateMessage = new RoomWidgetPlayListPlayStateMessage(RoomWidgetPlayListPlayStateMessage.const_882,this._furniId,_loc1_);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc2_);
         }
      ...
      public function playUserSong(param1:int) : void
      {
         ...
         this._soundManager.musicController.playSong(param1,HabboMusicPrioritiesEnum.const_447,0,0,0,0);
      }
      
      public function stopUserSong() : void
      {
         this._soundManager.musicController.stop(HabboMusicPrioritiesEnum.const_447);
      }
      ...
      {
         var _loc1_:RoomWidgetPlayListUserActionMessage = new RoomWidgetPlayListUserActionMessage(RoomWidgetPlayListUserActionMessage.const_746);
         if(messageListener != null)
         {
            messageListener.processWidgetMessage(_loc1_);
         }
         this._catalog.openCatalogPage(CatalogPageName.const_1939,true);
      }
