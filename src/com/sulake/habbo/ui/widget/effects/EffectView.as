package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectView
   {
      ...
      private const const_2353:int = 1000;
      
      private var _widget:EffectsWidget;
      
      private var _window:IWindowContainer;
      
      private var var_132:IWidgetAvatarEffect;
      
      private var var_660:IWindow;
      
      private var var_346:Number;
      
      private var var_546:ITextWindow;
      
      private var var_228:Timer;
      
      private var var_661:IWindow;
      ...
      public function EffectView(param1:EffectsWidget, param2:IWidgetAvatarEffect)
      {
         ...
         this.var_132 = param2;
         this._widget = param1;
         this.var_228 = new Timer(this.const_2353);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_132.isActive)
         {
            _loc2_ = this.var_132.secondsLeft / Number(this.var_132.duration);
            this.var_660.width = _loc2_ * this.var_346;
         }
         else
         {
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_546 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_546 == null)
            {
               return;
            }
         ...
         if(!this.var_132.isActive)
         {
            this.var_546.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_546.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_546.text;
         var _loc2_:int = this.var_132.secondsLeft;
      ...
      public function update() : void
      {
         ...
         if(!this._window)
         {
            this._window = this._widget.windowManager.createWindow("","",HabboWindowType.const_77,HabboWindowStyle.const_30,HabboWindowParam.const_64) as IWindowContainer;
         }
         ...
         this.var_546 = null;
         var _loc2_:String = "";
         if(this.var_132.isInUse)
         {
            _loc2_ = "memenu_effect_selected";
         }
         else if(this.var_132.isActive)
         {
         ...
         else
         {
            ...
            this.var_661 = this._window.findChildByName("effect_hilite");
            this.var_661.visible = false;
         }
         this.setTimeLeft();
         this.var_660 = this._window.findChildByName("loader_bar");
         if(this.var_660 != null)
         {
            this.var_346 = this.var_660.width;
            this.var_228.start();
            this.onUpdate();
         }
         if(this.var_132.icon)
         {
            this.setElementBitmap("effect_icon",this.var_132.icon);
         }
      ...
      private function onMouseEvent(param1:WindowMouseEvent) : void
      {
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               this._widget.selectEffect(this.var_132.type,this.var_132.isInUse);
         }
      }
