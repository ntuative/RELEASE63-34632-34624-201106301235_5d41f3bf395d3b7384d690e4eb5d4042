package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_2217:uint = 1;
      
      public static const COMPONENT_FLAG_CONTEXT:uint = 2;
      
      public static const const_1336:uint = 4;
       
      
      protected var var_825:uint = 0;
      ...
      private var var_585:InterfaceStructList;
      ...
      public function Component(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_585 = new InterfaceStructList();
      ...
      {
         var _loc3_:InterfaceStruct = this.var_585.getStructByInterface(param1);
         if(_loc3_ == null)
         {
      ...
      public function release(param1:IID) : uint
      {
         ...
         var _loc2_:InterfaceStruct = this.var_585.getStructByInterface(param1);
         if(_loc2_ == null)
         {
         ...
         if(this.var_1537 & const_1336)
         {
            if(_loc3_ == 0)
            {
               if(this.var_585.getTotalReferenceCount() == 0)
               {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + this.var_825 + "]";
      }
      ...
      public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc7_:uint = this.var_585.length;
         var _loc8_:int = 0;
         while(_loc8_ < _loc7_)
         {
            _loc6_ = this.var_585.getStructByIndex(_loc8_);
