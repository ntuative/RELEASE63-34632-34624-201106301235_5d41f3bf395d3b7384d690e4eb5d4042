package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1227:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_462)
         {
            this.var_462.removeEventListener(WindowEvent.const_286,this.scrollBarEventProc);
            this.var_462.removeEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            this.var_462 = null;
         }
         if(this.var_1227)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1227)
         {
            this.var_1227 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_462)
         {
            ...
            if(this.var_462)
            {
               this.var_462.addEventListener(WindowEvent.const_286,this.scrollBarEventProc);
               this.var_462.addEventListener(WindowEvent.const_255,this.scrollBarEventProc);
            }
         }
         return this.var_462;
      }
