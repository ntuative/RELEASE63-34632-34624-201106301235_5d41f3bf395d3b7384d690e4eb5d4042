package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2370:int = 2500;
      ...
      private var var_1362:UserDataManager;
      ...
      public function RoomSession(param1:int, param2:int, param3:IHabboTracking, param4:String = "", param5:String = "")
      {
         ...
         this.var_1362 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1362.connection = param1;
         }
      }
      ...
      {
         if(this._state == RoomSessionEvent.const_281 && this._connection != null)
         {
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1663));
         this.var_1664.add(this.var_1663,getTimer());
         ++this.var_1663;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1664.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2370)
            {
      ...
      {
         return this.var_1362 as IUserDataManager;
      }
