package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_184:IssueBundle;
      
      private var _window:IFrameWindow;
      
      private var var_594:UserInfoCtrl;
      
      private var var_1379:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = this.var_184.getHighestPriorityIssue();
         this.var_594 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
         this.var_1379 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
         ...
         if(this.var_184.reportedUserId > 0)
         {
            this.var_1379.load(_loc4_,this.var_184.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_184.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:Array = this.var_184.issues;
         var _loc3_:int = 0;
      ...
      {
         if(this.var_77 != null && this.var_77.issueManager != null && this.var_184 != null)
         {
            this.var_77.issueManager.removeHandler(this.var_184.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_77.issueManager.closeBundle(this.var_184.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_77.issueManager.closeBundle(this.var_184.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_77.issueManager.closeBundle(this.var_184.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_77.issueManager.releaseBundle(this.var_184.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_184.getHighestPriorityIssue().issueId;
         this.var_77.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_77,WindowTracker.const_1397,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_184.getHighestPriorityIssue();
            this.var_594 = new UserInfoCtrl(this._window,this.var_77,_loc3_.message);
