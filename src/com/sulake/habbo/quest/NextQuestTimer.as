package com.sulake.habbo.quest
{
   ...
   public class NextQuestTimer implements IDisposable
   {
      ...
      public static const const_797:int = 1000;
      ...
      private function refresh() : void
      {
         ...
         if(_loc1_ < 1)
         {
            ...
            this.var_48.questController.onQuest(this.var_133);
         }
         ...
         this._window.findChildByName("quest_header_txt").caption = this.var_48.localization.getKey("quests.nextquesttimer.caption." + (!!this.var_539 ? "expanded" : "contracted"));
      ...
      {
         this._window.findChildByName("quest_timer_expanded").visible = this.var_539;
         this._window.findChildByName("quest_timer_contracted").visible = !this.var_539;
         this._window.findChildByName("more_info_txt").visible = this.var_539 && this.var_48.currentlyInRoom;
         this._window.findChildByName("more_info_region").visible = this.var_539 && this.var_48.currentlyInRoom;
         this._window.findChildByName("quest_pic_bitmap").visible = this.var_539;
         this._window.findChildByName("desc_txt").visible = this.var_539;
         this.refresh();
      }
      ...
      private function onMoreInfo(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            this.var_48.questController.questDetails.showDetails(this.var_133);
         }
      }
