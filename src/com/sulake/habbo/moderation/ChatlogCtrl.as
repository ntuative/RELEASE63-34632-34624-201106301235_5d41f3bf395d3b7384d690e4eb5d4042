package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_976:Array = [];
      
      private static var var_1773:int = 1000;
      
      private static var var_977:Array = [];
      
      private static var var_1775:int = 200;
      ...
      private var var_1728:IMessageComposer;
      ...
      {
         this.var_779 = IWindowContainer(this.var_35.getXmlWindow("chatlog_roomheader"));
         this.var_778 = IWindowContainer(this.var_35.getXmlWindow("chatlog_chatline"));
         this.var_556 = new Timer(1000,1);
         ...
         this.var_35.connection.send(this.var_1728);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_976.pop() as IWindowContainer;
         }
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_977.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_779.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_977.length < var_1775)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_779.width;
            param1.height = this.var_779.height;
            var_977.push(param1);
         }
         else
         {
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1774[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1473.getValue(param2.chatterName))
            {
               this.var_1473.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1473.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1474)
         {
