package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      private static const const_1498:Point = new Point(100,30);
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:Array)
      {
         ...
         var _loc5_:* = null;
         this.var_1238 = [];
         this.var_1530 = [AvatarEditorFigureCategory.const_902,AvatarEditorFigureCategory.const_56,AvatarEditorFigureCategory.const_279,AvatarEditorFigureCategory.const_1001,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_111];
         super();
         this.var_23 = param1;
         if(var_1406 == null)
         {
         ...
         this._saveTimer = new Timer(const_1552,1);
         this._saveTimer.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param2 == null)
         {
            param2 = this.var_1530;
         }
         for each(_loc3_ in param2)
         {
            this.var_1238.push(_loc3_);
         }
         this.createWindow();
      }
      ...
      public function getFrame(param1:Array, param2:String = null) : IFrameWindow
      {
         ...
         this.var_84.position = const_1498;
      ...
      public function embedToContext(param1:IWindowContainer, param2:Array) : Boolean
      {
         ...
         else
         {
            if(this.var_666 == null)
            {
               this.var_666 = this.var_23.manager.windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1530);
         }
         if(param1.length != this.var_1238.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1238.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function createWindow() : void
      {
         ...
         while(_loc1_ >= 0)
         {
            ...
            if(_loc2_ != null && this.var_1238.indexOf(_loc2_.name) < 0)
            {
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1530;
      ...
      public function update() : void
      {
         ...
         if(this.var_23.manager.sessionData && this.var_23.manager.sessionData.clubLevel >= HabboClubLevelEnum.const_34 && (this.var_1529 == AvatarEditorSideCategory.const_111 || this.var_2564))
         {
            _loc4_ = "null";
         }
      ...
      {
         if(this.var_1529 == AvatarEditorSideCategory.const_111)
         {
            this.var_2564 = false;
            this.setSideContent(AvatarEditorSideCategory.const_565);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_565:
               break;
            case AvatarEditorSideCategory.const_522:
               _loc3_ = this.var_23.getSideContentWindowContainer(AvatarEditorSideCategory.const_522);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_333)
         {
            ...
            this.var_333 = this.var_23.manager.windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_333.procedure = this.stripClubDialogEventProc;
            this.var_333.center();
         }
         else
         {
      ...
      private function openCatalogClubPage() : void
      {
         ...
         {
            this.var_23.manager.catalog.openCatalogPage(CatalogPageName.const_128,true);
         }
      }
   }
}
