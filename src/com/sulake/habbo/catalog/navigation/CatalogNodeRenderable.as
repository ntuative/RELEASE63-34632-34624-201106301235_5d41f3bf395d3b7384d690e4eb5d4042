package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1426:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1443:XML;
      
      private static var var_1444:XML;
       
      
      private var var_1723:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_3063:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1444 == null)
         {
            ...
            var_1444 = _loc4_.content as XML;
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1723 == 4294967295)
            {
               this.var_1723 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_2033;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1972;
            }
         }
      }
      ...
      {
         this.var_67 = navigator.catalog.windowManager.buildFromXML(var_1444) as IItemListWindow;
         if(this.var_67 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1443) as IWindowContainer;
         }
         else
         {
