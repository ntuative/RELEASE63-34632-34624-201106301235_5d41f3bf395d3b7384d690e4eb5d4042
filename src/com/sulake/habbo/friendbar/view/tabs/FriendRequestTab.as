package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1565 ? var_1565 : new FriendRequestTab();
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_331,WindowStyle.const_103,WindowParam.const_29,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_402,WindowStyle.const_103,WindowParam.const_32,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            if(param2.name == const_1038)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1587;
            }
         }
      }
