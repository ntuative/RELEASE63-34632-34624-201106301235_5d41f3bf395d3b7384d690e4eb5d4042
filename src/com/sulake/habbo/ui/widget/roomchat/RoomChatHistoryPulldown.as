package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_1100:int = 150;
      
      private static const const_1099:int = 250;
      ...
      private var var_2600:BitmapData;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_42 = param3;
         this.var_2600 = (this._assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         this.var_1922 = (this._assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         this.var_2595 = (this._assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         this.var_1924 = (this._assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         this.var_1923 = (this._assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         this.var_2596 = (this._assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         this.var_2599 = (this._assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         this.var_86 = this._windowManager.createWindow("chat_history_bg","",HabboWindowType.const_367,HabboWindowStyle.const_30,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_86),null,0,0) as IBitmapWrapperWindow;
         this.var_42.addChild(this.var_86);
         this._window = this._windowManager.createWindow("chat_pulldown","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,this.var_42.height - const_86,param3.width,const_86),null,0) as IWindowContainer;
         this.var_42.addChild(this._window);
         this._region = this._windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_331,HabboWindowStyle.const_46,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_86),null,0) as IRegionWindow;
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_605:
               this.var_86.blend += param1 / const_1099;
               this._window.blend += param1 / const_1099;
               ...
               break;
            case const_1057:
               this.var_86.blend -= param1 / const_1100;
               this._window.blend -= param1 / const_1100;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         if(this._region != null)
         {
            ...
            this._region.width = this.var_42.width - this.var_2597;
         }
         if(this.var_86 != null)
         {
            this.var_86.rectangle = this.var_42.rectangle;
            this.var_86.height -= const_86;
         }
         this.buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(this.var_2598 == this._window.width)
         {
            return;
         }
         this.var_2598 = this._window.width;
         ...
         {
            barHandle.bitmap = this.var_2595;
            barHandle.disposesBitmap = false;
            barX.bitmap = this.var_1924;
            barX.disposesBitmap = false;
            this.var_2597 = this._window.width - barX.x;
         }
         ...
         if(barBg != null && barGripL != null && barGripR != null)
         {
            try
            {
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_2600,destBgBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1922,destGripLBitmap);
               ...
               if(width > 0 && height > 0)
               {
                  ...
                  this.tileBitmapHorz(this.var_1922,destGripRBitmap);
         ...
         this.var_86.bitmap = this.var_2599;
