package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1289;
         if(this.var_1289 < this.var_1055.length)
         {
            _loc1_ = this.var_1055[this.var_1289] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1055[this.var_1289] as Dictionary;
