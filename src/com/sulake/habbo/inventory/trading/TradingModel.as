package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1798:uint = 9;
      
      public static const const_229:uint = 0;
      
      public static const const_227:uint = 1;
      
      public static const const_437:uint = 2;
      
      public static const const_383:uint = 3;
      
      public static const const_593:uint = 4;
      ...
      public function startTrading(param1:int, param2:String, param3:Boolean, param4:int, param5:String, param6:Boolean) : void
      {
         ...
         this.var_61.updateItemList(this.var_903);
         this.var_61.updateItemList(this.var_1668);
      ...
      public function close() : void
      {
         if(this.var_810)
         {
            if(this._state != const_229 && this._state != const_266)
            {
      ...
      {
         Logger.log("OLD STATE: " + this._state + " NEW STATE: " + param1 + " OWN: " + this.var_904 + " OTHER: " + this.var_1373);
         ...
         {
            case const_229:
               if(param1 == const_227 || param1 == const_266)
               {
                  this._state = param1;
                  _loc2_ = true;
               }
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            this.var_61.alertPopup(TradingView.const_1391);
         }
         else if(param1 is TradingAcceptEvent)
         {
            ...
            {
               this.var_904 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               this.var_1373 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            this.var_61.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               this.var_61.alertPopup(TradingView.const_1287);
            }
            this.close();
         }
      ...
      public function requestAddItemToTrading(param1:int, param2:int, param3:int, param4:Boolean, param5:String = "") : Boolean
      {
         ...
         if(this.var_307.length < const_1798)
         {
