package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private static const const_706:Point = new Point(0,0);
      
      private static const const_385:int = 50;
      
      private static const const_1443:int = 50;
      
      private static const const_1047:Number = 60;
      
      private static const const_1444:Number = 50;
      ...
      private var var_1476:IRoomRenderingCanvasMouseListener = null;
      ...
      private var var_2374:Number = -1.0E7;
      ...
      private var var_3066:Boolean = false;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         this._id = param2;
         this.var_271 = new Sprite();
         this.var_271.mouseEnabled = false;
         this.var_110 = new Sprite();
         this.var_110.name = "canvas";
         this.var_110.mouseEnabled = false;
         this.var_271.addChild(this.var_110);
      ...
      {
         this.var_525.y -= param1 - this.var_633;
         this.var_633 = param1;
      }
      ...
      {
         if(param1 && !this.var_1075)
         {
            this.var_1075 = true;
            if(this.var_150 != null && !this.var_271.contains(this.var_150))
            {
               this.var_271.addChild(this.var_150);
               this.var_110.mask = this.var_150;
            }
         }
         else if(!param1 && this.var_1075)
         {
            this.var_1075 = false;
            if(this.var_150 != null && this.var_271.contains(this.var_150))
            {
               this.var_271.removeChild(this.var_150);
      ...
      public function dispose() : void
      {
         ...
         {
            while(this.var_271.numChildren > 0)
            {
      ...
      public function render(param1:int) : void
      {
         ...
         if(this.var_526 != this.var_2375 || this.var_524 != this.var_2372)
         {
            _loc8_ = true;
         }
         if(this.var_110.x != this.var_631 || this.var_110.y != this.var_633)
         {
            this.var_110.x = this.var_631;
            this.var_110.y = this.var_633;
            _loc8_ = true;
         }
         _loc4_ = 0;
         while(_loc4_ < _loc3_)
         ...
         this.var_2375 = this.var_526;
         this.var_2372 = this.var_524;
      }
      ...
      private function calculateUpdateInterval(param1:int) : void
      {
         ...
         if(this.var_1475 > 0)
         {
            ...
            if(_loc2_ > const_1047 * 3)
            {
               ...
               this.var_2373 = _loc2_;
            }
            if(_loc2_ <= MAXIMUM_VALID_FRAME_UPDATE_INTERVAL)
            {
               ++this.var_780;
               if(this.var_780 == const_385 + 1)
               {
                  this.var_592 = _loc2_;
                  this.var_1779 = this.var_2371;
               }
               else if(this.var_780 > const_385 + 1)
               {
                  _loc3_ = Number(this.var_780 - const_385);
                  this.var_592 = this.var_592 * (_loc3_ - 1) / _loc3_ + Number(_loc2_) / _loc3_;
                  this.var_1779 = this.var_1779 * (_loc3_ - 1) / _loc3_ + Number(this.var_2371) / _loc3_;
                  if(this.var_780 > const_385 + const_1443)
                  {
                     this.var_780 = const_385;
                     if(!this.var_1184 && this.var_592 > const_1047)
                     {
                        this.var_1184 = true;
                        Logger.log("Room canvas updating really slow - now entering frame skipping mode...");
                     }
                     else if(this.var_1184 && this.var_592 < const_1444)
                     {
                        this.var_1184 = false;
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int, param4:Boolean, param5:int) : int
      {
         ...
         _loc6_.update(this._geometry,param3,!_loc9_.isEmpty || param4,this.var_1777 && this.var_1184);
      ...
      {
         if(param1 < this.var_526 && param1 + param3 >= 0 && (param2 < this.var_524 && param2 + param4 >= 0))
         {
            if(!this.var_3066)
            {
               return true;
      ...
      private function rectangleVisibleWithExclusion(param1:int, param2:int, param3:int, param4:int) : Boolean
      {
         ...
         if(param1 + param3 >= this.var_526)
         {
            param3 -= this.var_526 + 1 - (param1 + param3);
         }
         if(param2 + param4 >= this.var_524)
         {
            param4 -= this.var_524 + 1 - (param2 + param4);
         }
         for each(_loc5_ in this.var_2376)
         {
      ...
      {
         if(param1 < 0 || param1 >= this.var_978)
         {
            return null;
         }
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(param2 < 0 || param2 >= this.var_978)
         {
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         var _loc3_:* = null;
         if(param1 < this.var_781 || this.var_781 == 0)
         {
            _loc4_ = this.var_978 - 1;
            while(_loc4_ >= param1)
            {
      ...
      private function getFlippedBitmapData(param1:BitmapData, param2:String, param3:Boolean = false, param4:Boolean = true, param5:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            this.var_628.identity();
            if(flipH)
            {
               this.var_628.scale(-1,1);
               this.var_628.translate(data.width,0);
            }
            if(flipV)
            {
               this.var_628.scale(1,-1);
               this.var_628.translate(0,data.height);
            }
            finalData.draw(data,this.var_628);
            if(name.length > 0)
            {
      ...
      private function getColoredBitmapData(param1:BitmapData, param2:String, param3:int, param4:Boolean = false) : ExtendedBitmapData
      {
         ...
         if(finalData == null)
         {
            ...
            {
               finalData = new ExtendedBitmapData(data.width,data.height,true,16777215);
               finalData.copyPixels(data,data.rect,const_706);
            }
            catch(e:Error)
            {
               finalData = new ExtendedBitmapData(1,1,true,16777215);
            }
            this.var_912.redMultiplier = tR;
            this.var_912.greenMultiplier = tG;
            this.var_912.blueMultiplier = tB;
            finalData.colorTransform(finalData.rect,this.var_912);
            if(name.length > 0)
            {
               this.var_272.addBitmapData(cacheName,finalData);
            }
      ...
      public function handleMouseEvent(param1:int, param2:int, param3:String, param4:Boolean, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         ...
         this.var_1778 = this.checkMouseHits(param1,param2,param3,param4,param5,param6,param7);
         ++this.var_1183;
         return this.var_1778;
      }
      ...
      {
         var _loc11_:Number = param1 - this.var_526 / 2;
         var _loc12_:Number = param2 - this.var_524 / 2;
         var _loc13_:* = null;
         return new RoomSpriteMouseEvent(param5,this._id + "_" + this.var_1776,this._id,param6,_loc11_,_loc12_,param3,param4,param8,param7,param9,param10);
      }
            ...
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(!_loc10_.clickHandling || param3 != MouseEvent.CLICK && param3 != MouseEvent.DOUBLE_CLICK)
               {
                  ...
                  if(_loc12_.indexOf(_loc9_) < 0)
                  {
                     ...
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != this.var_2370 || param2 != this.var_2374)
                     {
                        this.bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
      ...
      {
         if(this.var_368 != null && param1 != null)
         {
            this.var_368.add(param2,param1);
         }
      }
      ...
      private function processMouseEvents() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this._container == null || this.var_368 == null)
         {
            return;
         }
         var _loc1_:int = 0;
         ...
         {
            _loc2_ = this.var_368.getKey(_loc1_);
            _loc3_ = this.var_368.getWithIndex(_loc1_);
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     this.var_1476.processRoomCanvasMouseEvent(_loc3_,_loc4_,this.geometry);
                  }
                  else
                  {
