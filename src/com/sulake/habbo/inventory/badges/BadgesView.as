package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_685:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_685 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_685.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onInactiveBadgeClick);
         this.var_1056 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1056.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onActiveBadgeClick);
      }
      ...
      private function updateListViews() : void
      {
         ...
         var _loc1_:Number = this.var_685.scrollV;
         this.var_685.removeGridItems();
         this.var_1056.removeGridItems();
         var _loc2_:Array = this.var_78.getBadges(BadgesModel.const_568);
         var _loc4_:int = 0;
         while(_loc4_ < _loc2_.length)
         {
            ...
            if(!_loc3_.isInUse)
            {
               this.var_685.addGridItem(_loc3_.window);
         ...
         while(_loc4_ < _loc5_.length)
         {
            ...
            this.var_1056.addGridItem(_loc3_.window);
      ...
      {
         var _loc2_:int = this.var_685.getGridItemIndex(param1.window);
      ...
      {
         var _loc2_:int = this.var_1056.getGridItemIndex(param1.window);
