package com.sulake.habbo.sound.music
{
   ...
   public class HabboMusicController implements IHabboMusicController, IDisposable
   {
      ...
      private static const const_1430:int = HabboMusicPrioritiesEnum.const_120;
      ...
      private var var_519:IPlayListController = null;
      ...
      public function HabboMusicController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_834.push(new TraxSongInfoMessageEvent(this.onSongInfoMessage));
         this.var_834.push(new UserSongDisksInventoryMessageEvent(this.onSongDiskInventoryMessage));
         for each(_loc5_ in this.var_834)
         {
            this._connection.addMessageEvent(_loc5_);
         }
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_854,this.onJukeboxInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_247,this.onJukeboxDispose);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineInit);
         this.var_95.addEventListener(RoomEngineSoundMachineEvent.const_934,this.onSoundMachineDispose);
         this.var_1175 = new Timer(1000);
         this.var_1175.start();
         this.var_1175.addEventListener(TimerEvent.TIMER,this.sendNextSongRequestMessage);
         this._events.addEventListener(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.onSongFinishedPlayingEvent);
         _loc6_ = 0;
         while(_loc6_ < HabboMusicPrioritiesEnum.const_258)
         {
            this.var_320[_loc6_] = null;
      ...
      protected function onSongFinishedPlayingEvent(param1:SoundCompleteEvent) : void
      {
         ...
         {
            if(this.getTopRequestPriority() == this._priorityPlaying && this.getSongRequestCountAtPriority(this._priorityPlaying) == this.var_1757)
            {
               this.resetSongStartRequest(this._priorityPlaying);
            }
            _loc2_ = this._priorityPlaying;
            this.playSongWithHighestPriority();
            if(_loc2_ >= HabboMusicPrioritiesEnum.const_447)
            {
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_269)
            {
               ...
               {
                  _loc3_ = this.var_269.getWithIndex(_loc2_) as SongDataEntry;
            ...
            if(this.var_95)
            {
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_854,this.onJukeboxInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_247,this.onJukeboxDispose);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_806,this.onSoundMachineInit);
               this.var_95.removeEventListener(RoomEngineSoundMachineEvent.const_934,this.onSoundMachineDispose);
            }
      ...
      private function getSongIdRequestedAtPriority(param1:int) : int
      {
         ...
         var _loc2_:SongStartRequestData = this.var_320[param1];
      ...
      {
         var _loc1_:int = this.var_320.length - 1;
         while(_loc1_ >= 0)
         {
            if(this.var_320[_loc1_] != null)
            {
               return _loc1_;
            }
            _loc1_--;
      ...
      private function getSongDataEntry(param1:int) : SongDataEntry
      {
         ...
         {
            _loc2_ = this.var_269.getValue(param1) as SongDataEntry;
         }
         return _loc2_;
      }
      ...
      public function updateVolume(param1:Number) : void
      {
         ...
         var _loc4_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < HabboMusicPrioritiesEnum.const_258)
         {
      ...
      private function requestSong(param1:int, param2:Boolean) : void
      {
         ...
         {
            this.var_623.add(param1,param2);
      ...
      {
         if(param1 >= 0 && param1 < this.var_365.length)
         {
            return this.var_365.getKey(param1);
         }
         return -1;
      }
      ...
      public function getSongDiskInventorySongId(param1:int) : int
      {
         if(param1 >= 0 && param1 < this.var_365.length)
         {
            return this.var_365.getWithIndex(param1);
         }
         return -1;
      }
      ...
      public function samplesUnloaded(param1:Array) : void
      {
         ...
         while(_loc2_ < this.var_269.length)
         {
            ...
            if(_loc3_.id != this.var_1462 && _loc4_ != null && _loc4_.ready)
            {
      ...
      public function get samplesIdsInUse() : Array
      {
         ...
         {
            if(this.var_320[_loc2_] != null)
            {
               _loc3_ = this.var_320[_loc2_];
               _loc4_ = this.var_269.getValue(_loc3_.songId);
               if(_loc4_ != null)
               {
      ...
      private function sendNextSongRequestMessage(param1:TimerEvent) : void
      {
         ...
         this._connection.send(new GetSongInfoMessageComposer(this.var_769));
         Logger.log("Requested song info\'s : " + this.var_769);
         this.var_769 = new Array();
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc5_ < _loc4_.length)
         {
            ...
            if(_loc7_)
            {
               ...
               this.var_269.add(_loc6_.id,_loc10_);
      ...
      {
         if(param2 == -1 || param1 < 0 || param1 >= HabboMusicPrioritiesEnum.const_258)
         {
            return false;
         }
         ...
         this.var_1757 = this.getSongRequestCountAtPriority(param1);
         this.var_1462 = param2;
         if(this._priorityPlaying <= const_1430)
         {
      ...
      private function notifySongPlaying(param1:SongDataEntry) : void
      {
         ...
         if(param1.length >= 8000 && (this.var_2345 != param1.id || _loc3_ > this.var_2344 + 8000))
         {
            this._soundManager.notifyPlayedSong(param1.name,param1.creator);
            this.var_2345 = param1.id;
      ...
      private function areSamplesRequested(param1:int) : Boolean
      {
         ...
         return this.var_623.getValue(param1);
      }
      ...
      private function onSoundMachineInit(param1:Event) : void
      {
         ...
         this.var_519 = new SoundMachinePlayListController(this._soundManager,this,this._events,this.var_95,this._connection) as IPlayListController;
      }
      ...
      {
         this.disposeRoomPlaylist();
         this.var_519 = new JukeboxPlayListController(this._soundManager,this,this._events,this._connection) as IPlayListController;
