package com.sulake.habbo.ui.widget.effects
{
   ...
   public class EffectsWidget extends RoomWidgetBase
   {
      ...
      private static const const_1453:int = 320;
      
      private static const const_1454:int = 48;
      
      private static const const_1452:int = 2;
      ...
      public function open() : void
      {
         ...
         if(!this._view)
         {
            ...
            this._view.x = _loc2_.right + const_1452;
      ...
      public function update() : void
      {
         ...
         this.var_67.height = Math.max(Math.min(_loc5_,const_1453),const_1454);
      ...
      {
         this.handler.container.catalog.openCatalogPage(CatalogPageName.const_1273,true);
      }
   }
}
