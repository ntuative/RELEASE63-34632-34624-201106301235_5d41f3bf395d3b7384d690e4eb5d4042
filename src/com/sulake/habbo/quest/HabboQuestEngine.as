package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1684:int = 5;
      
      private static const const_1685:int = 800;
      
      private static const const_1686:int = 15;
      
      private static const const_1687:int = 300;
      ...
      private var var_1358:QuestController;
      
      private var var_1109:AchievementController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1358 = new QuestController(this);
         this.var_1109 = new AchievementController(this);
         ...
         registerUpdateReceiver(this,const_1684);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_415.events.removeEventListener(BadgeImageReadyEvent.const_235,this.var_1109.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_415.events.addEventListener(BadgeImageReadyEvent.const_235,this.var_1109.onBadgeImageReady);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_1358.onToolbarClick();
            }
            if(param1.iconId == HabboToolbarIconEnum.ACHIEVEMENTS)
            {
               this.var_1109.onToolbarClick();
            }
         }
      }
      ...
      {
         return this.var_1358.questTracker.isVisible();
      }
      ...
      {
         this.var_1358.update(param1);
         this.var_1109.update(param1);
      }
