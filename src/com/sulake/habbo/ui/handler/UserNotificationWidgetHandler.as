package com.sulake.habbo.ui.handler
{
   ...
   public class UserNotificationWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetUserNotificationMessage.const_1393);
         return _loc1_;
      }
      
      public function getProcessedEvents() : Array
      {
         return [RoomSessionUserNotificationEvent.const_135];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserNotificationEvent.const_135:
               _loc2_ = param1 as RoomSessionUserNotificationEvent;
               _loc3_ = new RoomWidgetUserNotificationEvent(RoomWidgetUserNotificationEvent.const_572);
