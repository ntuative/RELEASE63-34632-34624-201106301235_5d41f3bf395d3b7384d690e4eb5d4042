package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1429:String = "_TITLE";
      
      private static const const_1646:String = "_HEADER";
      
      private static const const_1645:String = "_CONTENT";
      
      private static const const_1644:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1632:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1429) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1632 = findChildByTag(const_1646) as IHeaderWindow;
            if(!this.var_1632)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_200 = findChildByTag(const_1645) as IWindowContainer;
            if(!this.var_200)
            {
      ...
      {
         return findChildByTag(const_1644) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1421,_loc2_,false);
      ...
      {
         return this.content != null && this.var_1140 ? this.content.iterator : new Iterator(this);
      }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_332,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_251,_loc3_.left,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_265,_loc3_.top,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_271,0 - _loc3_.right,PropertyStruct.const_35,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_253,0 - _loc3_.bottom,PropertyStruct.const_35,_loc2_));
         return _loc1_;
      }
