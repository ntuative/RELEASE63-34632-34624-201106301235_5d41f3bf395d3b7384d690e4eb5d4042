package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_644:RoomInfoViewCtrl;
      
      private var var_1195:RoomCreateViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_644 = new RoomInfoViewCtrl(this);
         this.var_1195 = new RoomCreateViewCtrl(this);
         this.var_2440 = new RoomThumbnailRenderer(this);
         this.var_1115 = new GuestRoomPasswordInput(this);
         this.var_331 = new GuestRoomDoorbell(this);
         this.var_488 = new Tabs(this);
         this.var_1194 = new OfficialRoomEntryManager(this);
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_48)
         {
            ...
            {
               this.var_323.onNavigatorToolBarIconClick();
            }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_323.startSearch(Tabs.const_262,Tabs.const_584,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_323.startSearch(Tabs.const_285,Tabs.const_289);
         this.var_488.getTab(Tabs.const_285).tabPageDecorator.tabSelected();
      }
