package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         this.var_2300 = parseInt(_loc2_,16);
         this.var_2298 = parseInt(_loc3_,16);
         ...
         this.var_912 = new ColorTransform(this.var_1796,this.var_1794,this.var_1792,this._alphaMultiplier);
         this.var_1164 = this.generatePaletteMapForGrayscale(this.var_2298,this.var_2300);
      }
      ...
      {
         return this.var_1164.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1164.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1164.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1164.getValue("alphas") as Array;
      }
