package com.sulake.core.runtime
{
   ...
   class Profiler extends Component implements IProfiler
   {
      ...
      {
         this.var_351 = new Dictionary(true);
         super(param1,0,null);
      }
      ...
      {
         return BitmapDataAsset.method_14;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            {
               IDisposable(this.var_351[_loc1_]).dispose();
      ...
      {
         this.var_3092 = getTimer() - this.var_2091;
      ...
      public function getProfilerAgentsInArray() : Array
      {
         ...
         for(_loc3_ in this.var_351)
         {
            _loc2_ = _loc3_ as IUpdateReceiver;
            if(IDisposable(_loc3_).disposed)
            {
               IDisposable(this.var_351[_loc3_]).dispose();
               delete this.var_351[_loc3_];
            }
            else
            {
               _loc1_.push(this.var_351[_loc3_]);
            }
         }
         return _loc1_;
      }
      ...
      {
         var _loc2_:ProfilerAgent = this.var_351[param1];
