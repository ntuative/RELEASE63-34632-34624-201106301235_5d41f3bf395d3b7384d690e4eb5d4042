package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_361 = new Array();
            var_361[0] = MouseCursorType.const_379;
            var_361[1] = MouseCursorType.const_30;
            var_361[2] = MouseCursorType.const_379;
            var_361[3] = MouseCursorType.const_379;
            var_361[4] = MouseCursorType.const_379;
            var_361[5] = MouseCursorType.const_30;
            var_361[6] = MouseCursorType.const_379;
         }
         if(var_316 == null)
         {
            var_316 = new Array();
            var_316[0] = WindowState.const_87;
            var_316[1] = WindowState.const_91;
            var_316[2] = WindowState.const_88;
            var_316[3] = WindowState.const_70;
            var_316[4] = WindowState.const_57;
            var_316[5] = WindowState.const_98;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_244;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_189 = state.var_1405 as WindowController;
         this.var_182 = state.renderer;
         this.var_932 = state.var_1407;
         eventQueue.begin();
         this.var_747.x = -1;
         this.var_747.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_747.x || event.stageY != this.var_747.y)
            {
               ...
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_747,array,WindowParam.const_29);
            }
         ...
         state.var_1405 = this.var_189;
         state.renderer = this.var_182;
         state.var_1407 = this.var_932;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_561))
         {
