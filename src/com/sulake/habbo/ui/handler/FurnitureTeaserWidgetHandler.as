package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_938,RoomWidgetViralFurniMessage.const_827,RoomWidgetViralFurniMessage.const_188];
      }
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_640,RoomSessionViralFurniStatusEvent.const_551];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_640:
