   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_912.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_912.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_912.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_912);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_355 == SkinLayoutEntity.const_345)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_566)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_355 == SkinLayoutEntity.const_373)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_356 == SkinLayoutEntity.const_345)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_566)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_373)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_490)
                  {
                  ...
                  else if(_loc10_.var_356 == SkinLayoutEntity.const_373 || _loc10_.var_355 == SkinLayoutEntity.const_373)
                  {
                  ...
                  {
                     this.var_309.a = REGION.width;
                     this.var_309.d = REGION.height;
                     this.var_309.tx = REGION.x;
                     this.var_309.ty = REGION.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_309,ALPHA);
                  }
                  else
                  {
                     this.var_309.a = 0 / _loc18_.width;
                     this.var_309.d = 0 / _loc18_.height;
                     this.var_309.tx = 0;
                     this.var_309.ty = 0;
                     _loc31_ = new BitmapData(REGION.width,REGION.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_309);
                     _loc32_ = new BitmapData(REGION.width,REGION.height,true,0);
                     _loc32_.draw(_loc19_,this.var_309,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_355 == SkinLayoutEntity.const_345)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_356 == SkinLayoutEntity.const_345)
               {
