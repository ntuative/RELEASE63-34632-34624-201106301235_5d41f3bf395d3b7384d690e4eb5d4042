package com.sulake.core.window.services
{
   ...
   public class WindowMouseOperator implements IDisposable
   {
      ...
      protected var var_751:Point;
      
      protected var var_1537:uint;
      ...
      public function operate(param1:int, param2:int) : void
      {
         ...
         this.getMousePositionRelativeTo(this._window,this._mouse,this.var_751);
         this._window.offset(this.var_751.x - this._offset.x,this.var_751.y - this._offset.y);
      }
