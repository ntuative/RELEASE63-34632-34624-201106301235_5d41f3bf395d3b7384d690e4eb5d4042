package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1635:int = 30000;
      ...
      public function VoteWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1635 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_171.reset();
            this.var_171.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_171 = null;
         }
         this._config = null;
         super.dispose();
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_171 = new Timer(1000);
            this.var_171.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
         this.var_2091 = getTimer();
         this.var_171.reset();
         this.var_171.start();
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1635 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_2091;
         if(_loc2_ > this.var_1635)
         {
            this.vote();
            return;
         }
