package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_820:String = "RCL_LOADER_READY";
      ...
      private static const const_710:String = "wall_place_holder";
      
      private static const const_709:String = "pet_place_holder";
      ...
      private static const const_1130:String = "selection_arrow";
      ...
      private var var_1620:IEventDispatcher = null;
      ...
      public function RoomContentLoader(param1:String)
      {
         ...
         this.var_2797 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2798 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      {
         if(this._state >= const_1072)
         {
            return;
         }
         this.var_1620 = param1;
         this.var_2796 = param2.getKey("flash.dynamic.download.url","furniture/");
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_415.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_572.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_572.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_877.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_490.add(_loc3_,_loc4_);
               if(this.var_407[_loc7_] == null)
               {
                  this.var_407[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_711.add(_loc3_,_loc4_);
      ...
      private function continueInitilization() : void
      {
         if(this.var_2799)
         {
            ...
            {
               this.var_1620.dispatchEvent(new Event(const_820));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(this.var_573 != null)
         {
            this.var_573.remove(param2);
            this.var_573.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_573 != null)
         {
            _loc2_ = this.var_573.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      {
         return [const_477,const_710,const_709,const_708,TILE_CURSOR,const_1130];
      }
      ...
      {
         var _loc3_:String = this.var_711.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_711.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_877.getValue(param1) != null)
         {
            return this.var_877.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_274 || param1 == RoomObjectVisualizationEnum.const_54 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_26:
                     if(this.var_407[_loc4_] == null)
                     {
                        this.var_407[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_25:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_405,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1621.getValue(param1) != null)
         {
            this.var_223 = this.var_1621.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_873,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2797.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1963);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2798.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_583,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1621.add(param1,_loc4_);
         this.var_223 = _loc4_;
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_878.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_878.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_572.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_878.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_572.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_572.add(_loc5_,_loc4_);
      ...
      public function method_6(param1:String) : XML
      {
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_579.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
