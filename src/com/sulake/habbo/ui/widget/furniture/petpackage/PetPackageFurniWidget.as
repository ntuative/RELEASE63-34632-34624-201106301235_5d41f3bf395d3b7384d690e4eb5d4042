package com.sulake.habbo.ui.widget.furniture.petpackage
{
   ...
   public class PetPackageFurniWidget extends RoomWidgetBase
   {
      ...
      {
         var _loc2_:* = null;
         if(this.var_719 == null || this._window == null)
         {
            return;
         }
         ...
         if(_loc1_ != null)
         {
            ...
            _loc2_ = new Point((_loc1_.width - this.var_719.width) / 2,(_loc1_.height - this.var_719.height) / 2);
            _loc1_.bitmap.copyPixels(this.var_719,this.var_719.rect,_loc2_);
         }
      }
      ...
      private function sendOpenPetPackage() : void
      {
         ...
         if(this.var_1343 || this.var_237 == -1)
         {
            return;
         }
         ...
         {
            this.var_1343 = true;
            message = new RoomWidgetOpenPetPackageMessage(RoomWidgetOpenPetPackageMessage.const_993,this.var_237,name);
