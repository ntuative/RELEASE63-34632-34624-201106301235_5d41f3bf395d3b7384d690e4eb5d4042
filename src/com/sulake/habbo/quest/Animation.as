   ...
   public class Animation implements IDisposable
   {
      ...
      private function draw() : void
      {
         ...
         if(this.var_1352)
         {
            ...
            {
               if(!_loc2_.isFinished(this.var_1108))
               {
                  _loc1_ = true;
                  _loc3_ = _loc2_.getBitmap(this.var_1108);
                  if(_loc3_ != null)
                  {
                     this.var_98.bitmap.copyPixels(_loc3_,_loc3_.rect,_loc2_.getPosition(this.var_1108));
                  }
               }
            }
         }
