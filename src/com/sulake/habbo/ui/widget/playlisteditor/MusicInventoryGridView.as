   ...
   public class MusicInventoryGridView
   {
      ...
      public function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            this.var_730.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_116.playButtonState = MusicInventoryGridItem.const_1325;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_116 != null)
         {
            this.var_116.playButtonState = MusicInventoryGridItem.const_493;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_116.playButtonState == MusicInventoryGridItem.const_493)
               {
                  this.var_116.playButtonState = MusicInventoryGridItem.const_1324;
            ...
            {
               _loc4_ = this.var_730.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
