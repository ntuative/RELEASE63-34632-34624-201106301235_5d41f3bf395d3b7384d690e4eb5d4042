package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_2933:String = null;
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_304.length == 1 && this.var_103 == this.var_1807)
         {
            return this.var_103 + this.var_588 + this.var_726 % 4;
         }
         if(this.var_304.length == 2)
         {
            for each(_loc1_ in this.var_304)
            {
               ...
               {
                  return this.var_103 + this.var_588 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_726 % 11;
                  return this.var_103 + "_" + this.var_1807 + this.var_588 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2932 || param2 != this.var_2931 || param1 != this.var_2933)
         {
            this.var_2932 = param3;
            this.var_2931 = param2;
            this.var_2933 = param1;
            this.var_2129 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1426 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1426)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_726);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_726);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         switch(param1)
         {
            ...
            case AvatarAction.const_987:
               ...
               if(_loc4_ != null)
               {
                  this.method_12("appendAction:" + [_loc3_,"->",_loc4_.getParameterValue(_loc3_)]);
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_360.push(new ActiveActionData(param1,param2,this.var_726));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.resetBodyPartCache(this.var_1103);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_588 = "";
         this.var_304 = this._structure.sortActions(this.var_360);
         if(this.var_304 == null)
         {
         ...
         {
            this.var_801 = this._structure.getCanvasOffsets(this.var_304,this._scale,this.var_103);
            for each(_loc4_ in this.var_304)
            {
               this.var_588 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_323)
               {
                  _loc5_ = parseInt(_loc4_.actionParameter);
                  if(this.var_1657 != _loc5_)
                  {
                     _loc2_ = true;
                  }
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_304)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_1081 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
               ...
               if(_loc1_.actionType == AvatarAction.const_333 || _loc1_.actionType == AvatarAction.const_301 || _loc1_.actionType == AvatarAction.const_396)
               {
                  this.var_1081 = true;
               }
            }
