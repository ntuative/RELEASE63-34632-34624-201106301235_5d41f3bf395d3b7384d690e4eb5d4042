   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this.var_243.events.addEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_193,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_235,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_193,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_235,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this.var_243.events.removeEventListener(SongInfoReceivedEvent.const_97,this.onSongInfoReceivedEvent);
            this.var_243 = null;
         }
         this.var_1152 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_498);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_788);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_851);
         _loc1_.push(RoomWidgetFurniActionMessage.const_946);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1186);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_895);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_981);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_881);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1848);
         _loc1_.push(RoomWidgetPetCommandMessage.const_525);
         _loc1_.push(RoomWidgetPetCommandMessage.const_874);
         _loc1_.push(RoomWidgetUserActionMessage.const_674);
         _loc1_.push(RoomWidgetUserActionMessage.const_248);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_922);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_547)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_248 || param1.type == RoomWidgetUserActionMessage.const_674 || param1.type == RoomWidgetUserActionMessage.const_659)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_498:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_788:
            ...
            case RoomWidgetUserActionMessage.const_658:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1396,_loc3_.name);
            ...
            case RoomWidgetFurniActionMessage.const_312:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_851:
            ...
            case RoomWidgetFurniActionMessage.const_946:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_1186:
            ...
            case RoomWidgetUserActionMessage.const_248:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_895:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_981:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_881:
            ...
            case RoomWidgetUserActionMessage.const_553:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_874:
            ...
            case RoomWidgetPetCommandMessage.const_525:
               ...
               break;
            case RoomWidgetChangeMottoMessage.const_922:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_304);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_422) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_422);
               }
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_734) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1360;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_304);
                  if(param1.category == RoomObjectCategoryEnum.const_26)
                  {
               ...
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1191);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_524)
                  {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_443) == 0)
                  {
                     _loc31_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_443.length);
            ...
            case RoomObjectCategoryEnum.const_28:
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_518)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_162)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_1028);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_784;
                  }
                  if(!_loc35_)
                  {
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc15_.push(RoomWidgetUserInfoUpdateEvent.const_1868);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_144];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_144:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_1028);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_243 != null)
         {
            ...
            this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_409,_loc2_,_loc3_,_loc4_));
         }
      }
