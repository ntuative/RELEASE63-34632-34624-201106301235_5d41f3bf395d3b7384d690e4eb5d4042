package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1666:int = 60;
      
      private static const const_1664:int = 25165823;
      
      private static const const_1665:int = 16777215;
      ...
      private var var_1105:IHabboNotifications;
      ...
      private var var_1654:ByteArray;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_956,this.onTraxLoadComplete);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_1105)
         {
            this.var_1105.release(new IIDHabboNotifications());
            this.var_1105 = null;
         }
         super.dispose();
      }
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1106.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1347:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1730:
               ...
               case HabboSoundTypesEnum.const_1301:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1408:
                  _loc3_ = "sound_catalogue_cash";
                  break;
               case HabboSoundTypesEnum.const_1801:
            ...
            this.var_1106.add(param1,_loc2_);
         }
         _loc2_.volume = this.var_1030;
         _loc2_.play();
      }
      ...
      private function loadSample(param1:int) : void
      {
         ...
         _loc4_.load(_loc3_);
         this.var_723.add(_loc4_,param1);
      }
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1349.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      private function createTraxInstance(param1:int, param2:String, param3:Boolean = true) : TraxSequencer
      {
         ...
         var _loc5_:TraxSequencer = new TraxSequencer(param1,_loc4_,this.var_302,events);
         _loc5_.volume = this.var_1030;
      ...
      private function validateSampleAvailability(param1:TraxSequencer, param2:Boolean) : void
      {
         ...
         {
            if(this.var_302.getValue(int(_loc4_[_loc6_])) == null)
            {
               if(param2)
               {
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1105.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1105 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_161 == null || this._connection == null || this._roomEngine == null || this.var_243 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1839,this.var_895));
         this.var_895 = -1;
         this.var_894 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1030 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_243.updateVolume(this.var_1030);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         {
            _loc2_ = this.var_723.remove(param1);
            if(this.var_302.getValue(_loc2_) == null)
            {
               this.var_1654.clear();
               _loc3_ = param1.length;
               param1.extract(this.var_1654,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1654,_loc2_,TraxSample.const_1766,TraxSample.const_1751);
               this.var_302.add(_loc2_,_loc4_);
            }
         }
      }
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1350.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1666 && this.var_1350.length > 0)
            {
               _loc3_ = this.var_1350.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_723.length == 0 && this.var_895 != -1)
            {
               this.var_894.ready = true;
               _loc4_ = this.var_895;
               this.var_895 = -1;
               this.var_894 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_956,_loc4_));
               if(this.var_2904)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_894 == null && this.var_1349.length > 0)
         {
            _loc1_ = this.var_1349.getKey(0);
            _loc2_ = this.var_1349.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_956,_loc1_));
               }
               else
               {
                  this.var_894 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         {
            _loc5_ = this.var_302.getKey(_loc4_);
            _loc6_ = this.var_302.getWithIndex(_loc4_);
         ...
         if(_loc1_ > const_1664)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1665 && _loc9_ < _loc2_.length)
            {
            ...
            if(_loc7_.length > 0)
            {
               for each(_loc11_ in _loc7_)
               {
                  ...
                  _loc12_ = this.var_302.getValue(_loc11_) as TraxSample;
                  _loc12_.dispose();
                  this.var_302.remove(_loc11_);
               }
