package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1719:String = "extra_tools";
      ...
      private var var_740:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1400:PurseExtension;
      
      private var var_1683:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_741:ExtensionView;
      ...
      private function onCommunicationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this._connection = this.var_285.getHabboMainConnection(null);
         this.tryInitialize();
      }
      ...
      {
         if(this.var_285 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","HabboFriendBarCom_im_notification_icon_png") == "true")
         {
            this.var_741 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_741)
            {
               this.var_1400 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_740 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1683 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_741.attachExtension(const_1718,this.var_1400.window,ExtensionFixedSlotsEnum.const_1909);
               this.var_741.attachExtension(const_1719,this.var_740.window,ExtensionFixedSlotsEnum.const_1974);
            }
         }
         if(this._view == null)
         {
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_740.showRoomInfo();
         }
         else
         {
            this.var_740.hideRoomInfo();
         }
      }
