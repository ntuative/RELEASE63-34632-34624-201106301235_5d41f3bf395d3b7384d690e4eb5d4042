package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_274.getWithIndex(this.var_328);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_802);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_274.getWithIndex(this.var_328);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_802);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_328;
         if(this.var_328 >= this.var_274.length)
         {
            this.var_328 = 0;
         }
         var _loc2_:Map = this.var_274.getWithIndex(this.var_328);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_328 < 0)
         {
            this.var_328 = this.var_274.length - 1;
         }
         var _loc2_:Map = this.var_274.getWithIndex(this.var_328);
         if(_loc2_ != null)
         {
