package com.sulake.habbo.navigator
{
   ...
   public class TextSearchInputs
   {
      ...
      public function TextSearchInputs(param1:HabboNavigator, param2:IWindowContainer)
      {
         ...
         this.var_788 = new TextFieldManager(this._navigator,_loc3_,25,this.searchRooms,this._navigator.getText("navigator.search.info"));
      ...
      {
         var _loc1_:String = this.var_788.getText();
         if(_loc1_ == "")
         {
            return;
         }
         this._navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_400,_loc1_);
