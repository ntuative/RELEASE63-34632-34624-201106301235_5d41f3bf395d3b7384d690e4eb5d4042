package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1096:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1542:String = "sendAccessTokenToServer";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1542,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1543,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1096);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1096);
         }
      }
