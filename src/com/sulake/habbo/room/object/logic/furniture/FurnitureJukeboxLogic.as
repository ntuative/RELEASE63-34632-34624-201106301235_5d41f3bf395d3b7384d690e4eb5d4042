package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureJukeboxLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_620,RoomObjectFurnitureActionEvent.const_513,RoomObjectFurnitureActionEvent.const_492,RoomObjectFurnitureActionEvent.const_494,RoomObjectWidgetRequestEvent.const_172];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         {
            object.getModelController().setString(RoomWidgetInfostandExtraParamEnum.const_422,RoomWidgetInfostandExtraParamEnum.const_524);
