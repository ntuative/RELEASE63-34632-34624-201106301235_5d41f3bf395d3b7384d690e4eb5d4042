package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class TagListRenderer
   {
      ...
      private var var_1346:Rectangle = null;
      
      private var var_3089:int = 0;
      ...
      public function renderTags(param1:Array, param2:IWindowContainer, param3:Array) : int
      {
         ...
         this._offsetX = 0;
         this.var_1347 = 0;
         this.var_1346 = param2.rectangle.clone();
         this.var_1346.height = 150;
         var _loc5_:int = 0;
      ...
      {
         if(param1.width > this.var_1346.width)
         {
            return false;
         }
         if(this.var_1347 + param1.height > this.var_1346.height)
         {
            return false;
         }
         if(this._offsetX + param1.width > this.var_1346.width)
         {
            this._offsetX = 0;
            this.var_1347 += param1.height + this.const_2366;
            return this.fit(param1);
         }
         param1.offset(this._offsetX,this.var_1347);
         this._offsetX += param1.width + this.const_2367;
         return true;
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1649 != null && this.var_1649.indexOf(param1) != -1)
         {
