package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1477:int = 267;
      
      private static const const_1476:int = 65;
      
      private static const const_1478:int = -70;
      ...
      private var var_1202:UserCountRenderer;
      
      private var var_2450:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2450 = new PublicRoomThumbs();
         super();
         this._navigator = param1;
         this.var_1202 = new UserCountRenderer(this._navigator);
      }
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1796)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_794 || param2.type == OfficialRoomEntryData.const_982))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            this.var_1202.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1476) : int(const_1477);
      ...
      {
         var _loc4_:String = this.var_2450.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1478) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_584,_loc2_.tag);
         }
