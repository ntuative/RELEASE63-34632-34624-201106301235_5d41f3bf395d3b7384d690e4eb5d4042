package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      protected static const const_1055:String = "btn_message";
      ...
      protected static const const_572:String = "notification";
      
      private static const const_75:uint = 10338138;
      
      private static const const_1095:uint = 13891476;
      
      private static const const_1094:String = null;
      
      private static const const_698:String = "icon_tag_notify";
      ...
      private static const const_470:Vector.<IWindowContainer> = new Vector.<IWindowContainer>();
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1034));
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_572,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1034));
            _loc5_ = false;
            ...
            if(this.friend.online)
            {
               ...
               _loc8_ = _loc3_.getChildByName(const_1055);
               if(_loc8_)
               {
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1034)).getListItemByName(const_462) as IWindowContainer;
            _loc1_.findChildByName(const_679).caption = this.var_168.name;
            var_2222.crop(_loc1_.getChildByName(const_679) as ITextWindow);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_470.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1538).content as XML) as IWindowContainer;
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1094;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1314:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2204);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_698;
               break;
            case FriendNotification.const_1236:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2204);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_698;
               break;
