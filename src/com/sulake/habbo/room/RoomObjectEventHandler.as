package com.sulake.habbo.room
{
   ...
   public class RoomObjectEventHandler implements IRoomRenderingCanvasMouseListener
   {
      ...
      public function setSelectedObject(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         switch(param4)
         {
            ...
            case RoomObjectCategoryEnum.const_25:
               ...
               _loc5_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_944,param1,param2,param3,param4));
         }
      }
      ...
      public function handleRoomObjectEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectStateChangeEvent.const_67:
               ...
               break;
            case RoomObjectStateChangeEvent.const_750:
            ...
            case RoomObjectFurnitureActionEvent.const_492:
               ...
               break;
            case RoomObjectFloorHoleEvent.const_163:
            case RoomObjectFloorHoleEvent.const_169:
               this.handleObjectFloorHoleEvent(param1,param2,param3);
               break;
            case RoomObjectRoomAdEvent.const_207:
            case RoomObjectRoomAdEvent.const_629:
            ...
            case RoomObjectRoomActionEvent.const_1765:
            case RoomObjectRoomActionEvent.const_567:
      ...
      private function handleRoomObjectMouseEvent(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectMouseEvent.const_500:
               ...
               break;
            case RoomObjectMouseEvent.const_596:
      ...
      private function handleRoomObjectMouseClick(param1:RoomObjectMouseEvent, param2:int, param3:int) : void
      {
         ...
         if(_loc8_ == RoomObjectCategoryEnum.const_84)
         {
            ...
            if(_loc15_ != _loc10_ && _loc16_ != _loc10_)
            {
               ...
               if(_loc17_ != null)
               {
                  _loc17_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_569,param2,param3,-1,RoomObjectCategoryEnum.const_140));
               }
         ...
         if(this._roomEngine != null)
         {
            ...
            if(_loc8_ != null && _loc8_.getEventHandler() != null)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_657);
               }
               else
               {
                  _loc10_ = new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_639);
               }
               _loc8_.getEventHandler().processUpdateMessage(_loc10_);
            }
         }
            ...
            case RoomObjectOperationEnum.OBJECT_UNDEFINED:
               if(_loc8_ == RoomObjectCategoryEnum.const_26 || _loc8_ == RoomObjectCategoryEnum.const_25)
               {
                  if(param1.altKey)
                  {
                     ...
                     if(_loc10_ != null)
                     {
                        _loc10_.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_733,param2,param3,_loc6_,_loc8_));
                     }
                  }
               }
         }
         ...
         if(_loc6_ == null)
         {
            ...
            if(_loc6_ != null)
            {
               if(_loc5_.category == RoomObjectCategoryEnum.const_26)
               {
                  ...
                  {
                     _loc9_ = _loc6_.getModel().getNumberArray(RoomObjectVariableEnum.const_906);
      ...
      private function handleObjectSoundMachineEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectFurnitureActionEvent.const_557:
               ...
               break;
            case RoomObjectFurnitureActionEvent.const_636:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1014,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_570:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1023,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_595:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_934,param2,param3,param1.objectId,_loc4_));
         }
      }
      ...
      private function handleObjectJukeboxEvent(param1:RoomObjectEvent, param2:int, param3:int) : void
      {
         ...
         {
            case RoomObjectFurnitureActionEvent.const_494:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_854,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_620:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1916,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_513:
               this._roomEngine.events.dispatchEvent(new RoomEngineSoundMachineEvent(RoomEngineSoundMachineEvent.const_1951,param2,param3,param1.objectId,_loc4_));
               break;
            case RoomObjectFurnitureActionEvent.const_492:
      ...
      private function validateWallItemLocation(param1:IRoomObject, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:Number, param6:Number, param7:SelectedRoomObjectData) : Vector3d
      {
         ...
         var _loc9_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_550);
         var _loc10_:Number = param1.getModel().getNumber(RoomObjectVariableEnum.const_999);
      ...
      private function setObjectAlphaMultiplier(param1:IRoomObjectController, param2:Number) : void
      {
         ...
         {
            param1.getModelController().setNumber(RoomObjectVariableEnum.const_374,param2);
         }
      }
      ...
      public function setSelectedAvatar(param1:int, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         if(selectionArrow != null && selectionArrow.getEventHandler() != null)
         {
            ...
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_657));
            }
            else
            {
               selectionArrow.getEventHandler().processUpdateMessage(new RoomObjectVisibilityUpdateMessage(RoomObjectVisibilityUpdateMessage.const_639));
            }
         }
      }
      ...
      private function getValidFurnitureDirection(param1:IRoomObjectController, param2:Boolean) : int
      {
         ...
         {
            _loc3_ = param1.getModel().getNumberArray(RoomObjectVariableEnum.const_906);
         }
      ...
      private function placeObject(param1:int, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(this._roomEngine != null && this._roomEngine.connection != null)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc7_ == RoomObjectCategoryEnum.const_28 && _loc5_.typeId == RoomObjectTypeEnum.const_206)
               {
