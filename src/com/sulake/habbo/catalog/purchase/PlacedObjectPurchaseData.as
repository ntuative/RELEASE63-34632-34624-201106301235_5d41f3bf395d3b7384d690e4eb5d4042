package com.sulake.habbo.catalog.purchase
{
   ...
   public class PlacedObjectPurchaseData implements IDisposable
   {
      ...
      private var var_1817:IProductData;
      
      private var var_687:IFurnitureData;
      ...
      {
         this.var_1294 = param1.offerId;
         this.var_1816 = param1.productContainer.firstProduct.productClassId;
         this.var_1817 = param1.productContainer.firstProduct.productData;
         this.var_687 = param1.productContainer.firstProduct.furnitureData;
         this.var_1582 = param1.productContainer.firstProduct.extraParam;
      }
      
      public function toString() : String
      {
         return [this._roomCategory,this._roomId,this.var_237,this._category,this.var_2082,this._x,this.var_186,this._direction,this.var_1294,this.var_1816].toString();
      }
