package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1142:uint = 4284532064;
      
      private static const const_1141:uint = 2577770;
      ...
      private var var_718:ItemPopupCtrl;
      ...
      private var var_1100:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_718 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_81)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.ownUserAccepts ? uint(const_1142) : uint(const_1141);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_19.otherUserAccepts ? uint(const_1142) : uint(const_1141);
            }
      ...
      public function removeSelection() : void
      {
         if(this.var_1100)
         {
            this.var_1100.isSelected = false;
            this.var_1100 = null;
         }
      }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_718.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_666);
            this.var_718.show();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            this.var_718.hideDelayed();
         }
      }
      ...
      private function getTraxSongFurniName(param1:GroupItem, param2:String, param3:Boolean, param4:uint = 1.0, param5:Boolean = false) : String
      {
         ...
         else if(param3)
         {
            ...
            this.var_207.push(param4);
            this.var_207.push(param1);
            this.var_207.push(param5);
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_207.length > 0)
         {
            _loc2_ = this.var_207.pop();
            _loc3_ = this.var_207.pop();
            _loc4_ = uint(this.var_207.pop());
            _loc5_ = _loc3_.peek();
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_19.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_19.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_718.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_666);
               }
            }
            else
            {
               this.var_207.push(_loc4_);
               this.var_207.push(_loc3_);
