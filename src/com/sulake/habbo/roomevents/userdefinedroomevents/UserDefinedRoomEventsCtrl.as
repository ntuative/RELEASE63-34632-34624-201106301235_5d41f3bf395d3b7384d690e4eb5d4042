package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1656:int = 2;
      ...
      private var var_2128:TriggerConfs;
      
      private var var_2126:ActionTypes;
      
      private var var_2127:ConditionTypes;
      
      private var var_303:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_896:RoomObjectHightLighter;
      
      private var var_198:UserDefinedRoomEventsHelp;
      
      private var var_1351:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_2128 = new TriggerConfs();
         this.var_2126 = new ActionTypes();
         this.var_2127 = new ConditionTypes();
         this.var_303 = new Dictionary();
         super();
         this.var_95 = param1;
         this.var_896 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_303[param1])
         {
            ...
            this.var_896.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_303[param1] = param2;
            this.var_896.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1351 = new SliderWindowController(this.var_95,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_95.assets,0,20,1);
         this.var_1351.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1351.setValue(0);
         this.method_3("configure_container","icon_trigger","trigger_icon_bitmap");
         this.method_3("configure_container","icon_action","action_icon_bitmap");
         this.method_3("configure_container","icon_condition","condition_icon_bitmap");
      ...
      private function method_3(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_896.hideAll(this.var_303);
         }
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1351.getValue()) : 0;
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1656) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1656 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2128);
         this.refreshConfigureElement(this.var_2126);
         this.refreshConfigureElement(this.var_2127);
