package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1282:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,104,"a"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,94,"b"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,36,"c"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,84,"d"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"e"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,80,"f"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,416,"i"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,320,"j"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,448,"k"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,352,"l"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,384,"m"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_50,372,"n"));
         ...
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,540,"t"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,512,"w"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,396,"x"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,440,"y"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,456,"z"));
         this.var_45.push(new RoomLayout(HabboClubLevelEnum.const_40,208,"0"));
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1282.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1981 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1981 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_67 = IItemListWindow(this.var_200.findChildByName("item_list"));
         ...
         this.var_1283 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_200.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1283.goBackToInitialState();
         this.var_1283.input.textBackgroundColor = 4294967295;
         this.var_1282 = this.var_45[0];
         this.refreshRoomThumbnails();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         {
            if(this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_40))
            {
               _loc5_ = null;
            }
            else
      ...
      private function isAllowed(param1:RoomLayout) : Boolean
      {
         switch(param1.requiredClubLevel)
         {
            ...
            case HabboClubLevelEnum.const_40:
               return this._navigator.sessionData.hasUserRight("fuse_use_vip_room_layouts",HabboClubLevelEnum.const_40);
            default:
               return false;
         }
      }
      ...
      {
         return Boolean(this.var_1283.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1283.getText();
         var _loc3_:String = "model_" + this.var_1282.name;
