package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1585:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_2006 = new Point();
         this.var_1585 = new Rectangle();
         this.var_339 = new Rectangle();
         this.var_396 = new Dictionary(true);
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_853 = null;
            for(_loc1_ in this.var_396)
            {
               delete this.var_396[_loc1_];
            }
            this.var_396 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_339.x = param2.x - param1.x;
            this.var_339.y = param2.y - param1.y;
            this.var_339.width = param2.width;
            this.var_339.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_32))
            {
               while(param1.testParamFlag(WindowParam.const_32))
               {
                  ...
                  this.var_339.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_339,WindowRedrawFlag.const_1310);
      ...
      {
         var _loc2_:WindowRendererItem = this.var_396[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_396[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            ...
            this.var_396[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_845,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_845,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_396[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_396[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            if(!_loc1_.disposed)
            {
               ...
               this.var_339.x = _loc3_.dirty.x;
               this.var_339.y = _loc3_.dirty.y;
               this.var_339.width = _loc3_.dirty.width;
               this.var_339.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_339,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_2006,this.var_1585))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_2006,this.var_1585))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_32))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1585);
