package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_692:DimmerViewColorGrid;
      
      private var var_479:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_77,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1463,const_1462,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_692 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         _loc1_ = this._window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            this.var_479 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,this._widget.assets);
         }
         this.var_293 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.selectTab(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_293.numTabItems)
         {
            _loc6_ = this.var_293.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         if(this.var_479 != null)
         {
            this.var_479.setValue(this.var_1590);
         }
         this.var_578 = this.colors.indexOf(_loc2_.color);
         if(this.var_692 != null)
         {
            this.var_692.setSelectedColorIndex(this.var_578);
         }
      ...
      private function selectTab(param1:int) : void
      {
         ...
         var _loc2_:IWindow = this.var_293.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_293.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_293.selector.getSelected();
         return this.var_293.selector.getSelectableIndex(_loc1_);
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(this.var_479 != null)
         {
            this.var_479.min = this._widget.minLights[param1 - 1];
         }
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_692 != null)
         {
            this.var_692.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
