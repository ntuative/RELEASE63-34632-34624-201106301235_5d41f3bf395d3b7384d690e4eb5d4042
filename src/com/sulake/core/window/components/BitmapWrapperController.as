package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_602 != PropertyDefaults.const_1342)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_815,this.var_602,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_2002);
         }
         if(this.var_931 != PropertyDefaults.const_1203)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_951,this.var_931,PropertyStruct.const_51,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_815:
                  ...
                  break;
               case PropertyDefaults.const_951:
