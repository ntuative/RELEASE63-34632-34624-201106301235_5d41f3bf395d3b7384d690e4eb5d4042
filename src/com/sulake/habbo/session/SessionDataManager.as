package com.sulake.habbo.session
{
   ...
   public class SessionDataManager extends Component implements ISessionDataManager
   {
      ...
      private var var_1870:GroupDetailsView;
      ...
      private var var_330:FurnitureDataParser;
      
      private var var_1868:UserTagManager;
      
      private var var_1223:BadgeImageManager;
      
      private var var_1221:HabboGroupInfoManager;
      
      private var var_1009:IgnoredUsersManager;
      ...
      public function SessionDataManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1221 = new HabboGroupInfoManager(this,events);
         this.var_1009 = new IgnoredUsersManager(this);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_330)
         {
            this.var_330.removeEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
            this.var_330.dispose();
            this.var_330 = null;
         }
         if(this.var_653)
         {
            this.var_653.removeEventListener(ProductDataParser.const_122,this.onProductsReady);
      ...
      private function initBadgeImageManager() : void
      {
         ...
         this.var_1223 = new BadgeImageManager(context.root.assets,events,this.var_161,this._localization);
      }
      ...
      private function onHabboCommunicationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_1221.communication = this._communication;
         this.var_1224.communication = this._communication;
         this.var_1009.registerMessageEvents();
      }
      ...
      private function onConfigurationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(!this.var_330)
         {
            ...
            this.var_330 = new FurnitureDataParser(this.var_544,this._wallItems,this.var_543,this._localization);
            this.var_330.addEventListener(FurnitureDataParser.const_122,this.onFurnitureReady);
            if(this.var_161.keyExists("furnidata.load.url"))
            {
               _loc3_ = this.var_161.getKey("furnidata.load.url");
               this.var_330.loadData(_loc3_);
            }
         }
      }
      ...
      private function onLocalizationReady(param1:IID, param2:IUnknown) : void
      {
         ...
         if(this.var_330)
         {
            this.var_330.localization = this._localization;
            this.var_330.registerFurnitureLocalizations();
         }
      }
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         this.var_1867 = _loc2_.clubLevel;
         this.var_1869 = _loc2_.securityLevel;
      }
      ...
      private function onUserObject(param1:IMessageEvent) : void
      {
         ...
         this.var_2468 = _loc3_.respectTotal;
         this.var_1222 = _loc3_.respectLeft;
         this.var_806 = _loc3_.petRespectLeft;
         this._figure = _loc3_.figure;
         this.var_1085 = _loc3_.sex;
         this.var_1724 = _loc3_.realName;
         this.var_2533 = _loc3_.identityId;
         this.var_1009.initIgnoreList();
      }
      ...
      private function onUserChange(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.id == -1)
         {
            ...
            this.var_1085 = _loc2_.sex;
            events.dispatchEvent(new HabboSessionFigureUpdatedEvent(this._id,this._figure,this.var_1085));
         }
      }
      ...
      private function onAvailabilityStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_2532 = _loc2_.isOpen;
         this.var_2531 = _loc2_.onShutDown;
      }
      ...
      {
         return this.var_1869 >= SecurityLevelEnum.const_1262;
      }
      ...
      {
         return this.var_1223.getBadgeImage(param1);
      }
      
      public function getBadgeImageWithInfo(param1:String) : BadgeInfo
      {
         return this.var_1223.getBadgeImageWithInfo(param1);
      }
      ...
      public function showGroupBadgeInfo(param1:int) : void
      {
         ...
         {
            this.var_1870 = new GroupDetailsView(this);
         }
         var _loc2_:HabboGroupDetails = this.var_1221.getGroupDetails(param1);
         if(_loc2_ != null)
         {
            this.var_1870.showGroupDetails(param1);
         }
      }
      
      public function getGroupDetails(param1:int) : HabboGroupDetails
      {
         return this.var_1221.getGroupDetails(param1);
      }
      
      public function getGroupBadgeId(param1:int) : String
      {
         return this.var_1221.getBadgeId(param1);
      }
      
      public function getGroupBadgeImage(param1:String) : BitmapData
      {
         return this.var_1223.getBadgeImage(param1,BadgeImageManager.const_1296);
      }
      ...
      {
         return this.var_1009.isIgnored(param1);
      }
      
      public function ignoreUser(param1:String) : void
      {
         this.var_1009.ignoreUser(param1);
      }
      
      public function unignoreUser(param1:String) : void
      {
         this.var_1009.unignoreUser(param1);
      }
      ...
      {
         var _loc2_:IConnection = this._communication.getHabboMainConnection(null);
         if(param1 < 0 || this.var_806 < 1 || _loc2_ == null)
         {
            throw new Error("Failed to give respect to pet: " + param1);
         }
         _loc2_.send(new RespectPetMessageComposer(param1));
         this.var_806 = this.var_806 - 1;
      }
      ...
      public function getFloorItemData(param1:int) : IFurnitureData
      {
         ...
         return this.var_544.getValue(param1.toString());
      }
      ...
      public function getFloorItemDataByName(param1:String, param2:int = 0) : IFurnitureData
      {
         ...
         var _loc3_:Array = this.var_543.getValue(param1);
      ...
      public function loadProductData(param1:IProductDataListener = null) : Boolean
      {
         ...
         if(param1 && this.var_1220.indexOf(param1) == -1)
         {
         ...
         if(this.var_653 == null)
         {
            ...
            this.var_653 = new ProductDataParser(_loc2_,this.var_1319);
            this.var_653.addEventListener(ProductDataParser.const_122,this.onProductsReady);
         }
         return false;
      }
      ...
      public function getFurniData(param1:IFurniDataListener) : Array
      {
         ...
         var _loc2_:Array = this.var_544.getValues();
