package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1717:int = 250;
      
      private static const const_1715:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1716:String = "${widgets.chatinput.say}";
      ...
      private var var_2182:IWindow;
      
      private var _button:IWindow;
      
      private var var_2181:IWindow;
      
      private var var_1681:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         ...
         this.var_3017 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_3016 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
         this.var_422 = new Timer(1000,1);
         this.var_422.addEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
         this.var_499 = new Timer(10000,1);
         this.var_499.addEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
         this.createWindow();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_422.reset();
            this.var_422.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onTypingTimerComplete);
            this.var_422 = null;
         }
         if(this.var_499 != null)
         {
            this.var_499.reset();
            this.var_499.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onIdleTimerComplete);
            this.var_499 = null;
         }
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2182 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2181 = this._window.findChildByName("send_button_text");
         this.var_1681 = this._window.findChildByName("block_text");
         this.var_2181.caption = const_1716;
         ...
         this.var_27.addEventListener(WindowKeyboardEvent.const_360,this.keyUpHandler);
         this.var_27.addEventListener(WindowEvent.const_117,this.onInputChanged);
         this._window.findChildByName("send_button").addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSend);
         this.var_1679 = true;
         this.var_739 = "";
         this._window.addEventListener(WindowEvent.const_575,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_667,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2182.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1717 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1715);
      }
      ...
      private function onInputChanged(param1:WindowEvent) : void
      {
         ...
         {
            if(_loc2_.text.length > this.var_739.length + 1)
            {
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_738);
