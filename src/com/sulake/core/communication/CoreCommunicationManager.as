package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_1731:IConnectionStateListener;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1257:
               _loc3_ = new SocketConnection(param1,this,this.var_1731);
               break;
            default:
      ...
      {
         var _loc3_:Array = this.var_763[param1];
         if(_loc3_ == null)
         {
            _loc3_ = new Array();
            this.var_763[param1] = _loc3_;
         }
         _loc3_.push(param2);
      }
      ...
      public function getMessageEvents(param1:IConnection, param2:Class) : Array
      {
         ...
         var _loc5_:Array = this.var_763[_loc3_];
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1445)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
