package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1498:Point = new Point(3,3);
      
      private static const const_1724:uint = 7433577;
      
      private static const const_1722:uint = 5723213;
      
      private static const const_487:String = "_hover";
      
      private static const const_486:String = "_normal";
      
      private static const const_485:int = 5;
      
      private static const const_1726:int = 600;
      
      private static const const_1723:int = 80;
      
      private static const const_1728:int = 74;
      
      private static const ICON_SPACING_NORMAL:int = 10;
      
      private static const const_1729:int = -2;
      
      private static const const_1725:int = 5;
      ...
      private var var_1694:BitmapData;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1498;
         this._window.addEventListener(WindowEvent.const_575,this.onParentResized);
         ...
         {
            this.setIconHoverState(_loc11_,const_486);
         }
         ...
         this.var_236.x = _loc13_.width - this.var_236.width - const_485;
         this.var_236.y = const_485;
         this.var_3031 = this.isNewItemsNotificationEnabled();
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         var _loc2_:* = this._windowManager.getDesktop(2).height < const_1726;
         if(!param1 && _loc2_ == this.var_1692)
         {
            return;
         }
         this.var_1692 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1728) : int(const_1723);
         var _loc4_:int = !!_loc2_ ? int(const_1729) : int(ICON_SPACING_NORMAL);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1725 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
         this._window.height = _loc6_.rectangle.bottom + const_1727;
      }
      ...
      private function onCatalogEvent(param1:CatalogEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case CatalogEvent.CATALOG_NEW_ITEMS_SHOW:
               if(this.var_236 != null && this.var_3031)
               {
      ...
      public function setToolbarState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case HabboToolbarEnum.const_781:
               _loc3_ = false;
               break;
            case HabboToolbarEnum.const_825:
               _loc3_ = true;
         }
      ...
      private function onIconHoverMouseEvent(param1:WindowMouseEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT:
               this.setIconHoverState(_loc4_,const_486);
               this.setIconBgHoverState(_loc3_,const_486);
         }
      }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_487 ? this.var_1693 : this.var_1694;
         }
         else
         {
      ...
      private function setIconBgHoverState(param1:IWindowContainer, param2:String) : void
      {
         ...
         if(param2 == const_487)
         {
            param1.color = const_1724;
         }
         else
         {
            param1.color = const_1722;
         }
      }
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1692 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1692 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      private function setMeMenuIconBitmaps(param1:BitmapData) : void
      {
         ...
         this.var_1694 = this.addShadow(param1,new Point(2,3),4280426782);
         if(this.var_1693)
         {
            this.var_1693.dispose();
         }
         this.var_1693 = this.addShadow(param1,new Point(4,5),4281150249);
         param1.dispose();
      }
      ...
      public function getUnseenItemCounter(param1:String) : IWindowContainer
      {
         ...
         var _loc2_:IWindowContainer = this.var_1137.getValue(param1) as IWindowContainer;
         if(!_loc2_)
         {
            ...
            _loc2_.x = _loc4_.width - _loc2_.width - const_485;
            _loc2_.y = const_485;
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","HabboFriendBarCom_im_notification_icon_png") == "true";
      }
   }
}
