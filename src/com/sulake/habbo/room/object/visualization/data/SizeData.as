package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      private var var_1293:DirectionData = null;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1355);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1392);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1581 / 2) % 360 / this.var_1581;
         ...
         {
            _loc6_ = int(this.var_290.getKey(_loc5_)) * this.var_1581;
