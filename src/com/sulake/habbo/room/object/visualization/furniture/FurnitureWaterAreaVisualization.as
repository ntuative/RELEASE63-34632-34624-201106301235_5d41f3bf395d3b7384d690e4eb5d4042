package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      {
         if(this.var_2420 == param1 && this.var_2419 == direction)
         {
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_638[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_638[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_532 == 0 || this.var_639 == 0)
         {
            ...
            this.var_532 = _loc2_.getNumber(RoomObjectVariableEnum.const_275);
            this.var_639 = _loc2_.getNumber(RoomObjectVariableEnum.const_352);
         }
         this.var_451 = [];
         this.var_638 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_532 * 2 + this.var_639 * 2)
         {
            this.var_451.push(false);
            this.var_638.push(ShoreMaskCreatorUtility.const_85);
            _loc1_++;
         }
      }
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_79,getSize(param3),this.var_451,this.var_638,assetCollection);
      }
