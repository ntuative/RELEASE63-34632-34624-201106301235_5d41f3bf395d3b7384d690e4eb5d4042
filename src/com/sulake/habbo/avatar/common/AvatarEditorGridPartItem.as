package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_789:IFigurePartSet;
      ...
      private const const_2347:int = 13421772;
      
      private const const_2346:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_746 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_746 != null && !this.var_1805)
            {
               _loc3_ = this.var_746;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1483.color = this.const_2347;
         }
         else
         {
            this.var_1483.color = this.const_2346;
         }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         if(this.var_635 == null)
         {
            if(!this.analyzePartLayers())
            {
               if(!this.var_1804)
               {
                  ...
                  this.var_1804 = _loc9_.content as BitmapData;
               }
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1805 && _loc2_.colorLayerIndex > 0)
               {
