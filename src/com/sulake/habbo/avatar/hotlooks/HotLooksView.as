package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      public function init() : void
      {
         ...
         this.var_678 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_678.numGridItems > 0)
         {
            this.var_678.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_78 = null;
      ...
      public function update() : void
      {
         ...
         for each(_loc2_ in this.var_78.hotLooks)
         {
            ...
            this.var_678.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_678.getGridItemIndex(param2.parent);
