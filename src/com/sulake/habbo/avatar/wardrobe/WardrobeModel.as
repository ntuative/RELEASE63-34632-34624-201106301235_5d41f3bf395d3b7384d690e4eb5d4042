package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeModel implements ISideContentModel
   {
      ...
      private function init() : void
      {
         ...
         while(_loc1_ <= 10)
         {
            this.var_569.add(_loc1_,new WardrobeSlot(this.var_26,_loc1_,this.isSlotEnabled(_loc1_)));
            _loc1_++;
         }
         if(this._view)
         {
      ...
      public function updateSlots(param1:int, param2:Array) : void
      {
         ...
         {
            _loc3_ = this.var_569.getValue(_loc4_.slotId) as WardrobeSlot;
            if(_loc3_)
            {
      ...
      private function isSlotEnabled(param1:int) : Boolean
      {
         if(param1 <= 5)
         {
            return this.var_26.manager.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_34);
         }
         return this.var_26.manager.sessionData.hasUserRight("fuse_larger_wardrobe",HabboClubLevelEnum.const_40);
      }
      
      public function get slots() : Array
      {
         return this.var_569.getValues();
      }
   }
}
