package com.sulake.habbo.friendlist
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_622[this.var_1142]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var_622[this.var_1142] = this._alert;
      }
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(this._friendList.getXmlWindow(this.var_1142));
