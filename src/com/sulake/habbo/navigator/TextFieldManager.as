package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_70.addEventListener(WindowEvent.const_117,this.checkMaxLen);
         this._orgTextBackground = this.var_70.textBackground;
         this.var_3009 = this.var_70.textBackgroundColor;
      ...
      public function restoreBackground() : void
      {
         ...
         this.var_70.textBackgroundColor = this.var_3009;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_70.text = this.var_1519;
            this.var_737 = true;
         }
         else
         {
      ...
      {
         return !this.var_737 && Util.trim(this.getText()).length > 2;
      }
      ...
      private function onInputClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_70.text = this.var_3010;
         this.var_737 = false;
         this.restoreBackground();
      }
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_2177)
         {
            this.var_70.text = _loc2_.substring(0,this.var_2177);
         }
      }
   }
}
