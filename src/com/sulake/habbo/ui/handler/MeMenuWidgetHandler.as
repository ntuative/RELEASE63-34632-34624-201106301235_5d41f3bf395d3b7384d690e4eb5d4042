package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_220);
         }
         this.var_1152 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_290,this.onAvatarEffectsChanged);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_914,this.onHelpTutorialEvent);
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_124,this.onCreditBalance);
            }
         }
         ...
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_290,this.onAvatarEffectsChanged);
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_914,this.onHelpTutorialEvent);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_124,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._container.avatarRenderManager != null)
         {
            ...
            if(_loc3_ != this.var_1532)
            {
               ...
               this.var_1900 = _loc1_;
               this.var_1899 = _loc2_;
            }
            else
            {
               _loc1_ = this.var_1900;
               _loc2_ = this.var_1899;
            }
         }
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_471)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_471,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_471 - const_1097)
                  {
                     _loc8_.offset(0,_loc2_.height - const_471 + const_1097);
                  }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetDanceMessage.const_1008);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_923);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1344);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1171);
         _loc1_.push(RoomWidgetSelectEffectMessage.const_1162);
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_799);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_775);
         _loc1_.push(RoomWidgetStopEffectMessage.const_975);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1911);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1272);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_539);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1959);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1238);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_908);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_932);
         _loc1_.push(RoomWidgetMeMenuMessage.const_778);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_998);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1925);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_743);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_980);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1232);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_445);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_932:
            ...
            case RoomWidgetWaveMessage.const_850:
               ...
               break;
            case RoomWidgetDanceMessage.const_1008:
               if(this._container != null && this._container.roomSession != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1344:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1171:
               if(this.var_12 != null)
               {
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_775:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1254)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_128,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_799:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1771:
                        this._catalog.openCatalogPage(CatalogPageName.const_1273,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1321:
               ...
               break;
            case RoomWidgetSelectEffectMessage.const_1162:
            case RoomWidgetStopEffectMessage.const_975:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1272:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_908:
               if(this._container != null)
               {
            ...
            case RoomWidgetMeMenuMessage.const_778:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_124,this._catalog.getPurse().credits));
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_539:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_220,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_220);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_644));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_998:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_394,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_743:
               ...
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_394,this._container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_980:
               this._container.soundManager.previewVolume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_394,this._container.soundManager.volume));
               break;
            case RoomWidgetAvatarEditorMessage.const_1232:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_662));
               }
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_124,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_129:
               ...
               break;
            case HabboHelpTutorialEvent.const_914:
               this._container.events.dispatchEvent(new RoomWidgetTutorialEvent(RoomWidgetTutorialEvent.const_656));
         }
      }
