package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_408.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_408)
         {
            this.var_408.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_408.reset();
            this.var_408 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_59 == null)
         {
            this.var_59 = IWindowContainer(this._navigator.getXmlWindow(this.var_1142));
            this.var_59.visible = false;
            this.var_59.setParamFlag(HabboWindowParam.const_43,true);
         ...
         this.var_59.x = _loc2_.x + this.var_2350 + param1.width;
