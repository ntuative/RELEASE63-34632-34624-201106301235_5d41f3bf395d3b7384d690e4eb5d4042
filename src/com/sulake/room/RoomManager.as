package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      public static const const_894:int = 3;
      ...
      private var var_716:IRoomObjectFactory = null;
      
      private var var_579:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1338:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_717 = [];
         this.var_714 = [];
         events.addEventListener(RoomContentLoadedEvent.const_405,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_583,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_953,this.onContentLoaded);
      }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_716 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_716 == null || this.var_579 == null)
         {
            return;
         }
         this._state = const_1945;
         if(this.var_1338 != null)
         {
            _loc1_ = this.var_1338;
            this.var_1338 = null;
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         var _loc4_:int = this.var_714.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_714[_loc4_];
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(!this.var_60.hasInternalContent(param3))
         {
            ...
            _loc9_ = this.var_60.method_6(_loc12_);
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_579.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_579.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_716.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_716 != null)
         {
            return this.var_716.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this._state == const_767)
         {
            return;
         }
         if(this.var_60 == null)
         {
            this._state = const_767;
            return;
         }
         if(this.var_60.getGraphicAssetCollection(param1) != null)
         {
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_60 == null || this.var_579 == null)
         {
            return;
         }
         var _loc2_:XML = this.var_60.getVisualizationXML(param1);
         var _loc3_:XML = this.var_60.method_6(param1);
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_579.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
            ...
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_579.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_716.createRoomObjectLogic(_loc6_);
