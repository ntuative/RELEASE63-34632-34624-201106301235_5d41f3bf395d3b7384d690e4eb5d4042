package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2060:String = "friend_requests_tab_xml";
      ...
      protected static const const_2057:String = "badge_counter";
      
      protected static const const_2056:String = "button_accept_all";
      
      protected static const const_2058:String = "click_area_discard_all";
      
      protected static const const_1413:String = "button_close";
      
      protected static const const_2059:String = "button_accept";
      
      protected static const const_1036:String = "click_area_discard";
      
      protected static const const_1417:String = "text_discard";
      
      private static var var_1565:FriendRequestsTab;
      
      private static const const_75:uint = 4294625561;
      
      private static const const_1095:uint = 4294957414;
      
      private static const const_1586:uint = 4289431312;
      
      private static const const_1585:uint = 4290616362;
      
      private static const REGION_REJECT_COLOR_EXPOSED:uint = 16770666;
      
      private static const const_1587:uint = 16777215;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1565 ? var_1565 : new FriendRequestsTab();
         _loc2_.var_165 = false;
         _loc2_._requests = param1;
         _loc2_._window.findChildByName(const_2057).caption = String(param1.length);
         return _loc2_;
      }
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1963)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1273.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1586) : uint(const_1585);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_679).caption = _loc5_.name;
      ...
      {
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_2060).content as XML) as IWindowContainer;
         ...
         this.var_1273 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1417)).textColor = REGION_REJECT_COLOR_EXPOSED;
            }
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OUT)
         {
            if(param2.name == const_1036)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1417)).textColor = const_1587;
            }
         }
      }
