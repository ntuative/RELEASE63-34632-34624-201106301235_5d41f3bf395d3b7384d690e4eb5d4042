package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1446:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1447:Class = ProfilerOutput_profiler_task_xml;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_3064 = new Array();
         this.var_170 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1446() as ByteArray;
      ...
      {
         var _loc2_:ByteArray = new var_1447() as ByteArray;
