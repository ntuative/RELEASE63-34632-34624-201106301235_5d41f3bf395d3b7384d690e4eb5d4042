package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_415 = param5;
         this.var_415.events.addEventListener(BadgeImageReadyEvent.const_235,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_415.events.removeEventListener(BadgeImageReadyEvent.const_235,this.onBadgeImageReady);
            this.var_415 = null;
         }
      }
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1245.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_668.indexOf(param3) != -1;
            _loc11_ = new Badge(param1,_loc7_,_loc10_);
            _loc11_.iconImage = this.var_415.getBadgeImage(param1);
            if(_loc10_)
            {
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_568);
      ...
      {
         return this.getItemInIndex(param1,const_568);
      }
      ...
      {
         if(param1 == InventoryCategory.const_219 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_668.indexOf(_loc2_) == -1)
            {
               this.var_668.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_668 && this.var_668.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1197));
            this.var_668 = [];
