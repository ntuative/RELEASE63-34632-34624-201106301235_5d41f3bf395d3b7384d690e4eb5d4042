package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneRasterizer implements IPlaneRasterizer
   {
      ...
      private var var_887:IGraphicAssetCollection = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_713 != null)
         {
            ...
            {
               _loc3_ = this.var_713.getWithIndex(_loc1_);
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      public function clearCache() : void
      {
         ...
         {
            _loc3_ = this.var_409.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc3_ != null)
            {
               _loc3_.clearCache();
            }
      ...
      private function resetMaterials() : void
      {
         ...
         while(_loc1_ < this.var_409.length)
         {
            _loc2_ = this.var_409.getWithIndex(_loc1_) as PlaneMaterial;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
      ...
      {
         return this.var_409.getValue(param1) as PlaneMaterial;
      }
         ...
         while(_loc3_ < _loc2_.length())
         {
            ...
            if(XMLValidator.checkRequiredAttributes(_loc4_,["id"]))
            {
               ...
               while(_loc8_ < _loc7_.length())
               {
                  ...
                  this.var_409.add(_loc5_,_loc6_);
                  _loc8_++;
               }
            }
            _loc3_++;
         ...
         while(_loc4_ < _loc3_.length())
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc19_ < _loc7_.length)
               {
                  ...
                  _loc21_ = this.var_887.getAsset(_loc20_);
                  if(_loc21_ != null)
                  {
                     _loc8_.push(_loc21_);
                  }
      ...
      protected function getGeometry(param1:int, param2:Number, param3:Number) : IRoomGeometry
      {
         ...
         var _loc5_:IRoomGeometry = this.var_713.getValue(_loc4_);
         if(_loc5_ == null)
         {
            _loc5_ = new RoomGeometry(param1,new Vector3d(param2,param3),new Vector3d(-10,0,0));
            this.var_713.add(_loc4_,_loc5_);
         }
         return _loc5_;
      }
