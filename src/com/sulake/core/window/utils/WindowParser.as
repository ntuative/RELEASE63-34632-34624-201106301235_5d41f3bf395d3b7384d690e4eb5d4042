package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1329:String = "_EXCLUDE";
      
      public static const const_2188:String = "_INCLUDE";
      
      public static const const_2203:String = "_TEMP";
      
      private static const const_1697:String = "layout";
      
      private static const const_1153:String = "window";
      
      private static const const_1151:String = "variables";
      
      private static const const_1152:String = "filters";
      
      private static const const_679:String = "name";
      
      private static const const_1695:String = "style";
      
      private static const const_722:String = "params";
      
      private static const const_1692:String = "tags";
      ...
      private static const const_1702:String = "visible";
      
      private static const const_1704:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_4:String = "background";
      
      private static const const_1248:String = "blend";
      
      private static const const_1694:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1693:String = "treshold";
      
      private static const const_1701:String = "children";
      
      private static const const_1703:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1700:String = "height_min";
      
      private static const const_1691:String = "height_max";
      ...
      private static const const_1705:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1698:RegExp = /(\s|\n|\r|\t|\v)*$/;
      ...
      protected var var_1153:Dictionary;
      
      protected var var_1711:Dictionary;
      
      protected var var_2266:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1428,this.var_1427);
         this.var_1153 = new Dictionary();
         this.var_1711 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1153,this.var_1711);
         this.var_2266 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1698,const_49);
         return param1.replace(const_1705,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1153)
            {
               delete this.var_1153[_loc1_];
            }
            for(_loc1_ in this.var_1711)
            {
               delete this.var_1711[_loc1_];
            }
            this.var_2266.dispose();
            this.var_2266 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1697)
         {
            _loc8_ = param1.child(const_1151);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1428[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_679,variables,"")));
         style = uint(this.parseAttribute(xml,const_1695,variables,style));
         params = uint(this.parseAttribute(xml,const_722,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1692,variables,tag)));
         rect = new Rectangle();
         ...
         visible = this.parseAttribute(xml,const_1702,variables,visible.toString()) == const_723;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_722).length() > 0)
         {
            list = xml.child(const_722).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               ...
               if(this.var_1153[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_679)) + "\"!");
               }
               params |= this.var_1153[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1704,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1696);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1151)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1703,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1700,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1691,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_4,variables,window.background.toString()) == const_723;
         blend = Number(this.parseAttribute(xml,const_1248,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1694,variables,window.clipping.toString()) == const_723;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1693,variables,window.mouseThreshold.toString()));
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_233)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1427[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1329) == -1)
                  {
