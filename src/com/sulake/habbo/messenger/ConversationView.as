package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1119:int = 100;
      
      private static const const_1611:int = 20;
       
      
      private var var_159:HabboMessenger;
      
      private var var_2715:IScrollbarWindow;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_159 = param1;
         this.var_2010 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_67 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2715 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1119 + const_1611)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1610;
         param1.invalidate();
      }
      ...
      public function refreshHeader() : void
      {
         ...
         {
            this.var_2010.enable();
         }
         else
         {
            this.var_2010.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_67.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_566.messages.length - const_1119);
         _loc1_ = 0;
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_978 || param3.type == Message.const_866 ? param3.time + ": " : "";
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_159.send(new FollowFriendMessageComposer(this.var_566.id));
