package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_563:IDisplayObjectWrapper;
      
      private var var_1980:Point;
      
      private var var_562:IItemGridWindow;
      
      private var var_1573:IScrollbarWindow;
      
      protected var var_1902:XML;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_199.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
            this.var_199 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_199 = _window.findChildByName("room_canvas_container") as IWindowContainer;
         if(this.var_199 != null)
         {
            this.var_199.visible = false;
            this.var_563 = this.var_199.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_563 != null && _loc3_ != null)
            {
               this.var_199.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_563.width,this.var_563.height);
               if(_loc4_ != null)
               {
                  this.var_563.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1980 = new Point(this.var_99.x,this.var_99.y);
         this.var_562 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1573 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(this.var_562 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         this.var_1902 = _loc1_.content as XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1281.y = this.var_1054.y + this.var_1054.height;
         ...
         else
         {
            ...
            {
               case Offer.const_652:
                  _loc6_ = this._bundlePreview.clone();
                  if(this.var_562 != null)
                  {
                     this.var_562.visible = true;
                     _loc11_ = _loc2_.productContainer as BundleProductContainer;
                     _loc11_.populateItemGrid(this.var_562,this.var_1573,this.var_1902);
                     this.var_562.scrollV = 0;
                  }
                  if(this.var_199 != null)
                  {
                     this.var_199.visible = false;
               ...
               case Offer.const_406:
                  ...
                  if(this.var_199 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_73 || _loc9_.productType == ProductTypeEnum.const_62 || _loc9_.productType == ProductTypeEnum.const_181)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_73:
                        if(_loc8_ != null && this.var_563 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_321,AvatarAction.const_642);
                                 _loc18_.appendAction(AvatarAction.const_323,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2679)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2679 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_99 != null && true)
         {
            ...
            this.var_99.x = this.var_1980.x;
            this.var_99.y = this.var_1980.y;
            if(param3 != null)
            {
