package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_500,RoomObjectMouseEvent.const_167];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_952,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_948,16777215);
         ...
         if(this.var_1553)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_952,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1216,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1261)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1954;
            if(_loc2_ - this.var_1261 >= this.var_1953)
            {
               _loc3_ = this.var_1260;
               _loc4_ = this.var_1955;
               this.var_1261 = 0;
            }
            else
            {
               ...
               _loc10_ = this.var_1260 >> 16 & 255;
               _loc11_ = this.var_1260 >> 8 & 255;
               _loc12_ = this.var_1260 & 255;
               _loc13_ = (_loc2_ - this.var_1261) / this.var_1953;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1956 + (this.var_1955 - this.var_1956) * _loc13_;
               this._color = _loc3_;
               this.var_1954 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_948,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_886:
               ...
               break;
            case RoomObjectRoomUpdateMessage.const_1019:
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_577:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_298)
               {
                  _loc5_ = "null";
               }
               ...
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_991:
         ...
         if(_loc4_)
         {
            ...
            param2.setString(RoomObjectVariableEnum.const_1260,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1381:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_690:
               ...
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1204:
               param2.setNumber(RoomObjectVariableEnum.const_1227,param1.value);
         }
      }
      ...
      private function updateFloorHoles(param1:RoomObjectRoomFloorHoleUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomFloorHoleUpdateMessage.const_163:
               this._planeParser.addFloorHole(param1.id,param1.x,param1.y,param1.width,param1.height);
               this.var_1553 = true;
               break;
            case RoomObjectRoomFloorHoleUpdateMessage.const_169:
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1252,int(param1.bgOnly));
         this.var_1554 = this._color;
         this.var_1956 = this.var_1954;
         this.var_1260 = _loc3_;
         this.var_1955 = _loc4_;
         this.var_1261 = getTimer();
         this.var_1953 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_578,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1875,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1897,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1876,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_578,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_256 || _loc12_ == RoomPlaneData.const_412)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
