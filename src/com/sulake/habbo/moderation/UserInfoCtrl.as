package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1109:int = 3600;
      
      private static const const_1108:int = 86400;
      
      private static const const_1110:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1107)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1109)
         {
            return Math.round(param1 / const_1107) + " mins ago";
         }
         if(param1 < 2 * const_1108)
         {
            return Math.round(param1 / const_1109) + " hours ago";
         }
         if(param1 < 2 * const_1110)
         {
            return Math.round(param1 / const_1108) + " days ago";
         }
         return Math.round(param1 / const_1110) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1263.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_35.getXmlWindow("user_info"));
            this.var_1263.addChild(_loc1_);
         ...
         _loc1_.findChildByName("message_but").procedure = this.method_10;
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_35,WindowTracker.const_1199,this._data.userId),this._callerFrame,this.var_1262,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new RoomVisitsCtrl(this.var_35,this._data.userId),this._callerFrame,this.var_1262,false,true);
      }
      ...
      private function method_10(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new SendMsgsCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1641),this._callerFrame,this.var_1262,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.windowTracker.show(new ModActionCtrl(this.var_35,this._data.userId,this._data.userName,this.var_1641),this._callerFrame,this.var_1262,false,true);
      }
