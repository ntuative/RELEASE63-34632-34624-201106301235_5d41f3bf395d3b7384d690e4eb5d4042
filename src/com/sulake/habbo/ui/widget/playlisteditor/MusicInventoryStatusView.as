package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_966:String = "MISV_BUY_MORE";
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_497[param1] as IWindowContainer,0);
         this.var_53 = param1;
      }
      ...
      {
         this.blitBackgroundImage(const_966,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_497.add(const_809,_loc1_);
            this.var_1800 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1799 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_559));
         ...
         if(_loc1_ != null)
         {
            this.var_497.add(const_966,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_673));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_497[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
