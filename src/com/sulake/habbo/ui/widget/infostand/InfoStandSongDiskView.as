package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandSongDiskView extends InfoStandFurniView
   {
      ...
      {
         if(param1.type == RoomWidgetSongUpdateEvent.const_423 && param1.songId == this.var_1877)
         {
      ...
      override protected function createWindow(param1:String) : void
      {
         ...
         var_267 = var_46.findChildByTag("catalog");
         if(var_267 != null)
         {
      ...
      private function getSongIdFromExtraParam(param1:String) : int
      {
         ...
         if(param1 != null)
         {
            _loc2_ = param1.substr(RoomWidgetInfostandExtraParamEnum.const_443.length,param1.length);
