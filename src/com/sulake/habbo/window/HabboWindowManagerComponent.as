package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1582:uint = 1;
      ...
      private var var_1948:ProfilerOutput;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_220 = new Array(const_472);
         ...
         {
            this.var_220[_loc6_] = new WindowContext("layer_" + _loc6_,this._windowRenderer,this,this._localization,context.displayObjectContainer,_loc5_,this);
            _loc6_++;
         }
         this.var_666 = this.var_220[const_1582];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_1948)
            {
               this.var_1948 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_1948.profiler = _loc3_;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_220)
            {
               ...
               {
                  IDisposable(this.var_220.pop()).dispose();
               }
            }
            this.var_220 = null;
            if(this.var_284)
      ...
      {
         return this.var_220[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = this.var_220[param2].getDesktopWindow();
      ...
      {
         return this.var_220[param2].getDesktopWindow().getChildByName(param1);
      }
      
      public function getActiveWindow(param1:uint = 1) : IWindow
      {
         return this.var_220[param1].getDesktopWindow().getChildAt(this.var_666.getDesktopWindow().numChildren - 1);
      }
      ...
      {
         var _loc2_:IWindowContext = this.var_220[param1];
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_426.length > 0)
         {
            ...
            while(_loc2_ >= 0)
            {
               this.var_220[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(this.var_1258)
         ...
         {
            this.var_220[_loc2_].render(param1);
            _loc2_++;
         }
         if(this.var_1258)
         {
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2005,new Date().getTime().toString());
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1760,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2020,param2.name + ": " + param2.toString());
            }
         }
      }
