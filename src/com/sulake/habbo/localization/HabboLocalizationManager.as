package com.sulake.habbo.localization
{
   ...
   public class HabboLocalizationManager extends CoreLocalizationManager implements IHabboLocalizationManager
   {
      ...
      public function HabboLocalizationManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_2775 = ["I","II","III","IV","V","VI","VII","VIII","IX","X","XI","XII","XIII","XIV","XV","XVI","XVII","XVIII","XIX","XX"];
         super(param1,param2,param3);
         this.var_2063 = (param2 & 0) > 0;
         if(!this.var_2063)
         {
            lock();
         }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(!this.var_2063)
            {
               if("HabboFriendBarCom_im_notification_icon_png" == this.var_161.getKey("use.default.localizations","HabboFriendBarCom_im_notification_icon_png"))
               {
                  _loc5_ = this.var_161.getKey("external.texts.txt","external_texts.txt");
                  events.addEventListener(LocalizationEvent.const_194,this.onLocalizationLoaded);
      ...
      {
         var _loc2_:* = null;
         events.removeEventListener(LocalizationEvent.const_194,this.onLocalizationLoaded);
         if(this.var_161.keyExists("external.override.texts.txt"))
         {
            _loc2_ = this.var_161.getKey("external.override.texts.txt");
            events.addEventListener(LocalizationEvent.const_194,this.onLocalizationOverrideLoaded);
      ...
      {
         events.removeEventListener(LocalizationEvent.const_194,this.onLocalizationOverrideLoaded);
         unlock();
      }
      ...
      {
         this.var_2064[param1] = param2;
      }
      
      private function getBadgePointLimit(param1:String) : int
      {
         return this.var_2064[param1];
      }
      ...
      {
         return this.var_2775[Math.max(0,param1 - 1)];
      }
