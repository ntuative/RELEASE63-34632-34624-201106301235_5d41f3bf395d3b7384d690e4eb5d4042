package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1106:String = "use_minimized_own_avatar_menu";
      ...
      private var var_253:AvatarInfoData;
      ...
      private var var_832:OwnAvatarMenuView;
      
      private var var_833:AvatarMenuView;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_161 = param4;
         this.var_253 = new AvatarInfoData();
         this.var_2621 = Boolean(this.var_161.getBoolean("menu.avatar.enabled",false));
         this.var_1945 = this.var_161.getBoolean("menu.own_avatar.enabled",false);
         ...
         this.handler.container.inventory.events.addEventListener(HabboInventoryEffectsEvent.const_290,this.onEffectsChanged);
      ...
      {
         messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_983,0,0));
      }
      ...
      override public function dispose() : void
      {
         ...
         this.handler.container.inventory.events.removeEventListener(HabboInventoryEffectsEvent.const_290,this.onEffectsChanged);
         this._view = null;
         this.var_161 = null;
         super.dispose();
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_371,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_196,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_459,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_543,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_749,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_371,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_196,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_99,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_459,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_543,this.updateEventHandler);
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_123:
               ...
               if(this.var_1945 && _loc2_.allowNameChange)
               {
               ...
               break;
            case RoomWidgetRoomObjectNameEvent.const_543:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_371:
               this.var_1947 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_361:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_749:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_1946 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_788,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_420:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_1946)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_162:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_137,false,!!_loc3_.isSpectatorMode ? null : this.var_253);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_518,false,null);
               break;
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_99:
               this.var_1935 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_459:
               this.var_1935 = true;
         }
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_322,_loc2_.id,RoomObjectCategoryEnum.const_28);
      ...
      {
         this.var_253.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_253.amIController = param1.amIController;
         this.var_253.amIOwner = param1.amIOwner;
         this.var_253.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_253.canBeKicked = param1.canBeKicked;
         this.var_253.canTrade = param1.canTrade;
         this.var_253.canTradeReason = param1.canTradeReason;
         this.var_253.hasFlatControl = param1.hasFlatControl;
         this.var_253.isIgnored = param1.isIgnored;
         this.var_253.respectLeft = param1.respectLeft;
         this.var_253.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_114;
         this.var_253.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_1945) : Boolean(this.var_2621);
         }
            ...
            if(!this.var_1935)
            {
               if(_loc7_)
               {
                  if(param6.isOwnUser)
                  {
                     if(!this.var_832)
                     {
                        this.var_832 = new OwnAvatarMenuView(this);
                     }
                  ...
                  else
                  {
                     if(!this.var_833)
                     {
                        this.var_833 = new AvatarMenuView(this);
                     }
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_220,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_220);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1106,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1106,!!param1 ? "1" : "0");
      }
   }
}
