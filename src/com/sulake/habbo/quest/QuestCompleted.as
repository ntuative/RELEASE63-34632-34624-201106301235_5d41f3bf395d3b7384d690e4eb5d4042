package com.sulake.habbo.quest
{
   ...
   public class QuestCompleted implements IDisposable
   {
      ...
      private static const const_1557:int = 31;
      ...
      public function prepare(param1:QuestMessageData) : void
      {
         ...
         this._window.findChildByName("catalog_link_txt").caption = this.var_48.localization.getKey("quests.completed.cataloglink." + this.var_133.activityPointType);
         var _loc2_:String = "quests.completed.reward." + this.var_133.activityPointType;
         this.var_48.localization.registerParameter(_loc2_,"amount",this.var_133.rewardCurrencyAmount.toString());
         this._window.findChildByName("reward_txt").caption = this.var_48.localization.getKey(_loc2_,_loc2_);
         this._window.visible = false;
         this._window.findChildByName("congrats_txt").caption = this.var_48.localization.getKey(!!this.var_133.lastQuestInCampaign ? "quests.completed.campaign.caption" : "quests.completed.quest.caption");
         ...
         this.var_48.setupCampaignImage(this._window,param1,this.var_133.lastQuestInCampaign);
         ...
         _loc3_.height = Math.max(const_1557,_loc3_.textHeight + const_1438);
      ...
      {
         this.var_48.localization.registerParameter(param1,"category",this.var_48.getCampaignName(this.var_133));
