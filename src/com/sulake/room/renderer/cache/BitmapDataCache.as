package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_998 = param1 * 1024 * 1024;
         this.var_1831 = param2 * 1024 * 1024;
         this.var_1506 = param3 * 1024 * 1024;
         if(this.var_1506 < 0)
         {
            this.var_1506 = 0;
         }
      ...
      {
         this.var_998 += this.var_1506;
         if(this.var_998 > this.var_1831)
         {
            this.var_998 = this.var_1831;
         }
      }
      ...
      public function addBitmapData(param1:String, param2:ExtendedBitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               this.var_799 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         this.var_799 += param2.width * param2.height * 4;
      }
   }
}
