package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1549:String = "pixelbalance";
      
      private static const const_1544:String = "badges";
      
      private static const const_1545:String = "selectbadge";
      
      private static const const_1551:String = "inventory";
      
      private static const const_1548:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1546:String = "friendlist";
      
      private static const const_1547:String = "pet_inventory";
      
      private static const const_1550:String = "go_to_room";
      ...
      private var var_1896:IHabboToolbar;
      ...
      private var var_550:HabboNotificationViewManager;
      
      private var var_250:HabboAlertDialogManager;
      
      private var var_820:ParkBusDialogManager;
      
      private var var_2563:Boolean;
      
      private var var_1025:ClubGiftNotification;
      
      private var var_1022:ClubEndingNotification;
      
      private var var_1023:ClubPromoNotification;
      
      private var var_3074:Dictionary;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         this.var_1237.push(_loc8_);
         return this.var_1237.length;
      }
      
      private function getNextItemFromQueue() : HabboNotificationItem
      {
         var _loc1_:Array = this.var_1237.splice(0,1);
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_250 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_1896 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_550 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1896,this.var_1024["styles"],this.var_1024["view"]);
         ...
         this._communication.addHabboConnectionMessageEvent(new UserBannedMessageEvent(this.method_9));
         ...
         registerUpdateReceiver(this.var_550,1);
         registerUpdateReceiver(this,2);
         this.var_415.events.addEventListener(BadgeImageReadyEvent.const_235,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_415.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1163,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1163,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1859,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_1003,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               {
                  _loc7_ = this.var_415.getFloorItemData(_loc6_.furniClassId);
               }
               else if(_loc6_.productType == CatalogPageMessageProductData.const_62)
               {
                  _loc7_ = this.var_415.getWallItemData(_loc6_.furniClassId);
               }
               ...
               {
                  _loc9_ = this.var_415.getProductData(_loc4_.localizationId);
                  if(_loc9_)
                  {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1750,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1363)
         {
            return;
         }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1022 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_550.isSpaceAvailable() && this.var_1237.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_550.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      {
         if(param1 != null && this.var_550 != null)
         {
            this.var_550.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_250 == null)
         {
            return;
         }
         this.var_250.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function method_9(param1:IMessageEvent) : void
      {
         ...
         this.var_250.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_250.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_250.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_250.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1398,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1398,_loc5_);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2563)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_1003,null);
            this.var_2563 = true;
      ...
      {
         if(param2.type == WindowEvent.const_151 || param2.type == WindowEvent.const_534)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1025 && this.var_1025.visible)
         {
            return;
         }
         this.var_1025 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1896);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_1003,_loc6_);
      }
   }
}
