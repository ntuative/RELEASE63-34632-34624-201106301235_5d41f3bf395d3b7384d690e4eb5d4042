package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_803)
         {
            this.var_803 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_803)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_804)
         {
            this.var_804 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_804)
            {
               return;
            }
