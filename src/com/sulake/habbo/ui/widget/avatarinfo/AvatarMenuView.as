package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_1031:uint = 1;
      
      protected static const const_1030:uint = 2;
      
      protected static var var_1429:uint = const_1031;
      
      private static const const_1422:uint = 16744755;
      
      private static const const_1423:uint = 16756591;
      ...
      protected var var_652:uint = 1;
      
      protected var var_1697:Boolean;
      ...
      protected function updateButtons() : void
      {
         ...
         if(!this.var_1697)
         {
            ...
            {
               this.var_652 = const_1030;
            }
            else
            {
               this.var_652 = var_1429;
            }
         }
         if(this.var_652 == const_1031)
         {
      ...
      private function showButton(param1:String, param2:Boolean = true) : void
      {
         ...
         if(_loc6_)
         {
            ...
            {
               _loc6_.x = _loc5_.x + (_loc5_.width - _loc5_.textWidth) / 2 - _loc6_.width - const_1040;
            }
            if(_loc6_.tags.indexOf("arrow_right") != -1)
            {
               _loc6_.x = _loc5_.x + (_loc5_.width + _loc5_.textWidth) / 2 + const_1040;
            }
         }
      }
      ...
      private function buttonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(param2.name == "button")
            {
               param2.color = param2.tags.indexOf("moderate") > -1 ? uint(const_2047) : uint(const_1032);
            }
            else if(param2.tags.indexOf("link") > -1)
            {
               ...
               {
                  ITextWindow(IWindowContainer(param2).getChildAt(0)).textColor = const_1423;
               }
            }
         }
