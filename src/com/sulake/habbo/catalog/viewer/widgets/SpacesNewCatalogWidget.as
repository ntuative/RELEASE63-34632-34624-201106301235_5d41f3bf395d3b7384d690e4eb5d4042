package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_118[this.var_549]);
      ...
      {
         var _loc2_:int = this.var_724[this.var_549];
         var _loc3_:Offer = this.var_215[this.var_549][_loc2_];
      ...
      public function selectIndex(param1:int) : void
      {
         ...
         {
            _loc2_ = this.var_215[this.var_549][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_724[this.var_549] = (this.var_215[this.var_549] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_724[0];
         var _loc2_:int = this.var_724[1];
         var _loc3_:int = this.var_724[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         for each(_loc1_ in page.offers)
         {
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_62 || _loc2_.productType == ProductTypeEnum.const_73))
            {
               continue;
            }
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            page.replaceOffers(this.var_215[this.var_549],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_724[this.var_549];
