package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1136:AvatarActionManager;
      
      private var var_425:FigureData;
      
      private var var_501:PartSetsData;
      
      private var _animationData:AnimationData;
      
      private var var_919:AnimationManager;
      
      private var var_1103:ActionDefinition;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:String, param3:PartOffsetData)
      {
         super();
         this.var_450 = param1;
         this.var_425 = new FigureData();
         this.var_501 = new PartSetsData();
         this._animationData = new AnimationData();
         this.var_919 = new AnimationManager();
         this.var_601 = param2;
      ...
      public function initGeometry(param1:XML) : void
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Geometry for structure: " + this.var_601);
            return;
         }
      ...
      public function initActions(param1:IAssetLibrary, param2:XML) : void
      {
         if(!param2)
         {
            Logger.log("[AvatarStructure] Could not init Actions for structure: " + this.var_601);
            return;
         }
         this.var_1136 = new AvatarActionManager(param1,this.var_601,param2);
         this.var_1103 = this.var_1136.getDefaultAction();
      }
      ...
      public function initPartSets(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Part Sets for structure: " + this.var_601);
            return false;
         }
         if(this.var_501.parse(param1))
         {
            if(this.var_601 == AvatarType.const_134)
            {
               this.var_501.getPartDefinition("ri").appendToFigure = true;
               this.var_501.getPartDefinition("li").appendToFigure = true;
            }
            return true;
         }
         return false;
      ...
      public function initAnimation(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Animations for structure: " + this.var_601);
            return false;
         }
      ...
      public function initFigureData(param1:XML) : Boolean
      {
         if(!param1)
         {
            Logger.log("[AvatarStructure] Could not init Figure Data for structure: " + this.var_601);
            return false;
         }
         return this.var_425.parse(param1);
      }
      
      public function injectFigureData(param1:XML) : void
      {
         this.var_425.injectXML(param1);
      }
      ...
      public function registerAnimations(param1:AssetLibraryCollection, param2:String = "fx", param3:int = 200) : void
      {
         ...
         while(_loc5_ < param3)
         {
            if(param1.hasAsset(param2 + _loc5_))
            {
               ...
               this.var_919.registerAnimation(this,_loc4_);
            }
            _loc5_++;
         }
      }
      ...
      public function getPartColor(param1:IAvatarFigureContainer, param2:String, param3:int = 0) : IPartColor
      {
         ...
         var _loc5_:ISetType = this.var_425.getSetType(param2);
         if(_loc5_ == null)
         {
            return null;
         }
         var _loc6_:IPalette = this.var_425.getPalette(_loc5_.paletteID);
         if(!_loc6_)
         {
            return null;
         }
      ...
      {
         return this.var_919.getLayerData(param1,param2,param3) as AnimationLayerData;
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return this.var_919.getAnimation(param1) as Animation;
      }
      
      public function getActionDefinition(param1:String) : ActionDefinition
      {
         return this.var_1136.getActionDefinition(param1);
      }
      
      public function getActionDefinitionWithState(param1:String) : ActionDefinition
      {
         return this.var_1136.getActionDefinitionWithState(param1);
      }
      ...
      {
         return this.var_1136.sortActions(param1);
      }
      ...
      public function getMandatorySetTypeIds(param1:String, param2:int) : Array
      {
         ...
         {
            this.var_745[param1] = new Dictionary();
         }
         if(this.var_745[param1][param2])
         {
            return this.var_745[param1][param2];
         }
         this.var_745[param1][param2] = this.var_425.getMandatorySetTypeIds(param1,param2);
         return this.var_745[param1][param2];
      }
      
      public function getDefaultPartSet(param1:String, param2:String) : IFigurePartSet
      {
         return this.var_425.getDefaultPartSet(param1,param2);
      }
      
      public function getCanvasOffsets(param1:Array, param2:String, param3:int) : Array
      {
         return this.var_1136.getCanvasOffsets(param1,param2,param3);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = this.var_919.getAnimation(_loc6_) as Animation;
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  ...
                  for each(_loc12_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc9_ = this.var_501.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = this.var_501.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1800[param3];
      ...
      public function getParts(param1:String, param2:IAvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int, param6:Array, param7:Dictionary = null) : Array
      {
         ...
         var _loc8_:Array = this.var_501.getActiveParts(param3.definition);
         ...
         if(param3.definition.isAnimation)
         {
            ...
            _loc9_ = this.var_919.getAnimation(_loc23_) as Animation;
            if(_loc9_ != null)
            {
         ...
         for each(_loc16_ in _loc20_)
         {
            ...
            _loc29_ = this.var_425.getSetType(_loc16_);
            if(_loc29_)
            {
               _loc30_ = this.var_425.getPalette(_loc29_.paletteID);
               if(_loc30_)
               {
                  ...
                  if(_loc31_)
                  {
                     ...
                     for each(_loc32_ in _loc31_.parts)
                     {
                        if(_loc15_.indexOf(_loc32_.type) > -1)
                        {
                           ...
                           {
                              _loc33_ = this.var_1103;
                           }
                           _loc12_ = this.var_501.getPartDefinition(_loc32_.type);
         ...
         for each(_loc11_ in _loc15_)
         {
            ...
            if(!_loc37_)
            {
               ...
               if(_loc8_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc12_ = this.var_501.getPartDefinition(_loc11_);
                     _loc42_ = false;
                     _loc43_ = 1;
      ...
      public function method_7(param1:int, param2:String, param3:String, param4:String, param5:int, param6:int) : Point
      {
