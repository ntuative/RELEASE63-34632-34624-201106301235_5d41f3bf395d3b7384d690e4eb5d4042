package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_2582:IWindowContainer;
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         this.var_1913 = IButtonWindow(this.find("bg_tab"));
         this.var_1912 = IButtonWindow(this.find("top_tab"));
         this.var_1911 = IButtonWindow(this.find("obj_tab"));
         this.var_2582 = IWindowContainer(this.find("tile_grid"));
         this.var_2583 = IWindowContainer(this.find("now_editing_container"));
         Util.setProcDirectly(this.find("save"),this.onSaveButton);
         Util.setProcDirectly(this.find("cancel"),this.onCancelButton);
         Util.setProcDirectly(this.var_1913,this.onBgTabButton);
         Util.setProcDirectly(this.var_1912,this.onTopTabButton);
      ...
      {
         this.setEnabled(this.var_1913,this.var_78.mode != ThumbnailEditorModel.const_37);
         this.setEnabled(this.var_1912,this.var_78.mode != ThumbnailEditorModel.const_63);
         this.setEnabled(this.var_1911,this.var_78.mode != ThumbnailEditorModel.const_33);
      }
      
      private function refreshEditArea() : void
      {
         var _loc1_:IWindowContainer = this.var_2583;
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = this.var_2582;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_517)
            {
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            _loc11_ = IRegionWindow(this._navigator.windowManager.createWindow("img_" + _loc8_,"",WindowType.const_331,HabboWindowStyle.const_46,0 | 0,new Rectangle(_loc9_ * 66,0,66,66),this.onImgSel,_loc10_.id));
