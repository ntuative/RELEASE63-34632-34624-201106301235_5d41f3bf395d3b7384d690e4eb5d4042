package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualizationPlanetObject
   {
      ...
      private static const const_1621:Number = 30;
      ...
      public function FurniturePlanetSystemVisualizationPlanetObject(param1:String, param2:int, param3:Number, param4:Number, param5:Number, param6:Number)
      {
         ...
         this.var_2738 = param4 * 0 * 2 / 360;
         this.var_2018 = param5 * 0 * 2 / 360;
         this._height = param6;
         this.var_1304 = 0;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1304 += this.var_2738 / const_1621;
      ...
      {
         var _loc3_:Number = this.var_1538 * Math.cos(this.var_1304 + this.var_2018);
         var _loc4_:Number = this.var_1538 * Math.sin(this.var_1304 + this.var_2018);
