package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_1076:uint = 2;
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         ...
         var _loc5_:uint = !!param1.background ? uint(const_1076) : uint(const_692);
         var _loc6_:Boolean = this.var_197.width > 0 && this.var_197.height > 0;
         var _loc7_:ISkinRenderer = this.resolveSkinRenderer(param1);
         if(_loc7_ != null)
         {
            if(_loc7_.isStateDrawable(this.var_1000))
            {
               _loc5_ = const_1077;
            }
         }
         ...
         if(_loc5_ != const_692)
         {
            this.var_1509 = this.var_1000;
            _loc4_ = param1.fetchDrawBuffer() as BitmapData;
            if(_loc4_ != null)
            {
               _loc4_.lock();
               if(_loc5_ == const_1077)
               {
                  _loc6_ = true;
                  ...
                  if(this.var_647)
                  {
                     ...
                     _loc7_.draw(param1,this.var_129,this.var_129.rect,this.var_1000,false);
                  }
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     this.var_1147.tx = param2.x;
                     this.var_1147.ty = param2.y;
                     this.var_912.alphaMultiplier = param1.blend;
                     param3.offset(param2.x,param2.y);
                     _loc4_.draw(this.var_129,this.var_1147,this.var_912,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
            ...
            this.var_197.left = int.MAX_VALUE;
            this.var_197.top = int.MAX_VALUE;
            this.var_197.right = int.MIN_VALUE;
            this.var_197.bottom = int.MIN_VALUE;
         }
         return true;
      }
      ...
      {
         return this._skinContainer.getTheActualState(param1.type,param1.style,param1.state) != this.var_1509;
      }
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.const_1382:
               ...
               break;
            case WindowRedrawFlag.const_927:
               this.var_1000 = this._skinContainer.getTheActualState(param1.type,param1.style,param1.state);
               if(this.var_1000 != this.var_1509)
               {
                  this.var_647 = true;
                  _loc4_ = true;
               }
               break;
            case WindowRedrawFlag.const_1248:
               if(param1.testParamFlag(WindowParam.const_32))
               {
                  this.var_647 = true;
                  _loc4_ = true;
               ...
               break;
            case WindowRedrawFlag.const_1310:
               _loc4_ = true;
         }
         if(_loc4_)
         {
            this.var_197.left = Math.min(this.var_197.left,param2.left);
            this.var_197.top = Math.min(this.var_197.top,param2.top);
            this.var_197.right = Math.max(this.var_197.right,param2.right);
            this.var_197.bottom = Math.max(this.var_197.bottom,param2.bottom);
         }
         return _loc4_;
      }
