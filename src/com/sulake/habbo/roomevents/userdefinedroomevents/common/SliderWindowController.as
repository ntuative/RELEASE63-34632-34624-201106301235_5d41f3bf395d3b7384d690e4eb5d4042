package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1387:Number = 1.0;
      
      private var var_735:Number = 0.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1387,param1);
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_1128);
         }
      ...
      {
         return int(this.var_1760 * (Number(param1 - this._minValue) / (this.var_1387 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1760 * (this.var_1387 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1129)
         {
            if(param1.type == WindowMouseEvent.const_55 || param1.type == WindowMouseEvent.const_244)
            {
               this.var_1129 = false;
            }
         }
         if(!this.var_1129 || param1.type != WindowEvent.const_424)
         {
            return;
         }
         if(this.var_735 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_735) * this.var_735;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_735 != 0)
            {
               _loc3_ = this.var_1128 + this.var_735;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_771 != null)
            {
               ...
               this.var_1760 = _loc1_.width - _loc2_.width;
            }
         }
