package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_818:IssueMessageData = null;
      
      private var var_817:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2333 = param2.pickerUserId;
         this.var_2552 = param2.pickerUserName;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_818 == null || param1.timeStamp < this.var_818.timeStamp)
         {
            this.var_818 = param1;
         }
         if(this.var_817 == null || param1.priority > this.var_817.timeStamp)
         {
            this.var_817 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_817;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_818;
         if(_loc2_ == null)
         {
