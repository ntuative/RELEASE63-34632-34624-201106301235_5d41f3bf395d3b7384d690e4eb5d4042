package com.sulake.habbo.catalog.purchase
{
   ...
   public class ChargeConfirmationDialog implements IDisposable
   {
      ...
      public function refresh() : void
      {
         ...
         {
            this.showChargeInfo(this.var_766);
         }
      }
      ...
      public function showChargeInfo(param1:ChargeInfo) : void
      {
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.currentamount","charges","" + this.var_766.charges);
         var _loc2_:ChargeOffer = new ChargeOffer(this.var_766);
         ...
         this._catalog.windowManager.registerLocalizationParameter("catalog.charge.info","patch_size","" + this.var_766.chargePatchSize);
      ...
      {
         this._catalog.connection.send(new UseFurnitureMessageComposer(this.var_766.stuffId,2));
      }
