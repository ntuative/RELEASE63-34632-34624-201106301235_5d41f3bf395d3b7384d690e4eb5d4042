package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_931:String = "PLSV_ADD_SONGS";
      
      public static const const_1377:String = "PLSV_START_PLAYBACK";
      
      public static const const_623:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_623)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_497[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_497[const_931];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_497.add(const_623,_loc1_);
