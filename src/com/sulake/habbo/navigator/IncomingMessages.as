package com.sulake.habbo.navigator
{
   ...
   public class IncomingMessages
   {
      ...
      private function onUserRights(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.securityLevel >= SecurityLevelEnum.const_1976)
         {
      ...
      private function onRoomInfo(param1:IMessageEvent) : void
      {
         ...
         {
            if(_loc2_.data.doorMode == RoomSettingsData.const_215 && this._navigator.sessionData.userName != _loc2_.data.ownerName)
            {
      ...
      private function onFlatCreated(param1:IMessageEvent) : void
      {
         ...
         this._navigator.mainViewCtrl.reloadRoomList(Tabs.const_289);
      }
      ...
      private function onRoomSettingsData(param1:IMessageEvent) : void
      {
         ...
         try
         {
            ...
            Logger.log("GOT ROOM SETTINGS DATA: " + parser.data.name + ", " + parser.data.maximumVisitors + ", " + parser.data.method_2);
         }
         catch(e:Error)
         {
      ...
      private function onCanCreateRoom(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(this._navigator.sessionData.hasUserRight("fuse_can_create_more_rooms",HabboClubLevelEnum.const_40))
            {
