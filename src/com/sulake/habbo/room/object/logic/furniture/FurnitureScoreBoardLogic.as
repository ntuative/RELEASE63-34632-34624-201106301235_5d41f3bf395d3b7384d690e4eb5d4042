   ...
   public class FurnitureScoreBoardLogic extends FurnitureLogic
   {
      ...
      private function updateScore(param1:int) : void
      {
         ...
         if(this.var_787 != _loc2_)
         {
            ...
            if(_loc3_ * const_481 > const_1052)
            {
               this.var_947 = const_1052 / _loc3_;
            }
            else
            {
               this.var_947 = const_481;
            }
            this.var_1482 = getTimer();
         }
      }
      ...
      override public function update(param1:int) : void
      {
         ...
         if(object != null)
         {
            ...
            if(_loc2_ != this.var_787 && param1 >= this.var_1482 + this.var_947)
            {
               _loc3_ = param1 - this.var_1482;
               ...
               this.var_1482 = param1 - (_loc3_ - _loc4_ * this.var_947);
            }
         }
      }
   }
