package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1095:IDesktopWindow;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_898 = param2;
         this._events = param3;
         this.var_1095 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_898.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_898.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_898.loadAssetFromFile("hotel_view_banner_" + this.var_1357,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_916));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1095.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1095.removeChild(this._window);
         }
      }
   }
}
