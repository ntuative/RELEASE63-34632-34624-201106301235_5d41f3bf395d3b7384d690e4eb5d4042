package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_660,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_644,this.onTaskDoneEvent);
         this.var_35.events.addEventListener(HabboHelpTutorialEvent.const_662,this.onTaskDoneEvent);
      ...
      {
         return this.var_1265 && this.var_1264 && this.var_1558;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_35)
         {
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_660,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_644,this.onTaskDoneEvent);
            this.var_35.events.removeEventListener(HabboHelpTutorialEvent.const_662,this.onTaskDoneEvent);
            if(this.var_35.sessionDataManager != null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_660:
               this.var_1558 = true;
               if(this.var_53 != null && this.var_53.id == const_504)
               {
                  this.showView(const_94);
               }
               break;
            case HabboHelpTutorialEvent.const_644:
               if(this.var_53 != null && this.var_53.id == const_421)
               {
                  this.var_1957 = true;
                  this.disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_662:
               if(this.var_1957)
               {
                  this.var_1957 = false;
                  this.showView(const_94);
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2646 = this._window.width - _loc2_.width;
         ...
         this._window.width = _loc2_.width + this.var_2646;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_362 || this.var_53.id == const_94))
         {
            this.showView(const_94);
         }
      }
      ...
      {
         this.var_1265 = true;
         if(this.var_53 != null && (this.var_53.id == const_421 || this.var_53.id == const_94))
         {
            this.showView(const_94);
         }
      }
