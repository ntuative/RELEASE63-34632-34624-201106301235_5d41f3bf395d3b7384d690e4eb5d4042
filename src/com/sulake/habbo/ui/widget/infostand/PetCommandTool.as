package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_417 = new Timer(this.const_2368);
         this.var_417.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1348.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1348.getValue(this.var_583) as CommandConfiguration;
      ...
      {
         this.var_1348.remove(param1);
         this.var_1348.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_874,param1);
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_43.context.getDesktopWindow().addEventListener(WindowEvent.const_39,this.onWindowDesktopResized);
         this.var_43.procedure = this.onCommandWindowProcedure;
         this.var_43.position = const_1498;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_493 == null)
         {
            ...
            this.var_493 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_493 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_493.x = 200;
            this.var_493.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_248,this.var_583));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_525,this.var_583,this.var_2118 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_525,this.var_583,this.var_2118 + " " + _loc5_);
