   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_227 != null)
         {
            ...
            {
               _loc1_ = this.var_227[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_887.removeReference();
         }
         this.var_887 = param1;
         if(this.var_887 != null)
         {
            this.var_887.addReference();
         }
      }
      ...
      {
         var _loc2_:* = null;
         while(this.var_227.length > param1)
         {
            _loc2_ = this.var_227[this.var_227.length - 1] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
