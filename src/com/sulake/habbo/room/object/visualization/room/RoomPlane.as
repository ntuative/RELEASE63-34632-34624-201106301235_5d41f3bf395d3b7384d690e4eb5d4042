package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_1076:IPlaneRasterizer = null;
      
      private var var_797:PlaneMaskManager = null;
      
      private var _id:String = null;
      
      private var var_2765:Number = 0;
      
      private var var_2769:Number = 0;
      ...
      private var var_487:PlaneBitmapData = null;
      ...
      private var var_874:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         this.var_2769 = param10;
         this.var_2766 = param11;
         this.var_2764 = param12;
         this.var_1075 = param6;
      }
      
      public function set canBeVisible(param1:Boolean) : void
      {
         if(param1 != this.var_874)
         {
            if(!this.var_874)
            {
      ...
      {
         return this._isVisible && this.var_874;
      }
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_706);
                  return param1;
               }
            }
         }
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1076.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_487;
         if(_loc3_ == null)
         {
         ...
         if(this.var_874 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_402))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(this.needsNewTexture(param1,param2))
         {
            ...
            if(this.var_1076 != null)
            {
               _loc3_ = this.var_1076.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_2061,this.var_2765,this.var_2769,this.var_2766,this.var_2764,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1890 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_874)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1488.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1488[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1318);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_181.z - originZ,this.var_137.z - originZ,this.var_100.z - originZ,this.var_136.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2768 = relativeDepth;
            this._isVisible = true;
            this.var_1890 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2767);
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_295.length == this.var_1074.length)
         {
            while(_loc1_ < this.var_295.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = this.var_1074[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_403.length > this.var_1614.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1075 || this.var_295.length == 0 && this.var_403.length == 0 && !this.var_402 || this.var_797 == null)
         {
            return;
         }
         ...
         if(this.var_402)
         {
            ...
            while(_loc5_ < this.var_295.length)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc3_.leftSideLoc / this.var_352.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc3_.rightSideLoc / this.var_353.length;
                  _loc12_ = _loc3_.type;
                  this.var_797.updateMask(this.var_79,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1074.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_403.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_79.width - this.var_79.width * _loc4_.leftSideLoc / this.var_352.length;
                  _loc11_ = this.var_79.height - this.var_79.height * _loc4_.rightSideLoc / this.var_353.length;
                  _loc13_ = this.var_79.width * _loc4_.leftSideLength / this.var_352.length;
                  _loc14_ = this.var_79.height * _loc4_.rightSideLength / this.var_353.length;
                  this.var_79.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
                  this.var_1614.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            this.var_402 = false;
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         this.var_257.copyChannel(param1,param1.rect,const_706,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_257.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_257,this.var_257.rect,const_706,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
