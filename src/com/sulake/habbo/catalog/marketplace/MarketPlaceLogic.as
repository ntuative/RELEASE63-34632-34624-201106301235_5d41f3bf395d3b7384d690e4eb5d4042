package com.sulake.habbo.catalog.marketplace
{
   ...
   public class MarketPlaceLogic implements IMarketPlace
   {
      ...
      public const const_2314:int = 1;
      
      public const const_2237:int = 2;
      
      public const const_2387:int = 3;
      ...
      public function dispose() : void
      {
         ...
         {
            this.disposeOffers(this.var_343);
            this.var_343 = null;
         }
         this._disposed = true;
      }
      ...
      {
         this.requestOffers(this.var_2896,this.var_2897,this.var_2810,this.var_2894);
      }
      ...
      public function buyOffer(param1:int) : void
      {
         ...
         this.showConfirmation(this.const_2314,_loc2_);
      }
      ...
      public function redeemSoldOffers() : void
      {
         ...
         var _loc1_:Array = this.var_343.getKeys();
         for each(_loc2_ in _loc1_)
         {
            _loc3_ = this.var_343.getValue(_loc2_);
            if(_loc3_.status == MarketPlaceOfferState.const_558)
            {
               this.var_343.remove(_loc2_);
               _loc3_.dispose();
            }
         }
         if(this._catalog)
      ...
      public function onOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2893 = _loc3_.totalItemsFound;
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
         }
      ...
      public function onOwnOffers(param1:IMessageEvent) : void
      {
         ...
         this.var_2674 = _loc3_.creditsWaiting;
         for each(_loc4_ in _loc3_.offers)
         {
            ...
            _loc5_.timeLeftMinutes = _loc4_.timeLeftMinutes;
            this.var_343.add(_loc4_.offerId,_loc5_);
         }
         if(this._visualization != null)
         {
            this._visualization.listUpdatedNotify();
      ...
      public function onBuyResult(param1:IMessageEvent) : void
      {
         ...
         else if(parser.result == 3)
         {
            ...
            this.showConfirmation(this.const_2237,updateItem);
            if(this._visualization != null)
            {
               this._visualization.listUpdatedNotify();
            }
      ...
      public function onCancelResult(param1:IMessageEvent) : void
      {
         ...
         if(parser.result == 1)
         {
            item = this.var_343.remove(parser.offerId);
            if(item != null)
            {
               item.dispose();
            }
      ...
      {
         if(param1.furniCategoryId != this.var_2840 || param1.furniTypeId != this.var_2839)
         {
            return;
         }
      ...
      private function isPosterItem(param1:IMarketPlaceOfferData) : Boolean
      {
         ...
         if(param1.furniType == 2 && param1.stuffData != null)
         {
            ...
            {
               _loc4_ = _loc3_.name;
               if(_loc4_ != null && _loc4_ == const_1553)
               {
                  _loc2_ = true;
               }
            }
