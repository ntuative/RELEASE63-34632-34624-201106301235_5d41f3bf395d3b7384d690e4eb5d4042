package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_715:uint = 1;
      ...
      private var var_1209:IRoomSession;
      ...
      private var var_260:ICatalogNavigator;
      ...
      private var var_2884:Boolean = true;
      
      private var var_2887:Boolean = true;
      
      private var var_2114:Boolean = false;
      
      private var var_2885:GiftWrappingConfiguration;
      
      private var var_1344:ClubGiftController;
      
      private var var_582:ClubBuyController;
      ...
      private var var_889:IPurchasableOffer;
      
      private var var_1646:IDragAndDropDoneReceiver;
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1807);
               return;
            }
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NOT_READY));
            _loc2_ = this.var_415.loadProductData(this);
            if(_loc2_)
            {
               this.init();
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_582.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2886 = this.isNewItemsNotificationEnabled();
      ...
      private function sessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_415.loadProductData(this);
      }
      ...
      {
         if(this._roomEngine != null && this.var_161 != null && this.var_161.getKey("catalog.furniture.animation","HabboFriendBarCom_im_notification_icon_png") == "true")
         {
            if(this.var_721 == null)
            {
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_906 || !this.var_260 || !this.var_260.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1102 = -1;
            this.var_891 = param1;
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_260.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_161.getKey("client.credits.embed.enabled","HabboFriendBarCom_im_notification_icon_png") == "true";
         if(false && _loc1_)
         {
      ...
      {
         return this.var_415.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_415.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_62)
         {
            _loc3_ = this.var_415.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_890.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_260 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_715) as IWindowContainer;
         ...
         _loc3_.setParamFlag(WindowParam.const_261,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_76:
               this.var_2114 = param1.session.isPrivateRoom;
               this.var_1209 = param1.session;
               if(this.var_107 != null)
               {
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1344 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_582 == null)
         {
            this.var_582 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1645 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_260.buildCatalogIndex(_loc2_);
         if(this.var_891 && this.var_891 != "")
         {
            this.var_260.openPage(this.var_891);
            this.var_891 = "";
            this.var_1102 = -1;
         }
         else if(this.var_1102 > -1)
         {
            this.var_260.openPageById(this.var_1102,this.var_2113);
            this.var_1102 = -1;
            this.var_2113 = -1;
            this.var_891 = "";
         }
         else if(this.var_1645 && this.var_2886)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_260.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1788));
         }
         else
         {
            this.var_260.loadFrontPage();
         }
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2884 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1408);
         }
         this.var_2884 = false;
         ...
         events.dispatchEvent(new PurseEvent(PurseEvent.const_124,this.var_114.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2887 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1301);
         }
         this.var_2887 = false;
         if(this.var_230 != null && !this.var_230.disposed)
         {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_382,_loc2_.amount));
         }
         if(_loc2_.type == ActivityPointTypeEnum.const_830)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         {
            events.dispatchEvent(new PurseEvent(PurseEvent.const_382,_loc2_.points["null"]));
         }
         if(_loc2_.points["null"] != null)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_114.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1334 ? true : false;
         this.updatePurse();
         if(_loc2_.responseType == ScrSendUserInfoMessageParser.RESPONSE_TYPE_PURCHASE)
         {
            this.reset();
            this.openCatalogPage(CatalogPageName.const_128,true);
         }
      }
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1344.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2885 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_582 != null)
         {
            this.var_582.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_720 != null && this.var_161.getBoolean("club.membership.extend.promotion.enabled",false))
         {
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_890.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_890.add(_loc2_.productCode,_loc3_.slice());
      ...
      public function isDraggable(param1:Offer) : Boolean
      {
         ...
         if(!this.var_1209 || !this.var_1209.isRoomOwner)
         {
            return false;
         }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
         ...
         var _loc5_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1345 && param1.type == RoomEngineObjectEvent.const_174)
         {
            this.resetPlacedOfferData(true);
            if(this.var_889 == null || this.var_889.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_889.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_889);
            _loc5_ = this.var_1646;
            if(_loc5_ != null)
            {
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_374,0.5);
            }
         }
      }
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_337:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_228);
                  ...
                  case FurniCategory.const_348:
                     _loc10_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_224);
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_715);
            if(_loc1_ != null)
            {
