package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      public function updateView() : void
      {
         ...
         if(this._figure && this.var_1625)
         {
            _loc5_ = this.var_26.manager.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_113,this.var_1085,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_42,parseInt(FigureData.const_760));
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "set_button":
               ...
               this.var_1085 = this.var_26.gender;
               this.var_26.handler.saveWardrobeOutfit(this.var_2080,this);
               this.updateView();
               break;
            case "get_button":
               if(this._figure)
               {
                  this.var_26.loadAvatarInEditor(this._figure,this.var_1085,this.var_26.clubMemberLevel);
               }
         }
      }
