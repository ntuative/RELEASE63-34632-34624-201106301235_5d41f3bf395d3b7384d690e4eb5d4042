package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1439:int = 56;
      
      private static const const_474:int = 5;
      
      private static const const_1438:int = 5;
      
      private static const const_1043:Point = new Point(8,8);
      
      private static const const_1440:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         if(this._window == null)
         {
            ...
            _loc8_.x = const_1043.x;
            _loc8_.y = const_1043.y;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1438;
         }
         _loc3_.visible = !_loc2_;
         var _loc5_:int = this.getTextHeight(_loc3_) - _loc4_;
         var _loc6_:int = this.setupLink("link_region",_loc3_.y + _loc3_.height + const_474);
         ...
         this._window.height = _loc8_.height + const_1439;
      ...
      private function setupLink(param1:String, param2:int) : int
      {
         ...
         {
            _loc7_ = const_474 + _loc6_.height;
         }
         if(!_loc5_ && _loc6_.visible)
         {
            _loc7_ = -const_474 - _loc6_.height;
      ...
      {
         return this.var_133.waitPeriodSeconds < 1 && const_1440.indexOf(this.var_133.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_48.localization.hasKey(this.var_133.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_48.localization.hasKey(this.var_133.getCampaignLocalizationKey() + ".searchtag");
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_48.openCatalog(this.var_133);
            }
            else if(this.hasNavigatorLink())
            {
               this.var_48.openNavigator(this.var_133);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1464 = NextQuestTimer.const_797;
         var _loc2_:Boolean = this.var_48.questController.questsList.refreshDelay(this._window,this.var_133);
         if(_loc2_)
         {
