package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      {
         this.var_1304 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
      ...
      {
         return this.getFrame(param1) == const_1140;
      }
      ...
      {
         var _loc2_:int = param1 - this.var_2823;
         if(_loc2_ < 0)
         {
            return const_1642;
         }
         var _loc3_:int = Math.floor(_loc2_ / const_1643);
