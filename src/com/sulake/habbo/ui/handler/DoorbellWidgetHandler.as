package com.sulake.habbo.ui.handler
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetLetUserInMessage.const_1026];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetLetUserInMessage.const_1026:
      ...
      {
         return [RoomSessionDoorbellEvent.const_127,RoomSessionDoorbellEvent.const_145,RoomSessionDoorbellEvent.const_59];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_127:
               ...
               this._container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_912,_loc2_.userName));
               break;
