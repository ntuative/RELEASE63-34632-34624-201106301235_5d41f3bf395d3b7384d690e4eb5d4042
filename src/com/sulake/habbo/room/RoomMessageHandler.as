package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      {
         if(this.var_980 != 0 || this.var_979 != 0)
         {
            if(this.var_11 != null)
            {
               this.var_11.disposeRoom(this.var_980,this.var_979);
            }
         }
         this.var_980 = param1;
         this.var_979 = param2;
      ...
      private function onRoomReady(param1:IMessageEvent) : void
      {
         ...
         if(this.var_980 != _loc3_.roomId || this.var_979 != _loc3_.roomCategory)
         {
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_785.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_785.objectData);
            this.var_785.objectData = null;
         }
         else
         {
            this.var_785.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_785.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_785.objectData = _loc6_;
         }
      }
      ...
      private function onWave(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_297,_loc6_);
      }
      ...
      private function onDance(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:int = this.getRoomId(_loc3_.roomId);
         var _loc5_:int = this.getRoomCategory(_loc3_.roomCategory);
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_576,_loc3_.danceStyle);
      }
      ...
      private function onAvatarSleep(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_249,_loc6_);
      }
      ...
      private function onUseObject(param1:IMessageEvent) : void
      {
         ...
         if(param1 is UseObjectMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_282,_loc2_.itemType);
         }
      }
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1356:
                     _loc9_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1308:
                     _loc9_ = "std";
               }
      ...
      private function onTypingStatus(param1:IMessageEvent) : void
      {
         ...
         this.var_11.updateObjectUserAction(_loc4_,_loc5_,_loc3_.userId,RoomObjectVariableEnum.const_663,_loc6_);
      }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1311,_loc3_.status);
         }
      }
      ...
      private function onGamePlayerNumberValue(param1:IMessageEvent) : void
      {
         ...
         if(param1 is GamePlayerValueMessageEvent)
         {
            ...
            _loc3_ = this.getRoomId(_loc2_.roomId);
            _loc4_ = this.getRoomCategory(_loc2_.roomCategory);
            this.var_11.updateObjectUserAction(_loc3_,_loc4_,_loc2_.userId,RoomObjectVariableEnum.const_399,_loc2_.value);
         }
      }
   }
}
