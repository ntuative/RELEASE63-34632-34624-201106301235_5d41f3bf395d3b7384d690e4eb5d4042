package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1590:String = "branded_image";
      
      private static const const_1593:int = 0;
      
      private static const const_1594:int = 1;
      
      private static const const_1591:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1708 = _loc4_.getNumber(RoomObjectVariableEnum.const_544);
                  this.var_1709 = _loc4_.getNumber(RoomObjectVariableEnum.const_488);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_580);
               }
            }
         }
         if(!this.var_1418)
         {
            this.var_1418 = this.checkIfImageReady();
            if(this.var_1418)
            {
               this.checkAndCreateImageForCurrentState(param1);
               return true;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_604);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1590)
         {
