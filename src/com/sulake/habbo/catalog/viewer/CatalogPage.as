package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_1177:ItemGridCatalogWidget;
      ...
      {
         return this._localization.getLinks(this.var_1178);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1178);
      }
      ...
      protected function createWindow(param1:String) : Boolean
      {
         ...
         this.var_2246 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2246) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1748:
               if(this.var_1177 == null)
               {
                  this.var_1177 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_38.push(this.var_1177);
               }
               break;
