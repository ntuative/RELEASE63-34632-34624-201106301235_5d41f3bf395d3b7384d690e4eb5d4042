package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      protected function createWindow(param1:String) : void
      {
         ...
         this.var_267 = this.var_46.findChildByTag("catalog");
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_1360 || param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_524 && param1.isRoomOwner)
         {
      ...
      private function getAdFurnitureExtraParams() : Map
      {
         ...
         {
            _loc2_ = this._widget.furniData.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_1172.length);
            _loc3_ = _loc2_.split("\t");
            if(_loc3_ != null)
            {
