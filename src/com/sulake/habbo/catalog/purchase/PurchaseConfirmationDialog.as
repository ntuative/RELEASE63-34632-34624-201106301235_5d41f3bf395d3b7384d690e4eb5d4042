package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2360:int = 10;
      ...
      private const const_2095:uint = 4.293848814E9;
      
      private const const_2096:uint = 4.294967295E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1294 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1761 = _loc1_.stuffTypes;
            this.var_851 = _loc1_.boxTypes;
            this.var_850 = _loc1_.ribbonTypes;
            this.var_1295 = this.var_1761[0];
            this.var_395 = this.var_851[0];
            this.var_393 = this.var_850[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_393 < 0)
         {
            this.var_393 = this.var_850.length - 1;
         }
         if(this.var_393 > this.var_850.length - 1)
         {
            this.var_393 = 0;
         }
         if(this.var_395 < 0)
         {
            this.var_395 = this.var_851.length - 1;
         }
         if(this.var_395 > this.var_851.length - 1)
         {
            this.var_395 = 0;
         }
         var _loc1_:int = this.var_851[this.var_395] * 1000 + this.var_850[this.var_393];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1295,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1761)
         {
      ...
      private function method_11() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1295);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_851[this.var_395]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_850[this.var_393]);
         this._catalog.purchaseProductAsGift(this.var_1583,this.var_1294,this.var_1582,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1583,this.var_1294,this.var_1582);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2696 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_240)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2360)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2696 = _loc2_.text;
      }
      ...
      {
         if(this.var_291 == null || !this.var_291.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_291.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_291 == null)
         {
            this.var_291 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_852 == null)
         {
            this.var_852 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_291 == null || this.var_852 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_291.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_291.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         return param1 % 2 == 0 ? uint(this.const_2095) : uint(this.const_2096);
      }
      ...
      {
         this.var_1295 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1295;
               }
            }
            _loc4_++;
         }
