package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1098:uint = 11;
      ...
      private var var_1248:IHabboWindowManager;
      ...
      private var var_466:FramerateTracker = null;
      
      private var var_280:LatencyTracker = null;
      
      private var var_670:LagWarningLogger = null;
      
      private var var_467:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_466 = new FramerateTracker();
         this.var_280 = new LatencyTracker();
         this.var_670 = new LagWarningLogger();
         this.var_467 = new ToolbarClickTracker(this);
         this.var_1534 = new Array(const_1098);
         var _loc4_:int = 0;
         while(_loc4_ < const_1098)
         {
            this.var_1534[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1878,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1869,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1845,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_785,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1200,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1248)
            {
               this.var_1248.release(new IIDHabboWindowManager());
               this.var_1248 = null;
            }
            if(this.var_318)
            {
            ...
            if(this.var_217)
            {
               if(!this.var_217.disposed)
               {
                  ...
                  Component(this.var_217).events.removeEventListener(HabboFriendListTrackingEvent.const_613,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_375,this.onRoomAction);
               }
            ...
            {
               this.var_334.stop();
               this.var_334.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_334 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_161)
         {
            if(this.var_280 != null)
            {
               this.var_280.configuration = this.var_161;
            }
            if(this.var_279 != null)
            {
               this.var_279.configuration = this.var_161;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1775);
            if(this.var_161)
            {
               if(this.var_670 != null)
               {
                  this.var_670.configure(this.var_161);
               }
               if(this.var_466 != null)
               {
                  this.var_466.configure(this.var_161);
               }
               if(this.var_467 != null)
               {
                  this.var_467.configure(this.var_161);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_294,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_916,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_280 != null)
            {
               this.var_280.communication = this._communication;
               this.var_280.connection = param1;
            }
            if(this.var_670 != null)
            {
               this.var_670.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_916)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_2015);
         }
         else if(param1.type == HabboHotelViewEvent.const_589)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1933);
         }
         else if(param1.type == HabboHotelViewEvent.const_68)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1825);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboCommunicationEvent.const_748:
               this.trackLoginStep(HabboLoginTrackingStep.const_1906,String(this._communication.port));
               break;
            ...
            case HabboCommunicationEvent.const_222:
               ...
               break;
            case HabboCommunicationEvent.const_294:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_294);
               if(this.var_280 != null)
               {
                  this.var_280.init();
               }
      ...
      {
         this.var_1248 = IHabboWindowManager(param2);
         if(this.var_1248)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_161)
            {
               if(this.var_161.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1534)
                  {
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_217).events.addEventListener(HabboFriendListTrackingEvent.const_613,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_613:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1200,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_375,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_318 = param2 as IAdManager;
         this.var_318.events.addEventListener(AdEvent.const_637,this.onRoomAdLoad);
      }
      ...
      private function onRoomAction(param1:RoomEngineEvent) : void
      {
         if(param1.type == RoomEngineEvent.const_185)
         {
            if(this.var_1916 < 1)
            {
               if(!this.var_334)
               {
                  this.var_334 = new Timer(60000,1);
                  this.var_334.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_334.start();
               }
            }
         }
         else if(param1.type == RoomEngineEvent.const_375)
         {
            if(this.var_334)
            {
               this.var_334.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_466)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_466.frameRate),_loc2_);
                  ++this.var_1916;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_467)
         {
            this.var_467.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_467)
         {
            this.var_467.track(param1.type);
         }
      }
      ...
      {
         this.var_670.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_279 != null)
         {
            this.var_279.update(param1,this.var_554);
         }
         if(this.var_280 != null)
         {
            this.var_280.update(param1,this.var_554);
         }
         if(this.var_466 != null)
         {
            this.var_466.trackUpdate(param1,this,this.var_554);
         }
         if(this.var_670 != null)
         {
            this.var_670.update(this.var_554);
         }
      }
   }
}
