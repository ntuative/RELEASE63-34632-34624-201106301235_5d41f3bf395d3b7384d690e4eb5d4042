package com.sulake.habbo.ui.handler
{
   ...
   public class WelcomeGiftWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function addMessageEvents() : void
      {
         ...
         this.var_834 = [];
         this.var_834.push(new WelcomeGiftStatusEvent(this.onWelcomeGiftStatus));
         this.var_834.push(new ChangeEmailResultEvent(this.onChangeEmailResult));
      ...
      {
         var _loc1_:* = null;
         if(!this._container || !this._container.connection || !this.var_834)
         {
            return;
         }
         for each(_loc1_ in this.var_834)
