package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2066:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2763:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1613 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1613;
            this.var_1613 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_681 != spriteCount)
         {
            createSprites(this.var_681);
         }
         if(param2)
         {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_456:
               break;
            case LayerData.const_1355:
               _loc2_ = "null";
               break;
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_513 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2763)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2762 = _loc3_.getNumber(RoomObjectVariableEnum.const_259);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_374));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_2494 = this.var_1317 != null;
            this.var_2759 = _loc3_.getNumber(RoomObjectVariableEnum.const_961);
      ...
      {
         if(this.var_2758 != param2 || this.var_2761 != param1)
         {
            this.var_1072 = [];
            this.var_1073 = [];
            this.var_871 = [];
            ...
            this.var_2760 = this.getSize(param1);
      ...
      {
         this.var_681 = param1;
         this.var_1612 = this.var_681 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_650.length)
         {
            return "";
         }
         var _loc3_:String = this.var_1072[param2];
         var _loc4_:Boolean = this.var_1073[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2760;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1612)
            {
               _loc6_ = FurnitureVisualizationData.const_650[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_1072[param2] = _loc3_;
            this.var_1073[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_869[param3] != null && !this.var_2060)
         {
