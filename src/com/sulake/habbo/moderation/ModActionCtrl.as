package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1342:IDropMenuWindow;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1341 = IButtonWindow(this.var_35.getXmlWindow("modact_offence"));
         this.var_1340 = IButtonWindow(this.var_35.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1973;
         ...
         this.var_1342 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1342);
      ...
      public function refreshCategorization() : void
      {
         ...
         {
            this.refreshButtons("offences_cont",2,this.var_1099.offences,this.var_1341,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_35.initMsg.offenceCategories,this.var_1340,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1952;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModAlertMessageComposer(this.var_1642,this.var_580.text,this.var_1641));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1099 = this.var_35.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_580.text = this.var_1098.msg;
         this.var_737 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_35.connection.send(new ModKickMessageComposer(this.var_1642,this.var_580.text,this.var_1641));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1342.selection < 0)
         {
            this.var_35.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_35.connection.send(new ModBanMessageComposer(this.var_1642,this.var_580.text,this.getBanLength(),this.var_1641));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1342.selection;
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_1341.destroy();
            this.var_1341 = null;
         }
         if(this.var_1340 != null)
         {
            this.var_1340.destroy();
            this.var_1340 = null;
         }
         this.var_1342 = null;
         this.var_580 = null;
