package com.sulake.habbo.quest
{
   ...
   public class QuestsList implements IDisposable
   {
      ...
      private static const const_1433:int = 30;
      ...
      public function onToolbarClick() : void
      {
         ...
         {
            this.var_770 = new WindowToggle(this._window,this._window.desktop,this.requestQuests,this.close);
         }
         this.var_770.toggle();
         this.var_1759 = false;
      }
      ...
      private function refresh(param1:Boolean) : void
      {
         ...
         while(true)
         {
            if(_loc2_ < this.var_1463.length)
            {
               this.refreshEntry(true,_loc2_,this.var_1463[_loc2_],param1);
            }
            else
            {
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_67.spacing = const_1432;
      }
      ...
      public function createListEntry() : IWindowContainer
      {
         ...
         _loc6_.x = _loc3_.width - _loc6_.width - const_1434;
         ...
         _loc3_.x = _loc2_.x + _loc2_.width + const_1431;
      ...
      public function setEntryHeight(param1:IWindowContainer) : void
      {
         ...
         _loc2_.findChildByName("completion_txt").y = _loc2_.height - const_1433;
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(_loc3_ && this.var_1759 && !this.var_1758)
            {
               this.var_1759 = false;
