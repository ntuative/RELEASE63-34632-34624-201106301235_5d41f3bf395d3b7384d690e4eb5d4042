package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1588:int = 18;
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_225 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1588 && _loc2_ < this.var_225.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_558,this.var_225[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_225 != null && this.var_225.length > 0)
         {
            ...
            this.var_392 = this.var_225[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_558,this.var_392),this.getRaceLocalizationKey(this.var_558,this.var_392));
            }
         }
         return this.getRaceLocalizationKey(this.var_558,this.var_392);
      }
