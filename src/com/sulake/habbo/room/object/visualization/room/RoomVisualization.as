package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1797:int = 16777215;
      
      public static const const_2016:int = 13421772;
      
      private static const const_1090:int = 16777215;
      
      private static const const_1091:int = 13421772;
      
      private static const const_1093:int = 10066329;
      
      private static const const_1092:int = 10066329;
      
      public static const const_1985:int = 16777215;
      
      public static const const_1824:int = 13421772;
      
      public static const const_1904:int = 10066329;
      ...
      private var var_1451:String = null;
      
      private var _floorType:String = null;
      
      private var var_1452:String = null;
      
      private var var_995:Number = NaN;
      
      private var var_1503:Number = NaN;
      
      private var var_2548:Number = NaN;
      
      private var var_1889:String = null;
      
      private var var_1231:uint = 16777215;
      
      private var var_2551:int = 255;
      
      private var var_2547:int = 255;
      ...
      private const const_2354:int = 250;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_995))
         {
            this._planeParser.floorThicknessMultiplier = this.var_995;
         }
         if(!isNaN(this.var_1503))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1503;
         }
         ...
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_1895)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_72,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2354 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_378.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1888)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2549 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2547 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2551 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1890)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1686 || _loc3_.y != this.var_2546 || _loc3_.z != this.var_2550 || param1.scale != this.var_1891))
            {
               this.var_1686 = _loc3_.x;
               this.var_2546 = _loc3_.y;
               this.var_2550 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1260);
            if(_loc3_ != this.var_1889)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_1889 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_948));
            if(_loc4_ != this.var_1231)
            {
               this.var_1231 = _loc4_;
               this.var_2549 = this.var_1231 & 255;
               this.var_2547 = this.var_1231 >> 8 & 255;
               this.var_2551 = this.var_1231 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1252));
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_228);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_213);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_224);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_777));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_928));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            ...
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1227);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_995 || _loc3_ != this.var_1503))
            {
               this.var_995 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1216);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2548)
            {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1230;
      }
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_72 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_298)
                              {
