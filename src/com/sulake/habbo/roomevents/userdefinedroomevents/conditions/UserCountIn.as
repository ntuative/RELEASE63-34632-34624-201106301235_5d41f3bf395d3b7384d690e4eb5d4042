package com.sulake.habbo.roomevents.userdefinedroomevents.conditions
{
   ...
   public class UserCountIn implements ConditionType
   {
      ...
      {
         this.var_95 = param2;
         this.var_1204 = new SliderWindowController(param2,this.getMinInput(param1),param2.assets,1,50,1);
         this.var_1204.addEventListener(Event.CHANGE,this.onMinSliderChange);
         this.var_1204.setValue(1);
         this.var_1203 = new SliderWindowController(param2,this.getMaxInput(param1),param2.assets,1,50,1);
         this.var_1203.addEventListener(Event.CHANGE,this.onMaxSliderChange);
         this.var_1203.setValue(50);
      }
