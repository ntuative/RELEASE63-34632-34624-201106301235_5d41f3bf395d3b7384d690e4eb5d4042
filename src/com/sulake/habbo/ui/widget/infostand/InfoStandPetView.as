package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1673:int = 162;
      
      private static const const_1676:int = 16;
      
      private static const const_721:int = 4;
      
      private static const const_1682:uint = 14342874;
      
      private static const const_1681:uint = 3815994;
      
      private static const const_1674:uint = 2085362;
      
      private static const const_1670:uint = 39616;
      
      private static const const_1671:uint = 10513106;
      
      private static const const_1672:uint = 8734654;
      
      private static const const_1683:uint = 9094430;
      
      private static const const_1678:uint = 6200576;
      
      private static const const_1679:String = "happiness";
      
      private static const const_1675:String = "experience";
      
      private static const const_1677:String = "energy";
      
      private static const const_1680:int = 250;
      ...
      private var var_232:PetCommandTool;
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1679,param1.nutrition,param1.nutritionMax,const_1670,const_1674);
         this.updateStateElement(const_1675,param1.experience,param1.experienceMax,const_1672,const_1671);
         this.updateStateElement(const_1677,param1.energy,param1.energyMax,const_1678,const_1683);
         ...
         if(this.var_232 && this.var_232.isVisible() && param1.isOwnPet)
         {
            this.var_232.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:CommandConfiguration) : void
      {
         ...
         this.var_232.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1673,const_1676,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1682);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1681);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_721,_loc7_.width - 2,_loc7_.height - 2 - const_721);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_721);
      ...
      private function openTrainView() : void
      {
         if(this.var_232 == null)
         {
            this.var_232 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_583) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_232.showWindow(true);
            this.var_232.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_232 && this.var_232.getPetId() == this.var_583)
               {
                  this.var_232.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_401,this._widget.petData.ownerId);
      ...
      private function arrangeButtons() : void
      {
         ...
         this.var_109.height = _loc4_ + const_1148;
         this.updateWindow();
      }
   }
}
