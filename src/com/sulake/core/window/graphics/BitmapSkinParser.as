   ...
   public class BitmapSkinParser
   {
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_355 = SkinLayoutEntity.const_526;
                  break;
               case "move":
                  _loc5_.var_355 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_355 = SkinLayoutEntity.const_566;
                  break;
               case "tiled":
                  _loc5_.var_355 = SkinLayoutEntity.const_373;
                  break;
               case "center":
            ...
            {
               case "fixed":
                  _loc5_.var_356 = SkinLayoutEntity.const_526;
                  break;
               case "move":
                  _loc5_.var_356 = SkinLayoutEntity.const_345;
                  break;
               case "strech":
                  _loc5_.var_356 = SkinLayoutEntity.const_566;
                  break;
               case "tiled":
                  _loc5_.var_356 = SkinLayoutEntity.const_373;
                  break;
               case "center":
                  _loc5_.var_356 = SkinLayoutEntity.const_490;
            }
         }
