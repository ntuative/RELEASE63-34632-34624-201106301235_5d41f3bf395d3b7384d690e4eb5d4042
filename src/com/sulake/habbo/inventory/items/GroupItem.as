package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_1644:Number;
      
      protected var var_930:int = 0;
      
      protected var var_746:BitmapData;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1644));
         }
         else
         {
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_969)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      public function updateThumbData() : void
      {
         ...
         this.var_1483.color = !!this.var_1479 ? uint(const_1451) : uint(const_1450);
         this.var_2380.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2248 && this.getRecyclableCount() > 0)
            {
