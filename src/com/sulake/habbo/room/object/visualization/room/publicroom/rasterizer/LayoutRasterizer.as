package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_887:IGraphicAssetCollection;
      
      private var var_1782:XMLList;
      
      private var _offsetX:int;
      
      private var var_1347:int;
      
      private var var_2320:Vector3d;
      ...
      private var var_1459:LayoutRasterizerData = null;
      ...
      {
         if(param1 != this.var_957)
         {
            this.var_957 = param1;
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1459 = this.var_45.getValue(this.var_957);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2320 = new Vector3d(-0.5,0.5,0);
         this.var_956 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2320);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_45.getValue(this.var_957);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1748 = RoomObjectVariableEnum.const_1284;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1748 = RoomObjectVariableEnum.const_1282;
                           }
                           if(param2 != null)
                           {
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_45.getValue(this.var_957);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2322 && param3 == this.var_2321)
         {
            return;
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1748);
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1459.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_887.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_441.indexOf(_loc10_) >= 0 && this.var_956)
            {
               param1 = this.var_441.indexOf(_loc10_);
               if(this.var_620[param1] != "")
               {
                  _loc9_ = this.var_887.getAsset(this.var_620[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
