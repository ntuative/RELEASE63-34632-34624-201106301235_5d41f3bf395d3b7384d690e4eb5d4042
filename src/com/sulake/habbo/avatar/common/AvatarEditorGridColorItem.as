package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(this.var_731.width,this.var_731.height,true,0);
            _loc1_.bitmap.copyPixels(this.var_731,this.var_731.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = this._window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1117.width,this.var_1117.height,true,0);
            _loc5_ = this.var_1117.clone();
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_1002.width,this.var_1002.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_1002,this.var_1002.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
