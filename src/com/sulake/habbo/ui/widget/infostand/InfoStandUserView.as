package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      private var var_1044:TagListRenderer;
      ...
      private const const_1150:int = 5;
      
      private const const_2374:int = 3;
      
      private const const_1689:int = 11184810;
      
      private const const_1690:int = 16777215;
      
      private const const_2372:int = 2000;
      
      private const const_2371:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1044 = new TagListRenderer(param1,this.onTagSelected);
         this.var_2974 = !this._widget.config.getBoolean("menu.avatar.enabled",false);
      }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1150;
      ...
      public function setMotto(param1:String, param2:Boolean) : void
      {
         ...
         if(param2)
         {
            ...
            if(param1 == "")
            {
               ...
               _loc5_.textColor = this.const_1689;
            }
            else
            {
               _loc5_.textColor = this.const_1690;
            }
            _loc5_.enable();
         }
         else
         ...
         _loc5_.text = param1;
         _loc5_.height = Math.min(_loc5_.textHeight + this.const_1150,this.const_2371);
         _loc5_.height = Math.max(_loc5_.height,this.const_2373);
         _loc3_.height = _loc5_.height + this.const_2374;
         if(param2)
         {
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1044.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_784:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         {
            _loc6_ = getTimer();
            if(_loc6_ - this.var_2975 > this.const_2372 && _loc4_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
