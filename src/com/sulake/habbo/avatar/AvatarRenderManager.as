package com.sulake.habbo.avatar
{
   ...
   public class AvatarRenderManager extends Component implements IAvatarRenderManager
   {
      ...
      private const const_2351:String = "hd-99999-99999";
      ...
      private var var_246:AvatarAssetDownloadManager;
      
      private var var_1828:AvatarFigureContainer;
      ...
      public function AvatarRenderManager(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_652 = RenderMode.const_1763;
         ...
         this.var_121.add(AvatarType.const_134,_loc4_);
         ...
         this.var_121.add(AvatarType.const_54,_loc4_);
         ...
         this.var_798 = new PaletteManager(param1.assets as AssetLibraryCollection);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_246)
         {
            this.var_246.removeEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
      ...
      private function onAllModulesReadyAndRunning(param1:Event) : void
      {
         ...
         this.var_325.init();
         this.var_798.init();
         _loc2_ = this.var_121.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc2_)
         {
         ...
         _loc2_ = this.var_121.getValue(AvatarType.const_54) as AvatarStructure;
         if(_loc2_)
         {
            _loc2_.resetPartOffsets(context.assets);
         }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(param2 != null)
         {
            ...
            _loc3_ = this.var_121.getValue(AvatarType.const_134) as AvatarStructure;
            if(_loc3_ != null)
            {
               ...
               if(this.var_246 == null)
               {
                  ...
                  this.var_246 = new AvatarAssetDownloadManager(context.assets,_loc6_,_loc7_,_loc3_);
                  this.var_246.addEventListener(Event.COMPLETE,this.onAvatarAssetsDownloadManagerReady);
               }
            }
         }
      }
      ...
      private function checkIfReady() : void
      {
         if(!this.var_966)
         {
            if(this.var_2444 && this.var_2446 && this.var_2445)
            {
               this.var_966 = true;
      ...
      public function isFigureReady(param1:IAvatarFigureContainer) : Boolean
      {
         ...
         return this.var_246.isReady(param1);
      }
      ...
      public function downloadFigure(param1:IAvatarFigureContainer, param2:IAvatarImageListener) : void
      {
         ...
         this.var_246.loadFigureSetData(param1,param2);
      }
      ...
      {
         var _loc5_:AvatarStructure = this.var_121.getValue(AvatarType.const_134) as AvatarStructure;
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         if(this.var_246.isReady(_loc6_))
         {
            return new AvatarImage(_loc5_,this._aliasCollection,_loc6_,param2);
         }
         if(!this.var_1828)
         {
            this.var_1828 = new AvatarFigureContainer(this.const_2351);
         }
         this.var_246.loadFigureSetData(_loc6_,param4);
         return new PlaceholderAvatarImage(_loc5_,this._aliasCollection,this.var_1828,param2);
      }
      ...
      public function createPetImage(param1:int, param2:int, param3:uint, param4:String, param5:IPetImageListener = null) : IAvatarImage
      {
         var _loc9_:* = null;
         var _loc6_:* = false;
         if(this.mode != RenderMode.const_1854)
         {
            _loc6_ = !this.var_325.assetsReady(param1,param4);
         }
         var _loc7_:String = this.var_325.createPetFigureString(param1,param2,param3);
         var _loc8_:AvatarStructure = this.var_121.getValue(AvatarType.const_54) as AvatarStructure;
         if(_loc8_ == null)
         {
            return null;
         }
      ...
      public function resetPetData() : void
      {
         ...
         var _loc2_:AvatarStructure = this.var_121.getValue(AvatarType.const_54);
      ...
      {
         var _loc3_:AvatarStructure = this.var_121.getValue(AvatarType.const_134) as AvatarStructure;
      ...
      public function injectFigureData(param1:String, param2:XML) : void
      {
         ...
         switch(param1)
         {
            ...
            case AvatarType.const_54:
               _loc3_ = this.var_121.getValue(AvatarType.const_54) as AvatarStructure;
               break;
            default:
