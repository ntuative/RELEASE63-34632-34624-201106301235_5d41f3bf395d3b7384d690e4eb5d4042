package com.sulake.habbo.tracking
{
   ...
   public class ToolbarClickTracker
   {
      ...
      {
         this.var_1733 = Boolean(parseInt(param1.getKey("toolbar.tracking.enabled","1")));
         this.var_2662 = parseInt(param1.getKey("toolbar.tracking.max.events","100"));
      }
      ...
      public function track(param1:String) : void
      {
         ...
         ++this.var_1969;
         if(this.var_1969 <= this.var_2662)
         {
