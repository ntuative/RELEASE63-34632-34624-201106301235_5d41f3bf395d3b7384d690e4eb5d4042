package com.sulake.habbo.ui.handler
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1968:Map = null;
      
      private var var_1274:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1275:Number = 0.0;
      
      private var var_841:Point = null;
      
      private var var_560:Vector3d;
      
      public function ChatWidgetHandler()
      {
         this.var_1274 = [];
         this.var_560 = new Vector3d();
         super();
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_471.length)
            {
               _loc2_ = this.var_471.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      {
         return [RoomWidgetChatMessage.const_878,RoomWidgetChatSelectAvatarMessage.const_757];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_878:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_34) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1251))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_34) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1251))
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_585);
                                 this._container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc9_ != null)
                        {
                           ...
                           _loc15_ = this._container.roomEngine.method_4(_loc3_.session.roomId,_loc3_.session.roomCategory,this._container.getFirstCanvasId());
                           if(_loc15_ != null)
                           {
                              _loc6_ += _loc15_.x;
                              _loc7_ += _loc15_.y;
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_471.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_682.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_682.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    ...
                                    {
                                       this.var_471.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1275 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1275);
            }
            if(this.var_841 == null)
            {
               ...
               this.var_560.y = 0;
               this.var_560.z = 0;
               this.var_841 = _loc4_.getScreenPoint(this.var_560);
               this.var_1275 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_560.x = 0;
            this.var_560.y = 0;
            this.var_560.z = 0;
            _loc8_ = _loc4_.getScreenPoint(this.var_560);
            if(_loc8_ != null)
            {
               _loc9_ = this._container.roomEngine.method_4(_loc2_,_loc3_,_loc1_);
               if(_loc9_ != null)
               {
                  _loc8_.offset(_loc9_.x,_loc9_.y);
               }
               if(_loc8_.x != this.var_841.x || _loc8_.y != this.var_841.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_841,_loc5_));
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_471)
         {
            _loc2_ = this.var_471.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1274.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_682.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1968.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1968.remove(param1);
         if(_loc3_ != null)
         {
