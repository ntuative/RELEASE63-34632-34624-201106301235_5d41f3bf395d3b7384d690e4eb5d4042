package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2044:uint = 1;
      
      protected static const const_2042:uint = 2;
      ...
      public static const const_1989:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_1178:Boolean = false;
      
      public static const const_1921:int = 2;
      
      private static var var_942:Array = new Array();
      
      private static var var_761:Array = new Array();
      ...
      protected var var_626:Class;
      
      protected var var_504:uint = 0;
      
      protected var _name:String;
      
      protected var var_1140:Boolean = false;
      ...
      protected var var_3038:String = "";
      
      protected var var_2245:int;
      
      protected var var_1410:int;
      
      protected var var_1409:int;
      
      protected var var_3121:uint = 0;
      
      protected var var_3040:Boolean = true;
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1178)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_761[_loc2_] as LibraryLoader;
            ...
            while(var_761.length < const_1921 && false)
            {
               _loc1_ = var_942.shift() as LibraryLoader;
      ...
      {
         return !!this.var_1140 ? uint(this.var_1410 - this.var_2245) : uint(getTimer() - this.var_2245);
      }
      ...
      {
         if(this.var_1141 && !_disposed)
         {
            this.var_1141 = false;
            if(!this.var_1140 && this.var_266)
            {
               this.var_1410 = -1;
               this.var_2245 = getTimer();
               queue(this);
            }
         }
      }
      ...
      {
         if(!this.var_1140 && !_disposed && this.var_1409 > 0)
         {
            try
            {
               this.var_44.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_266,const_1989 - this.var_1409);
            if(this.var_3040)
            {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_626 = this.getDefinition(this._name) as Class;
         ...
         try
         {
            xmlClass = this.var_626.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
