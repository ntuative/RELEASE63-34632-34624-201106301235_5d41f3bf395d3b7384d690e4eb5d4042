package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static const const_680:String = "{";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_97[const_232],var_97[ITALIC],var_97[BOLD]];
            var_97.reset();
            var_97[const_232] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         if(countSubStrings(param1,const_680) != countSubStrings(param1,const_681))
         {
            throw new Error("Mismatching amount of \"" + const_680 + "\" versus \"" + const_681 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            ...
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_680)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
