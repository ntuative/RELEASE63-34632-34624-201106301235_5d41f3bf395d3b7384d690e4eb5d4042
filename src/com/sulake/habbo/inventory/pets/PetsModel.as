package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(param1 == InventoryCategory.const_125 && this.var_26.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_2111 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_28,RoomObjectTypeEnum.const_206,_loc3_.figureString);
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_2111 && param1.type == RoomEngineObjectEvent.const_174)
         {
      ...
      public function addUnseenPets(param1:Array) : void
      {
         ...
         {
            if(this.var_581.indexOf(_loc2_) == -1)
            {
               this.var_581.push(_loc2_);
            }
         }
         this._view.update();
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         var _loc1_:IConnection = this._communication.getHabboMainConnection(null);
         if(this.var_581 && this.var_581.length > 0)
         {
      ...
      {
         return this.var_581.length;
      }
      
      public function isUnseen(param1:int) : Boolean
      {
         return this.var_581.indexOf(param1) > -1;
      }
   }
}
