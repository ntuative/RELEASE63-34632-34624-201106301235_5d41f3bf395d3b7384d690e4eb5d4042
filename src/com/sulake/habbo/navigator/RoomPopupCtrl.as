package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      private var var_2440:RoomThumbnailRenderer;
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         this.var_2440 = new RoomThumbnailRenderer(param1);
         this.var_1044 = new TagRenderer(param1,hideInstantly);
      }
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         ...
         this.refreshRoomName(this.var_205,this.var_141);
         if(this.var_141.ownerName != "" && this.var_141.ownerName != "-")
         {
         }
         this.refreshOwnerName();
         this.refreshTextWithCaption("roomctg",this.var_205,!!this.var_141.event ? this.getEventCtg(this.var_141.categoryId) : this.getRoomCtg(this.var_141.categoryId));
         this.refreshRoomDesc(this.var_205,this.var_141);
         this.refreshExtraCont();
         this.refreshInfo(this.var_205,"trading_allowed",this.var_141.allowTrading);
         this.refreshInfo(this.var_205,"doormode_doorbell",this.var_141.doorMode == 1);
         this.refreshInfo(this.var_205,"doormode_password",this.var_141.doorMode == 2);
      ...
      {
         this.refreshTextWithCaption("roomowner",this.var_205,this.var_141.ownerName);
      ...
      private function refreshExtraCont() : void
      {
         ...
         this.var_1044.refreshTags(_loc1_,this.var_141.tags);
         ...
         this.var_2440.refreshThumbnail(_loc1_,this.var_141.thumbnail,false);
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_262,Tabs.const_400,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
