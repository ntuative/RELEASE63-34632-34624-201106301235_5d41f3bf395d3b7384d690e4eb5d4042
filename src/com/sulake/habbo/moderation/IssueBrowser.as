package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2362:String = "my_issues";
      
      private const const_2361:String = "open_issues";
      
      private const const_2363:String = "picked_issues";
      
      private const const_2385:String = "closed_issues";
      ...
      private var var_401:IIssueBrowserView;
      
      private var var_2042:IIssueBrowserView;
      
      private var var_2044:IIssueBrowserView;
      
      private var var_2043:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_293 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_293.numTabItems)
            {
               _loc5_ = this.var_293.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_47,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_293 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_293 == null || this.var_293.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_293.selector.getSelectableByName("open_issues");
         this.var_293.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_401 == _loc2_)
         {
            return;
         }
         if(this.var_401 != null)
         {
            this.var_401.visible = false;
         }
         this.var_401 = _loc2_;
         if(this.var_401 == null)
         {
         ...
         this.var_401.view.width = this.var_293.container.width;
         this.var_401.view.height = this.var_293.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2362:
               ...
               {
                  this.var_2042 = new MyIssuesView(this.issueManager,this,this.var_293.container);
               }
               return this.var_2042;
            case this.const_2361:
               if(this.var_2044 == null)
               {
                  this.var_2044 = new OpenIssuesView(this.issueManager,this,this.var_293.container);
               }
               return this.var_2044;
            case this.const_2363:
               if(this.var_2043 == null)
               {
                  this.var_2043 = new PickedIssuesView(this.issueManager,this,this.var_293.container);
               }
