package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_2064:String = "button_ok";
      
      protected static const const_2063:String = "text_title";
      
      protected static const DESCRIPTION_NAME:String = "text_description";
      
      protected static const const_2343:String = "widget_notification_frame";
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_690)
            {
               while(this.var_690.length > 0)
               {
                  this.var_690.pop().dispose();
               }
               this.var_690 = null;
            }
            this._widget = null;
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.findChildByName(const_2063).caption = title;
         dialog.findChildByName(DESCRIPTION_NAME).caption = description;
         dialog.center();
         dialog.findChildByName(const_2064).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
