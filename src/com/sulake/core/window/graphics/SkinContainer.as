package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1570:String = "skin";
      
      private static const const_1572:String = "bitmap";
      
      private static const const_1573:String = "fill";
      
      private static const const_1571:String = "text";
      
      private static const const_1574:String = "label";
      
      private static const const_1575:String = "shape";
      ...
      private var var_2608:Dictionary;
      
      private var var_2609:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_2608 = new Dictionary();
         TypeCodeTable.fillTables(this.var_1930,this.var_2608);
         this.var_2609 = new Dictionary();
         this.var_2607 = new Dictionary();
         StateCodeTable.fillTables(this.var_2609,this.var_2607);
         this.var_468 = new Dictionary();
         this.var_468[const_1570] = BitmapSkinRenderer;
         this.var_468[const_1572] = BitmapDataRenderer;
         this.var_468[const_1573] = FillSkinRenderer;
         this.var_468[const_1571] = TextSkinRenderer;
         this.var_468[const_1574] = LabelRenderer;
         this.var_468[const_1575] = ShapeSkinRenderer;
         this.var_468[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_468[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_363 == null)
         {
            var_363 = new Array();
            var_363.push(WindowState.const_70);
            var_363.push(WindowState.const_90);
            var_363.push(WindowState.const_98);
            ...
            var_363.push(WindowState.const_100);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  this.addSkinRenderer(this.var_1930[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer, param4:DefaultAttStruct) : void
      {
         ...
         {
            this.var_1035[param1] = new Array(const_1102);
         }
         this.var_1035[param1][param2] = param3;
         if(this.var_1036[param1] == null)
         {
            this.var_1036[param1] = new Array(const_1102);
         }
         this.var_1036[param1][param2] = param4;
      }
