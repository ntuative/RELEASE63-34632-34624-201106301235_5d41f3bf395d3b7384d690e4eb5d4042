package com.sulake.habbo.ui.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_1832:String = "POLL_OFFER_STATE_OK";
      ...
      private function onOk(param1:WindowEvent) : void
      {
         ...
         this._state = const_1832;
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_1007,this._id));
      }
      ...
      private function onCancel(param1:WindowEvent) : void
      {
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_542,this._id));
