package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_531:IKeyExchange;
      ...
      private var var_242:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_636 = param1;
            this.var_63.initConnection(HabboConnectionType.const_273);
         }
      }
      ...
      {
         if(this.var_63 && this.var_151 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_242 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         ...
         {
            this.var_242.loadHotelViewImage(_loc3_ + _loc2_);
         }
         var _loc4_:* = this.var_151.getKey("use.sso.ticket") == "1";
         this.var_636 = this.var_151.getKey("sso.ticket",null);
         this.var_1813 = this.var_151.getKey("flash.client.url","");
         this.var_2415 = this.var_151.getKey("external.variables.txt","");
         if(this.var_242 == null)
         {
            this.var_242 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_63.mode = HabboConnectionType.const_99;
            if(this.var_636)
            {
               this.var_63.initConnection(HabboConnectionType.const_273);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_805,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1929);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_63.mode = HabboConnectionType.const_1271;
            }
         }
         this.var_63.initConnection(HabboConnectionType.const_273);
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(this.var_63.mode)
         {
            case HabboConnectionType.const_99:
               ...
               this.var_242.loadBannerImage(_loc7_ + "?token=" + this.var_1487,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1271:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1915:
               this.var_988 = this.generateRandomHexString(30);
               this.var_531 = new DiffieHellman(new BigInteger(this.var_151.getKey("connection.development.prime"),16),new BigInteger(this.var_151.getKey("connection.development.generator"),16));
               this.var_531.init(this.var_988);
               _loc8_ = this.var_531.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_531.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_531.getSharedKey(16).toUpperCase();
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1813,this.var_2415));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_2068,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_636 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_636);
            _loc2_.send(_loc4_);
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_294);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2416)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1487);
         ...
         this.var_531 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_531.init(_loc14_);
            _loc15_ = this.var_531.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_988 = _loc14_;
            }
