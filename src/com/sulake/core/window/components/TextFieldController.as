package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_906:Boolean = false;
      ...
      override public function getGraphicContext(param1:Boolean) : IGraphicContext
      {
         if(param1 && !var_21)
         {
            var_21 = new GraphicContext("GC {" + _name + "}",GraphicContext.const_1277,var_10);
         }
         return var_21;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_906 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_867,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1737);
         _loc1_.push(this.var_1416 != PropertyDefaults.const_1389 ? new PropertyStruct(PropertyDefaults.const_926,this.var_1416,PropertyStruct.const_38,true) : PropertyDefaults.const_1792);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1399 ? new PropertyStruct(PropertyDefaults.const_1011,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1873);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1372 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1958);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_926:
                  this.var_1416 = _loc2_.value as Boolean;
                  if(this.var_1416)
                  {
               ...
               case PropertyDefaults.const_867:
                  ...
                  break;
               case PropertyDefaults.const_1349:
