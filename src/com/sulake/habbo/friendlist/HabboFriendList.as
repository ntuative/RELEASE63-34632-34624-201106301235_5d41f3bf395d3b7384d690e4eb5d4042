package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      public static const const_197:String = "face";
      ...
      private var var_2540:FriendListLookAndFeel;
      
      private var var_488:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1881:OpenedToWebPopup;
      ...
      private var var_1880:AvatarSearchResults;
      ...
      {
         this.var_2540 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_118 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1880 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_659.stop();
            this.var_659.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_659 = null;
         }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1881 = new OpenedToWebPopup(this);
         }
         this.var_1881.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_458);
      }
      ...
      {
         var _loc2_:IAvatarImage = this.var_609.createAvatarImage(param1,AvatarScaleType.const_113,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         this.var_1105 = param2 as IHabboNotifications;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_1264,this.getText("friendlist.friends")));
         this.var_118.addCategory(new FriendCategory(FriendCategory.const_416,this.getText("friendlist.friends.offlinecaption")));
         ...
         if(!this.var_659)
         {
            this.var_659 = new Timer(120000);
            this.var_659.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_659.start();
         }
         ...
         {
            _loc5_ = this.var_118.findCategory(FriendCategory.const_416);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_488.findTab(FriendListTab.const_92).setNewMessageArrived(true);
         }
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_488.findTab(FriendListTab.const_92);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1880.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_488.findTab(FriendListTab.const_92);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         var _loc1_:FriendListTab = this.var_488.findTab(FriendListTab.const_92);
         if(!_loc1_)
         {
            return;
         }
      ...
      {
         if(!this.var_809 || !this.var_122)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_809.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_40))
         {
            _loc2_ = this.var_122.vipLimit;
         }
         else if(this.var_809.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_34))
         {
         ...
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_ != null && !_loc3_.disposed && _loc3_.figure == param1)
            {
               ...
               if(_loc3_.face != null)
               {
                  ...
                  if(_loc4_ != null)
                  {
                     _loc5_ = _loc4_.getChildByName(const_197) as IBitmapWrapperWindow;
