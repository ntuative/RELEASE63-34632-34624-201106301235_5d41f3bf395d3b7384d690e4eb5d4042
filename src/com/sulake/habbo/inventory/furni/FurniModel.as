package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1601:int = 1000;
      ...
      private var var_1575:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_477 = [];
         this.var_478 = [];
         this.var_686 = new Timer(const_1602,1);
         this.var_686.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2686 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_686.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_686.stop();
               this.var_686 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1575 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1575;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_844 == null)
         {
            this.var_844 = this._windowManager.buildFromXML(this.var_2686) as IWindowContainer;
            _loc12_ = this._assets.getAssetByName("thumb_selected_outline_png") as BitmapDataAsset;
            _loc13_ = this.var_844.findChildByName("outline") as IBitmapWrapperWindow;
            _loc13_.bitmap = _loc12_.content as BitmapData;
            _loc13_.disposesBitmap = false;
         }
         var _loc11_:IWindowContainer = this.var_844.clone() as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_74 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_300:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_125);
            }
         }
      }
      ...
      {
         this.var_2687 = getTimer();
         this.switchCategory(const_300);
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_426);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_687.add(const_36,new Array());
         this.var_687.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1, param4:Boolean = false) : void
      {
         ...
         {
            _loc6_ = const_36;
            _loc5_ = this.var_477.indexOf(param1.ref) > -1;
         }
         else
         {
            ...
            _loc6_ = const_45;
            _loc5_ = this.var_478.indexOf(param1.ref) > -1;
         }
         ...
         if(param4)
         {
            if(this._view.visibleCategoryId == const_300)
            {
      ...
      {
         return getTimer() < this.var_2687 + const_1601;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_358;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_376 || _loc3_.category == FurniCategory.const_337 || _loc3_.category == FurniCategory.const_348)
         {
            if(param1)
            {
               return false;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_358:
               this.cancelFurniInMover();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_687.getValue(param1) as Array;
         if(_loc3_ != null)
         {
      ...
      public function addUnseenFloorItems(param1:Array) : void
      {
         ...
         {
            if(this.var_477.indexOf(_loc2_) == -1)
            {
               this.var_477.push(_loc2_);
            }
         }
      }
      ...
      public function addUnseenWallItems(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            if(this.var_478.indexOf(_loc2_) == -1)
            {
               this.var_478.push(_loc2_);
            }
         }
      }
      ...
      public function getUnseenItemCount(param1:int = 0) : int
      {
         switch(param1)
         {
            ...
            case UnseenItemCategoryEnum.const_454:
               return this.var_478.length;
            default:
               return this.var_477.length + this.var_478.length;
         }
      }
      ...
      public function resetUnseenItems(param1:String = null) : void
      {
         ...
         {
            case const_45:
               if(this.var_478 && this.var_478.length > 0)
               {
                  _loc2_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_454));
                  this.var_478 = [];
                  _loc3_ = this.getCategoryContent(param1);
               }
               break;
            case const_36:
               if(this.var_477 && this.var_477.length > 0)
               {
