package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1559:String = "asset-libraries";
      
      private static const const_1558:String = "library";
      
      private static const const_1566:String = "service-libraries";
      
      private static const const_1563:String = "library";
      
      private static const const_1564:String = "component-libraries";
      
      private static const const_1562:String = "library";
      
      private static const const_1560:String = "error_data";
      
      private static const const_1565:String = "error_cat";
      
      private static const const_1561:String = "error_desc";
       
      
      private var var_381:LibraryLoaderQueue;
      
      private var var_827:IEventDispatcher;
      
      private var var_555:uint;
      
      private var var_380:Function;
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            case Core.const_1237:
               ...
               this.var_380 = this.simpleFrameUpdateHandler;
               break;
            case Core.const_808:
               debug("Core; using complex frame update handler");
               this.var_380 = this.complexFrameUpdateHandler;
               break;
            case Core.const_844:
               debug("Core; using profiler frame update handler");
               this.var_380 = this.profilerFrameUpdateHandler;
               this.var_218 = new Profiler(this);
               attachComponent(this.var_218,[new IIDProfiler()]);
               var_432.addChild(new ProfilerViewer(this.var_218));
               break;
            case Core.const_646:
               debug("Core; using experimental frame update handler");
               this.var_380 = this.experimentalFrameUpdateHandler;
               break;
            case Core.CORE_SETUP_DEBUG:
               debug("Core; using debug frame update handler");
               this.var_380 = this.debugFrameUpdateHandler;
         }
      }
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1560,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1565,String(param3));
         ErrorReportStorage.setParameter(const_1561,param1);
      ...
      public function readConfigDocument(param1:XML, param2:IEventDispatcher = null) : void
      {
         ...
         this.var_827 = loadingEventDelegate;
         if(this.var_381 == null)
         {
            this.var_381 = new LibraryLoaderQueue(_debug);
         }
         try
         {
         ...
         try
         {
            node = config.child(const_1566)[0];
            if(node != null)
            {
               list = node.child(const_1563);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
         ...
         try
         {
            node = config.child(const_1564)[0];
            if(node != null)
            {
               list = node.child(const_1562);
               for each(item in list)
               {
                  url = item.attribute("url").toString();
                  loader = new LibraryLoader(context,true,_debug);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1247);
         if(!disposed)
         {
      ...
      private function finalizeLoadingEventDelegate() : void
      {
         if(this.var_827)
         {
            this.var_827.dispatchEvent(new Event(Event.COMPLETE));
         }
      }
      ...
      private function updateLoadingProgress(param1:LibraryLoaderEvent = null) : void
      {
         ...
         if(this.var_827)
         {
            ...
            this.var_827.dispatchEvent(new LibraryProgressEvent(_loc2_.url,param1.bytesLoaded,param1.bytesTotal,_loc2_.elapsedTime));
         }
      }
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_827)
                  {
                     this.var_827.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_555 - this.var_381.length,this.var_555,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_218 ? 0 : this.var_1537 & 0;
         if(_loc3_ == Core.const_646)
         {
      ...
      private function onEnterFrame(param1:Event) : void
      {
         ...
         this.var_380(_loc2_,_loc2_ - this._lastUpdateTimeMs);
