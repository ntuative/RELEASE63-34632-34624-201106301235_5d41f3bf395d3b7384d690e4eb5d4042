   ...
   public class DimmerViewColorGrid
   {
      ...
      private function populateColourGrid(param1:IHabboWindowManager) : void
      {
         ...
         for each(_loc2_ in this.colors)
         {
            ...
            _loc3_.width = this.var_618.width;
            _loc3_.height = this.var_618.height;
            this.var_516.addGridItem(_loc3_);
            _loc4_ = _loc3_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_618.width,this.var_618.height,true,0);
               _loc4_.bitmap.copyPixels(this.var_618,this.var_618.rect,new Point(0,0));
            }
            _loc5_ = _loc3_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_1171.width,this.var_1171.height,true,0);
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_618 = BitmapData(_loc3_.content);
         _loc3_ = BitmapDataAsset(param1.getAssetByName("dimmer_color_button"));
         this.var_1171 = BitmapData(_loc3_.content);
