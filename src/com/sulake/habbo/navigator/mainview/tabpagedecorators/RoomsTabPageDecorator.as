   ...
   public class RoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(this.var_154 == null)
         {
            ...
            this.var_154.addEventListener(WindowEvent.const_47,this.onFilterSelected);
         }
         _loc3_.visible = true;
      }
      ...
      public function tabSelected() : void
      {
         if(this.var_154 != null)
         {
            this.var_154.removeEventListener(WindowEvent.const_47,this.onFilterSelected);
      ...
      private function startSearch() : void
      {
         ...
         if(_loc1_ == 0)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_444);
         }
         else if(_loc1_ == 1)
         {
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_901);
         }
         else
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_231,Tabs.const_444,"" + _loc3_);
         }
         if(this.var_154)
         {
