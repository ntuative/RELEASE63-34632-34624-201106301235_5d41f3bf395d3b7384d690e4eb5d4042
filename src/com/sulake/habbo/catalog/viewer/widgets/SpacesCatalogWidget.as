package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1451:String = "default";
      ...
      private var var_1452:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_951 = this.parseElements(_loc2_.floors.pattern);
         this.var_1166 = this.parseElements(_loc2_.walls.pattern);
         this.var_1169 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_951)
                  {
                     _loc11_ = this.var_951[_loc10_];
                     if(this.var_615.indexOf(_loc10_) == -1)
                     {
                        this.var_615.push(_loc10_);
                        this.var_1167.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1166[_loc8_] != null)
                  {
                     this.var_765.push(_loc8_);
                  ...
                  break;
               case "landscape":
                  if(this.var_1169[_loc8_] != null)
                  {
                     this.var_764.push(_loc8_);
         ...
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1451,this.var_1452,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1168[this.var_435];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1451);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1167[this.var_440];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this._landscapeOffers[this.var_438];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_615[this.var_440];
         var _loc3_:Array = this.var_951[_loc2_];
         if(_loc3_ != null && this.var_436 >= 0)
         {
            _loc11_ = _loc3_[this.var_436];
            if(_loc11_ != null)
            {
               this._floorType = _loc11_;
            }
         }
         var _loc4_:Offer = this.var_1167[this.var_440];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_765[this.var_435];
         var _loc6_:Array = this.var_1166[_loc5_];
         if(_loc6_ != null && this.var_437 >= 0)
         {
            _loc13_ = _loc6_[this.var_437];
            if(_loc13_ != null)
            {
               this.var_1451 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1168[this.var_435];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_764[this.var_438];
         var _loc9_:Array = this.var_1169[_loc8_];
         if(_loc9_ != null && this.var_439 >= 0)
         {
            _loc15_ = _loc9_[this.var_439];
            if(_loc15_ != null)
            {
               this.var_1452 = _loc15_;
            }
         }
         var _loc10_:Offer = this._landscapeOffers[this.var_438];
         if(_loc10_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_109:
               ...
               if(this.var_440 < 0)
               {
                  this.var_440 = this.var_615.length - 1;
               }
               if(this.var_440 >= this.var_615.length)
               {
                  this.var_440 = 0;
               }
               this.var_436 = 0;
               this.var_949 = 0;
               _loc5_ = this.var_615[this.var_440];
               _loc6_ = this.var_951[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_949 = _loc6_.length;
               }
            ...
            case const_236:
               ...
               if(this.var_435 < 0)
               {
                  this.var_435 = this.var_765.length - 1;
               }
               if(this.var_435 == this.var_765.length)
               {
                  this.var_435 = 0;
               }
               this.var_437 = 0;
               this.var_950 = 0;
               _loc7_ = this.var_765[this.var_435];
               _loc8_ = this.var_1166[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_950 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_438 < 0)
               {
                  this.var_438 = this.var_764.length - 1;
               }
               if(this.var_438 >= this.var_764.length)
               {
                  this.var_438 = 0;
               }
               this.var_439 = 0;
               this.var_952 = 0;
               _loc9_ = this.var_764[this.var_438];
               _loc10_ = this.var_1169[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_952 = _loc10_.length;
               }
