package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      {
         var _loc4_:* = null;
         if(this.var_240.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         {
            _loc4_ = this.var_240[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               this.var_240.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
         this.var_240.push(param1);
      }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_240,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         return Math.ceil(this.var_240.length / const_411);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_941 * const_411;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_941 + 1) * const_411,this.var_240.length);
      }
