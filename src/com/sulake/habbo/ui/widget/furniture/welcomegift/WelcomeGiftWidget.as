package com.sulake.habbo.ui.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_691:String = "welcome_gift_email_unverified";
      
      private const const_1068:String = "welcome_gift_email_verified";
      
      private const const_1475:String = "welcome_gift_email_change";
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1200)
         {
            this.setViewState(this.const_1068);
         }
         else
         {
            this.setViewState(this.const_691);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_691:
               ...
               this._view.findChildByName("edit_text").visible = this.var_996;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_29,this.var_996);
               break;
            case this.const_1068:
            ...
            case this.const_1475:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_996);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1504;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1475);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_735,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1200 ? this.const_1068 : this.const_691);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1505 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1505));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_664,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_898,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_664,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_898,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_664:
               this.var_1504 = param1.email;
               this.var_1200 = param1.isVerified;
               this.var_996 = param1.allowEmailChange;
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1505);
