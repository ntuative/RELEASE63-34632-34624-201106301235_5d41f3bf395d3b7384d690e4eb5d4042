   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_615,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_64.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_64.getValue(InventorySubCategory.const_358));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_64.getValue(InventoryCategory.const_219));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_64.getValue(InventorySubCategory.const_1265));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_64.getValue(InventoryCategory.const_125));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_64.getValue(InventoryCategory.const_426) as MarketplaceModel;
      }
      ...
      {
         this.var_415 = ISessionDataManager(param2);
         this.initInventory();
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_615,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_82:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_615:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      {
         if(!this._communication || !this._windowManager || !this._localization || !this._roomEngine || !this.var_415 || !this._config || !this._catalog || !this._avatarRenderer || !this.var_15 || !this._toolbar || !this._soundManager)
         {
            return;
         }
         ...
         this.var_64.add(InventoryCategory.const_426,_loc1_);
         ...
         this.var_64.add(InventoryCategory.const_74,_loc2_);
         var _loc3_:BadgesModel = new BadgesModel(this,this._windowManager,this._communication,this._assetLibrary,this.var_415);
         this.var_64.add(InventoryCategory.const_219,_loc3_);
         ...
         this.var_64.add(InventorySubCategory.const_358,_loc5_);
         ...
         this.var_64.add(InventorySubCategory.const_1265,_loc6_);
         ...
         this.var_64.add(InventoryCategory.const_125,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_1001.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_1001.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_1001.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_1001.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_290));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2477)
         {
            this.var_2477 = _loc1_;
